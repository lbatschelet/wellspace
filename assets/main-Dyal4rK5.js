...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:ui,depthTest:!1,depthWrite:!1})}function E_(i,e,t){const n=new Float32Array(Bi),s=new D(0,1,0);return new Zn({name:"SphericalGaussianBlur",defines:{n:Bi,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${i}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:n},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:s}},vertexShader:za(),fragmentShader:`
...
`)}const Px={[Lh]:"Linear",[Dh]:"Reinhard",[Ih]:"Cineon",[Nh]:"ACESFilmic",[kh]:"AgX",[Uh]:"Neutral",[Fh]:"Custom"};function Lx(i,e){const t=Px[e];return t===void 0?(Pe("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+i+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const ua=new D;function Dx(){et.getLuminanceCoefficients(ua);const i=ua.x.toFixed(4),e=ua.y.toFixed(4),t=ua.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
...
`)+`
`+p);const y=x+m+a,M=x+p+o,S=qu(s,s.VERTEX_SHADER,y),T=qu(s,s.FRAGMENT_SHADER,M);s.attachShader(b,S),s.attachShader(b,T),t.index0AttributeName!==void 0?s.bindAttribLocation(b,0,t.index0AttributeName):t.morphTargets===!0&&s.bindAttribLocation(b,0,"position"),s.linkProgram(b);function C(P){if(i.debug.checkShaderErrors){const L=s.getProgramInfoLog(b)||"",k=s.getShaderInfoLog(S)||"",V=s.getShaderInfoLog(T)||"",O=L.trim(),B=k.trim(),X=V.trim();let z=!0,K=!0;if(s.getProgramParameter(b,s.LINK_STATUS)===!1)if(z=!1,typeof i.debug.onShaderError=="function")i.debug.onShaderError(s,b,S,T);else{const ee=Ku(s,S,"vertex"),oe=Ku(s,T,"fragment");Ue("THREE.WebGLProgram: Shader Error "+s.getError()+" - VALIDATE_STATUS "+s.getProgramParameter(b,s.VALIDATE_STATUS)+`
...
Program Info Log: `+O+`
`+ee+`
`+oe)}else O!==""?Pe("WebGLProgram: Program Info Log:",O):(B===""||X==="")&&(K=!1);K&&(P.diagnostics={runnable:z,programLog:O,vertexShader:{log:B,prefix:m},fragmentShader:{log:X,prefix:p}})}s.deleteShader(S),s.deleteShader(T),N=new ya(s,b),w=Fx(s,b)}let N;this.getUniforms=function(){return N===void 0&&C(this),N};let w;this.getAttributes=function(){return w===void 0&&C(this),w};let v=t.rendererExtensionParallelShaderCompile===!1;return this.isReady=function(){return v===!1&&(v=s.getProgramParameter(b,Ex)),v},this.destroy=function(){n.releaseStatesOfProgram(this),s.deleteProgram(b),this.program=void 0},this.type=t.shaderType,this.name=t.shaderName,this.id=Tx++,this.cacheKey=e,this.usedTimes=1,this.program=b,this.vertexShader=S,this.fragmentShader=T,this}let Zx=0;class Qx{constructor(){this.shaderCache=new Map,this.materialCache=new Map}update(e){const t=e.vertexShader,n=e.fragmentShader,s=this._getShaderStage(t),r=this._getShaderStage(n),a=this._getShaderCacheForMaterial(e);return a.has(s)===!1&&(a.add(s),s.usedTimes++),a.has(r)===!1&&(a.add(r),r.usedTimes++),this}remove(e){const t=this.materialCache.get(e);for(const n of t)n.usedTimes--,n.usedTimes===0&&this.shaderCache.delete(n.code);return this.materialCache.delete(e),this}getVertexShaderID(e){return this._getShaderStage(e.vertexShader).id}getFragmentShaderID(e){return this._getShaderStage(e.fragmentShader).id}dispose(){this.shaderCache.clear(),this.materialCache.clear()}_getShaderCacheForMaterial(e){const t=this.materialCache;let n=t.get(e);return n===void 0&&(n=new Set,t.set(e,n)),n}_getShaderStage(e){const t=this.shaderCache;let n=t.get(e);return n===void 0&&(n=new Jx(e),t.set(e,n)),n}}class Jx{constructor(e){this.id=Zx++,this.code=e,this.usedTimes=0}}function e0(i,e,t,n,s,r,a){const o=new fc,l=new Qx,c=new Set,u=[],h=new Map,d=s.logarithmicDepthBuffer;let f=s.precision;const g={MeshDepthMaterial:"depth",MeshDistanceMaterial:"distance",MeshNormalMaterial:"normal",MeshBasicMaterial:"basic",MeshLambertMaterial:"lambert",MeshPhongMaterial:"phong",MeshToonMaterial:"toon",MeshStandardMaterial:"physical",MeshPhysicalMaterial:"physical",MeshMatcapMaterial:"matcap",LineBasicMaterial:"basic",LineDashedMaterial:"dashed",PointsMaterial:"points",ShadowMaterial:"shadow",SpriteMaterial:"sprite"};function b(w){return c.add(w),w===0?"uv":`uv${w}`}function m(w,v,P,L,k){const V=L.fog,O=k.geometry,B=w.isMeshStandardMaterial?L.environment:null,X=(w.isMeshStandardMaterial?t:e).get(w.envMap||B),z=X&&X.mapping===Ua?X.image.height:null,K=g[w.type];w.precision!==null&&(f=s.getMaxPrecision(w.precision),f!==w.precision&&Pe("WebGLProgram.getParameters:",w.precision,"not supported, using",f,"instead."));const ee=O.morphAttributes.position||O.morphAttributes.normal||O.morphAttributes.color,oe=ee!==void 0?ee.length:0;let ye=0;O.morphAttributes.position!==void 0&&(ye=1),O.morphAttributes.normal!==void 0&&(ye=2),O.morphAttributes.color!==void 0&&(ye=3);let be,pt,rt,te;if(K){const Ge=Vn[K];be=Ge.vertexShader,pt=Ge.fragmentShader}else be=w.vertexShader,pt=w.fragmentShader,l.update(w),rt=l.getVertexShaderID(w),te=l.getFragmentShaderID(w);const ie=i.getRenderTarget(),_e=i.state.buffers.depth.getReversed(),ze=k.isInstancedMesh===!0,ve=k.isBatchedMesh===!0,We=!!w.map,Be=!!w.matcap,qe=!!X,Je=!!w.aoMap,it=!!w.lightMap,He=!!w.bumpMap,Tt=!!w.normalMap,I=!!w.displacementMap,St=!!w.emissiveMap,Ke=!!w.metalnessMap,mt=!!w.roughnessMap,Te=w.anisotropy>0,R=w.clearcoat>0,_=w.dispersion>0,F=w.iridescence>0,J=w.sheen>0,se=w.transmission>0,Q=Te&&!!w.anisotropyMap,Ae=R&&!!w.clearcoatMap,ce=R&&!!w.clearcoatNormalMap,Me=R&&!!w.clearcoatRoughnessMap,ke=F&&!!w.iridescenceMap,ae=F&&!!w.iridescenceThicknessMap,he=J&&!!w.sheenColorMap,Se=J&&!!w.sheenRoughnessMap,we=!!w.specularMap,ue=!!w.specularColorMap,j=!!w.specularIntensityMap,A=se&&!!w.transmissionMap,G=se&&!!w.thicknessMap,Z=!!w.gradientMap,ne=!!w.alphaMap,$=w.alphaTest>0,W=!!w.alphaHash,re=!!w.extensions;let de=Xn;w.toneMapped&&(ie===null||ie.isXRRenderTarget===!0)&&(de=i.toneMapping);const Le={shaderID:K,shaderType:w.type,shaderName:w.name,vertexShader:be,fragmentShader:pt,defines:w.defines,customVertexShaderID:rt,customFragmentShaderID:te,isRawShaderMaterial:w.isRawShaderMaterial===!0,glslVersion:w.glslVersion,precision:f,batching:ve,batchingColor:ve&&k._colorsTexture!==null,instancing:ze,instancingColor:ze&&k.instanceColor!==null,instancingMorph:ze&&k.morphTexture!==null,outputColorSpace:ie===null?i.outputColorSpace:ie.isXRRenderTarget===!0?ie.texture.colorSpace:tn,alphaToCoverage:!!w.alphaToCoverage,map:We,matcap:Be,envMap:qe,envMapMode:qe&&X.mapping,envMapCubeUVHeight:z,aoMap:Je,lightMap:it,bumpMap:He,normalMap:Tt,displacementMap:I,emissiveMap:St,normalMapObjectSpace:Tt&&w.normalMapType===Gf,normalMapTangentSpace:Tt&&w.normalMapType===lc,metalnessMap:Ke,roughnessMap:mt,anisotropy:Te,anisotropyMap:Q,clearcoat:R,clearcoatMap:Ae,clearcoatNormalMap:ce,clearcoatRoughnessMap:Me,dispersion:_,iridescence:F,iridescenceMap:ke,iridescenceThicknessMap:ae,sheen:J,sheenColorMap:he,sheenRoughnessMap:Se,specularMap:we,specularColorMap:ue,specularIntensityMap:j,transmission:se,transmissionMap:A,thicknessMap:G,gradientMap:Z,opaque:w.transparent===!1&&w.blending===vs&&w.alphaToCoverage===!1,alphaMap:ne,alphaTest:$,alphaHash:W,combine:w.combine,mapUv:We&&b(w.map.channel),aoMapUv:Je&&b(w.aoMap.channel),lightMapUv:it&&b(w.lightMap.channel),bumpMapUv:He&&b(w.bumpMap.channel),normalMapUv:Tt&&b(w.normalMap.channel),displacementMapUv:I&&b(w.displacementMap.channel),emissiveMapUv:St&&b(w.emissiveMap.channel),metalnessMapUv:Ke&&b(w.metalnessMap.channel),roughnessMapUv:mt&&b(w.roughnessMap.channel),anisotropyMapUv:Q&&b(w.anisotropyMap.channel),clearcoatMapUv:Ae&&b(w.clearcoatMap.channel),clearcoatNormalMapUv:ce&&b(w.clearcoatNormalMap.channel),clearcoatRoughnessMapUv:Me&&b(w.clearcoatRoughnessMap.channel),iridescenceMapUv:ke&&b(w.iridescenceMap.channel),iridescenceThicknessMapUv:ae&&b(w.iridescenceThicknessMap.channel),sheenColorMapUv:he&&b(w.sheenColorMap.channel),sheenRoughnessMapUv:Se&&b(w.sheenRoughnessMap.channel),specularMapUv:we&&b(w.specularMap.channel),specularColorMapUv:ue&&b(w.specularColorMap.channel),specularIntensityMapUv:j&&b(w.specularIntensityMap.channel),transmissionMapUv:A&&b(w.transmissionMap.channel),thicknessMapUv:G&&b(w.thicknessMap.channel),alphaMapUv:ne&&b(w.alphaMap.channel),vertexTangents:!!O.attributes.tangent&&(Tt||Te),vertexColors:w.vertexColors,vertexAlphas:w.vertexColors===!0&&!!O.attributes.color&&O.attributes.color.itemSize===4,pointsUvs:k.isPoints===!0&&!!O.attributes.uv&&(We||ne),fog:!!V,useFog:w.fog===!0,fogExp2:!!V&&V.isFogExp2,flatShading:w.flatShading===!0&&w.wireframe===!1,sizeAttenuation:w.sizeAttenuation===!0,logarithmicDepthBuffer:d,reversedDepthBuffer:_e,skinning:k.isSkinnedMesh===!0,morphTargets:O.morphAttributes.position!==void 0,morphNormals:O.morphAttributes.normal!==void 0,morphColors:O.morphAttributes.color!==void 0,morphTargetsCount:oe,morphTextureStride:ye,numDirLights:v.directional.length,numPointLights:v.point.length,numSpotLights:v.spot.length,numSpotLightMaps:v.spotLightMap.length,numRectAreaLights:v.rectArea.length,numHemiLights:v.hemi.length,numDirLightShadows:v.directionalShadowMap.length,numPointLightShadows:v.pointShadowMap.length,numSpotLightShadows:v.spotShadowMap.length,numSpotLightShadowsWithMaps:v.numSpotLightShadowsWithMaps,numLightProbes:v.numLightProbes,numClippingPlanes:a.numPlanes,numClipIntersection:a.numIntersection,dithering:w.dithering,shadowMapEnabled:i.shadowMap.enabled&&P.length>0,shadowMapType:i.shadowMap.type,toneMapping:de,decodeVideoTexture:We&&w.map.isVideoTexture===!0&&et.getTransfer(w.map.colorSpace)===ut,decodeVideoTextureEmissive:St&&w.emissiveMap.isVideoTexture===!0&&et.getTransfer(w.emissiveMap.colorSpace)===ut,premultipliedAlpha:w.premultipliedAlpha,doubleSided:w.side===Pn,flipSided:w.side===Yt,useDepthPacking:w.depthPacking>=0,depthPacking:w.depthPacking||0,index0AttributeName:w.index0AttributeName,extensionClipCullDistance:re&&w.extensions.clipCullDistance===!0&&n.has("WEBGL_clip_cull_distance"),extensionMultiDraw:(re&&w.extensions.multiDraw===!0||ve)&&n.has("WEBGL_multi_draw"),rendererExtensionParallelShaderCompile:n.has("KHR_parallel_shader_compile"),customProgramCacheKey:w.customProgramCacheKey()};return Le.vertexUv1s=c.has(1),Le.vertexUv2s=c.has(2),Le.vertexUv3s=c.has(3),c.clear(),Le}function p(w){const v=[];if(w.shaderID?v.push(w.shaderID):(v.push(w.customVertexShaderID),v.push(w.customFragmentShaderID)),w.defines!==void 0)for(const P in w.defines)v.push(P),v.push(w.defines[P]);return w.isRawShaderMaterial===!1&&(x(v,w),y(v,w),v.push(i.outputColorSpace)),v.push(w.customProgramCacheKey),v.join()}function x(w,v){w.push(v.precision),w.push(v.outputColorSpace),w.push(v.envMapMode),w.push(v.envMapCubeUVHeight),w.push(v.mapUv),w.push(v.alphaMapUv),w.push(v.lightMapUv),w.push(v.aoMapUv),w.push(v.bumpMapUv),w.push(v.normalMapUv),w.push(v.displacementMapUv),w.push(v.emissiveMapUv),w.push(v.metalnessMapUv),w.push(v.roughnessMapUv),w.push(v.anisotropyMapUv),w.push(v.clearcoatMapUv),w.push(v.clearcoatNormalMapUv),w.push(v.clearcoatRoughnessMapUv),w.push(v.iridescenceMapUv),w.push(v.iridescenceThicknessMapUv),w.push(v.sheenColorMapUv),w.push(v.sheenRoughnessMapUv),w.push(v.specularMapUv),w.push(v.specularColorMapUv),w.push(v.specularIntensityMapUv),w.push(v.transmissionMapUv),w.push(v.thicknessMapUv),w.push(v.combine),w.push(v.fogExp2),w.push(v.sizeAttenuation),w.push(v.morphTargetsCount),w.push(v.morphAttributeCount),w.push(v.numDirLights),w.push(v.numPointLights),w.push(v.numSpotLights),w.push(v.numSpotLightMaps),w.push(v.numHemiLights),w.push(v.numRectAreaLights),w.push(v.numDirLightShadows),w.push(v.numPointLightShadows),w.push(v.numSpotLightShadows),w.push(v.numSpotLightShadowsWithMaps),w.push(v.numLightProbes),w.push(v.shadowMapType),w.push(v.toneMapping),w.push(v.numClippingPlanes),w.push(v.numClipIntersection),w.push(v.depthPacking)}function y(w,v){o.disableAll(),v.instancing&&o.enable(0),v.instancingColor&&o.enable(1),v.instancingMorph&&o.enable(2),v.matcap&&o.enable(3),v.envMap&&o.enable(4),v.normalMapObjectSpace&&o.enable(5),v.normalMapTangentSpace&&o.enable(6),v.clearcoat&&o.enable(7),v.iridescence&&o.enable(8),v.alphaTest&&o.enable(9),v.vertexColors&&o.enable(10),v.vertexAlphas&&o.enable(11),v.vertexUv1s&&o.enable(12),v.vertexUv2s&&o.enable(13),v.vertexUv3s&&o.enable(14),v.vertexTangents&&o.enable(15),v.anisotropy&&o.enable(16),v.alphaHash&&o.enable(17),v.batching&&o.enable(18),v.dispersion&&o.enable(19),v.batchingColor&&o.enable(20),v.gradientMap&&o.enable(21),w.push(o.mask),o.disableAll(),v.fog&&o.enable(0),v.useFog&&o.enable(1),v.flatShading&&o.enable(2),v.logarithmicDepthBuffer&&o.enable(3),v.reversedDepthBuffer&&o.enable(4),v.skinning&&o.enable(5),v.morphTargets&&o.enable(6),v.morphNormals&&o.enable(7),v.morphColors&&o.enable(8),v.premultipliedAlpha&&o.enable(9),v.shadowMapEnabled&&o.enable(10),v.doubleSided&&o.enable(11),v.flipSided&&o.enable(12),v.useDepthPacking&&o.enable(13),v.dithering&&o.enable(14),v.transmission&&o.enable(15),v.sheen&&o.enable(16),v.opaque&&o.enable(17),v.pointsUvs&&o.enable(18),v.decodeVideoTexture&&o.enable(19),v.decodeVideoTextureEmissive&&o.enable(20),v.alphaToCoverage&&o.enable(21),w.push(o.mask)}function M(w){const v=g[w.type];let P;if(v){const L=Vn[v];P=Dp.clone(L.uniforms)}else P=w.uniforms;return P}function S(w,v){let P=h.get(v);return P!==void 0?++P.usedTimes:(P=new $x(i,v,w,r),u.push(P),h.set(v,P)),P}function T(w){if(--w.usedTimes===0){const v=u.indexOf(w);u[v]=u[u.length-1],u.pop(),h.delete(w.cacheKey),w.destroy()}}function C(w){l.remove(w)}function N(){l.dispose()}return{getParameters:m,getProgramCacheKey:p,getUniforms:M,acquireProgram:S,releaseProgram:T,releaseShaderCache:C,programs:u,dispose:N}}function t0(){let i=new WeakMap;function e(a){return i.has(a)}function t(a){let o=i.get(a);return o===void 0&&(o={},i.set(a,o)),o}function n(a){i.delete(a)}function s(a,o,l){i.get(a)[o]=l}function r(){i=new WeakMap}return{has:e,get:t,remove:n,update:s,dispose:r}}function n0(i,e){return i.groupOrder!==e.groupOrder?i.groupOrder-e.groupOrder:i.renderOrder!==e.renderOrder?i.renderOrder-e.renderOrder:i.material.id!==e.material.id?i.material.id-e.material.id:i.z!==e.z?i.z-e.z:i.id-e.id}function eh(i,e){return i.groupOrder!==e.groupOrder?i.groupOrder-e.groupOrder:i.renderOrder!==e.renderOrder?i.renderOrder-e.renderOrder:i.z!==e.z?e.z-i.z:i.id-e.id}function th(){const i=[];let e=0;const t=[],n=[],s=[];function r(){e=0,t.length=0,n.length=0,s.length=0}function a(h,d,f,g,b,m){let p=i[e];return p===void 0?(p={id:h.id,object:h,geometry:d,material:f,groupOrder:g,renderOrder:h.renderOrder,z:b,group:m},i[e]=p):(p.id=h.id,p.object=h,p.geometry=d,p.material=f,p.groupOrder=g,p.renderOrder=h.renderOrder,p.z=b,p.group=m),e++,p}function o(h,d,f,g,b,m){const p=a(h,d,f,g,b,m);f.transmission>0?n.push(p):f.transparent===!0?s.push(p):t.push(p)}function l(h,d,f,g,b,m){const p=a(h,d,f,g,b,m);f.transmission>0?n.unshift(p):f.transparent===!0?s.unshift(p):t.unshift(p)}function c(h,d){t.length>1&&t.sort(h||n0),n.length>1&&n.sort(d||eh),s.length>1&&s.sort(d||eh)}function u(){for(let h=e,d=i.length;h<d;h++){const f=i[h];if(f.id===null)break;f.id=null,f.object=null,f.geometry=null,f.material=null,f.group=null}}return{opaque:t,transmissive:n,transparent:s,init:r,push:o,unshift:l,finish:u,sort:c}}function i0(){let i=new WeakMap;function e(n,s){const r=i.get(n);let a;return r===void 0?(a=new th,i.set(n,[a])):s>=r.length?(a=new th,r.push(a)):a=r[s],a}function t(){i=new WeakMap}return{get:e,dispose:t}}function s0(){const i={};return{get:function(e){if(i[e.id]!==void 0)return i[e.id];let t;switch(e.type){case"DirectionalLight":t={direction:new D,color:new Ie};break;case"SpotLight":t={position:new D,direction:new D,color:new Ie,distance:0,coneCos:0,penumbraCos:0,decay:0};break;case"PointLight":t={position:new D,color:new Ie,distance:0,decay:0};break;case"HemisphereLight":t={direction:new D,skyColor:new Ie,groundColor:new Ie};break;case"RectAreaLight":t={color:new Ie,position:new D,halfWidth:new D,halfHeight:new D};break}return i[e.id]=t,t}}}function r0(){const i={};return{get:function(e){if(i[e.id]!==void 0)return i[e.id];let t;switch(e.type){case"DirectionalLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new De};break;case"SpotLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new De};break;case"PointLight":t={shadowIntensity:1,shadowBias:0,shadowNormalBias:0,shadowRadius:1,shadowMapSize:new De,shadowCameraNear:1,shadowCameraFar:1e3};break}return i[e.id]=t,t}}}let a0=0;function o0(i,e){return(e.castShadow?2:0)-(i.castShadow?2:0)+(e.map?1:0)-(i.map?1:0)}function l0(i){const e=new s0,t=r0(),n={version:0,hash:{directionalLength:-1,pointLength:-1,spotLength:-1,rectAreaLength:-1,hemiLength:-1,numDirectionalShadows:-1,numPointShadows:-1,numSpotShadows:-1,numSpotMaps:-1,numLightProbes:-1},ambient:[0,0,0],probe:[],directional:[],directionalShadow:[],directionalShadowMap:[],directionalShadowMatrix:[],spot:[],spotLightMap:[],spotShadow:[],spotShadowMap:[],spotLightMatrix:[],rectArea:[],rectAreaLTC1:null,rectAreaLTC2:null,point:[],pointShadow:[],pointShadowMap:[],pointShadowMatrix:[],hemi:[],numSpotLightShadowsWithMaps:0,numLightProbes:0};for(let c=0;c<9;c++)n.probe.push(new D);const s=new D,r=new Ve,a=new Ve;function o(c){let u=0,h=0,d=0;for(let w=0;w<9;w++)n.probe[w].set(0,0,0);let f=0,g=0,b=0,m=0,p=0,x=0,y=0,M=0,S=0,T=0,C=0;c.sort(o0);for(let w=0,v=c.length;w<v;w++){const P=c[w],L=P.color,k=P.intensity,V=P.distance;let O=null;if(P.shadow&&P.shadow.map&&(P.shadow.map.texture.format===As?O=P.shadow.map.texture:O=P.shadow.map.depthTexture||P.shadow.map.texture),P.isAmbientLight)u+=L.r*k,h+=L.g*k,d+=L.b*k;else if(P.isLightProbe){for(let B=0;B<9;B++)n.probe[B].addScaledVector(P.sh.coefficients[B],k);C++}else if(P.isDirectionalLight){const B=e.get(P);if(B.color.copy(P.color).multiplyScalar(P.intensity),P.castShadow){const X=P.shadow,z=t.get(P);z.shadowIntensity=X.intensity,z.shadowBias=X.bias,z.shadowNormalBias=X.normalBias,z.shadowRadius=X.radius,z.shadowMapSize=X.mapSize,n.directionalShadow[f]=z,n.directionalShadowMap[f]=O,n.directionalShadowMatrix[f]=P.shadow.matrix,x++}n.directional[f]=B,f++}else if(P.isSpotLight){const B=e.get(P);B.position.setFromMatrixPosition(P.matrixWorld),B.color.copy(L).multiplyScalar(k),B.distance=V,B.coneCos=Math.cos(P.angle),B.penumbraCos=Math.cos(P.angle*(1-P.penumbra)),B.decay=P.decay,n.spot[b]=B;const X=P.shadow;if(P.map&&(n.spotLightMap[S]=P.map,S++,X.updateMatrices(P),P.castShadow&&T++),n.spotLightMatrix[b]=X.matrix,P.castShadow){const z=t.get(P);z.shadowIntensity=X.intensity,z.shadowBias=X.bias,z.shadowNormalBias=X.normalBias,z.shadowRadius=X.radius,z.shadowMapSize=X.mapSize,n.spotShadow[b]=z,n.spotShadowMap[b]=O,M++}b++}else if(P.isRectAreaLight){const B=e.get(P);B.color.copy(L).multiplyScalar(k),B.halfWidth.set(P.width*.5,0,0),B.halfHeight.set(0,P.height*.5,0),n.rectArea[m]=B,m++}else if(P.isPointLight){const B=e.get(P);if(B.color.copy(P.color).multiplyScalar(P.intensity),B.distance=P.distance,B.decay=P.decay,P.castShadow){const X=P.shadow,z=t.get(P);z.shadowIntensity=X.intensity,z.shadowBias=X.bias,z.shadowNormalBias=X.normalBias,z.shadowRadius=X.radius,z.shadowMapSize=X.mapSize,z.shadowCameraNear=X.camera.near,z.shadowCameraFar=X.camera.far,n.pointShadow[g]=z,n.pointShadowMap[g]=O,n.pointShadowMatrix[g]=P.shadow.matrix,y++}n.point[g]=B,g++}else if(P.isHemisphereLight){const B=e.get(P);B.skyColor.copy(P.color).multiplyScalar(k),B.groundColor.copy(P.groundColor).multiplyScalar(k),n.hemi[p]=B,p++}}m>0&&(i.has("OES_texture_float_linear")===!0?(n.rectAreaLTC1=pe.LTC_FLOAT_1,n.rectAreaLTC2=pe.LTC_FLOAT_2):(n.rectAreaLTC1=pe.LTC_HALF_1,n.rectAreaLTC2=pe.LTC_HALF_2)),n.ambient[0]=u,n.ambient[1]=h,n.ambient[2]=d;const N=n.hash;(N.directionalLength!==f||N.pointLength!==g||N.spotLength!==b||N.rectAreaLength!==m||N.hemiLength!==p||N.numDirectionalShadows!==x||N.numPointShadows!==y||N.numSpotShadows!==M||N.numSpotMaps!==S||N.numLightProbes!==C)&&(n.directional.length=f,n.spot.length=b,n.rectArea.length=m,n.point.length=g,n.hemi.length=p,n.directionalShadow.length=x,n.directionalShadowMap.length=x,n.pointShadow.length=y,n.pointShadowMap.length=y,n.spotShadow.length=M,n.spotShadowMap.length=M,n.directionalShadowMatrix.length=x,n.pointShadowMatrix.length=y,n.spotLightMatrix.length=M+S-T,n.spotLightMap.length=S,n.numSpotLightShadowsWithMaps=T,n.numLightProbes=C,N.directionalLength=f,N.pointLength=g,N.spotLength=b,N.rectAreaLength=m,N.hemiLength=p,N.numDirectionalShadows=x,N.numPointShadows=y,N.numSpotShadows=M,N.numSpotMaps=S,N.numLightProbes=C,n.version=a0++)}function l(c,u){let h=0,d=0,f=0,g=0,b=0;const m=u.matrixWorldInverse;for(let p=0,x=c.length;p<x;p++){const y=c[p];if(y.isDirectionalLight){const M=n.directional[h];M.direction.setFromMatrixPosition(y.matrixWorld),s.setFromMatrixPosition(y.target.matrixWorld),M.direction.sub(s),M.direction.transformDirection(m),h++}else if(y.isSpotLight){const M=n.spot[f];M.position.setFromMatrixPosition(y.matrixWorld),M.position.applyMatrix4(m),M.direction.setFromMatrixPosition(y.matrixWorld),s.setFromMatrixPosition(y.target.matrixWorld),M.direction.sub(s),M.direction.transformDirection(m),f++}else if(y.isRectAreaLight){const M=n.rectArea[g];M.position.setFromMatrixPosition(y.matrixWorld),M.position.applyMatrix4(m),a.identity(),r.copy(y.matrixWorld),r.premultiply(m),a.extractRotation(r),M.halfWidth.set(y.width*.5,0,0),M.halfHeight.set(0,y.height*.5,0),M.halfWidth.applyMatrix4(a),M.halfHeight.applyMatrix4(a),g++}else if(y.isPointLight){const M=n.point[d];M.position.setFromMatrixPosition(y.matrixWorld),M.position.applyMatrix4(m),d++}else if(y.isHemisphereLight){const M=n.hemi[b];M.direction.setFromMatrixPosition(y.matrixWorld),M.direction.transformDirection(m),b++}}}return{setup:o,setupView:l,state:n}}function nh(i){const e=new l0(i),t=[],n=[];function s(u){c.camera=u,t.length=0,n.length=0}function r(u){t.push(u)}function a(u){n.push(u)}function o(){e.setup(t)}function l(u){e.setupView(t,u)}const c={lightsArray:t,shadowsArray:n,camera:null,lights:e,transmissionRenderTarget:{}};return{init:s,state:c,setupLights:o,setupLightsView:l,pushLight:r,pushShadow:a}}function c0(i){let e=new WeakMap;function t(s,r=0){const a=e.get(s);let o;return a===void 0?(o=new nh(i),e.set(s,[o])):r>=a.length?(o=new nh(i),a.push(o)):o=a[r],o}function n(){e=new WeakMap}return{get:t,dispose:n}}const u0=`void main() {
	gl_Position = vec4( position, 1.0 );
...
void main() {
  ...
  `,{viewPanel:i,viewWellbeing:i.querySelector(".ui-pin-view-score"),viewWellbeingLabel:i.querySelector(".ui-pin-view-label.wellbeing"),viewAnswers:i.querySelector(".ui-pin-view-answers"),viewStation:i.querySelector(".ui-pin-view-station"),viewPending:i.querySelector(".ui-pin-view-pending"),viewTimestamp:i.querySelector(".ui-pin-view-timestamp"),viewScoreDot:i.querySelector(".ui-pin-view-dot")}}function my(){const i=document.createElement("div");i.className="ui ui-pin-panel";const e=document.createElement("button");e.type="button",e.className="ui-pin-toggle",e.textContent=Re("ui.pinToggleIdle"),i.appendChild(e);const t=document.createElement("div");t.className="ui-pin-mode",i.appendChild(t);const n=document.createElement("div");n.className="ui-legend",i.appendChild(n);const{backdrop:s,modal:r,closeButton:a}=zd(),o=document.createElement("form");o.className="ui-form",r.appendChild(o);const l=document.createElement("div");l.className="ui-form-content",o.appendChild(l);const c=py();o.appendChild(c.viewPanel);const u=document.createElement("div");u.className="ui-form-error",o.appendChild(u);const h=document.createElement("div");h.className="ui-form-nav is-hidden";const d=document.createElement("button");d.type="button",d.className="ui-form-back",d.textContent=Re("ui.back");const f=document.createElement("button");f.type="button",f.className="ui-form-next",f.textContent=Re("ui.next"),h.appendChild(d),h.appendChild(f),o.appendChild(h);const g=document.createElement("button");return g.type="submit",g.className="ui-form-submit",g.textContent=Re("ui.save"),o.appendChild(g),{panel:i,toggleButton:e,backdrop:s,form:o,formContent:l,closeButton:a,submitButton:g,formNav:h,backButton:d,nextButton:f,colorModeRow:t,legend:n,...c}}function Hd(i,{getSelectedFloor:e,getFloorSlabTopY:t,getFloorIntersectTargets:n}){const s=e(),r=typeof n=="function"?n(s):[],a=Array.isArray(r)?r.filter(Boolean):[];if(a.length){const h=i.intersectObjects(a,!0).filter(d=>d.object?.isMesh&&d.object.visible!==!1&&!d.object.userData?.isHitSphere);for(const d of h){if(!d.face)continue;if(d.face.normal.clone().transformDirection(d.object.matrixWorld).y>.18)return{floorIndex:s,position:d.point.clone()}}if(h.length)return{floorIndex:s,position:h[0].point.clone()}}const o=typeof t=="function"?t(s):0,l=new Gn(new D(0,1,0),-o),c=new D;return i.ray.intersectPlane(l,c)?{floorIndex:s,position:c.clone()}:null}const da=550,hr=18,ph=hr;function gy(i){const e=[];return i.children.forEach(t=>{t.children&&t.children.forEach(n=>{n.userData.isHitSphere&&e.push(n)})}),e}function by({camera:i,domElement:e,pinGroup:t,getState:n,getSelectedFloor:s,getFloorSlabTopY:r,getFloorIntersectTargets:a,onPinClick:o,onClusterClick:l,onEmptyClick:c,onFloorClick:u}){const h=new yc,d=new De;let f=0,g=null,b=null,m=null;function p(v){try{e.releasePointerCapture(v)}catch{}}function x(){m&&(m(),m=null),b!==null&&(p(b.pointerId),b=null)}function y(v,P){const L=e.getBoundingClientRect();return d.x=(v-L.left)/L.width*2-1,d.y=-((P-L.top)/L.height)*2+1,h.setFromCamera(d,i),Hd(h,{getSelectedFloor:s,getFloorSlabTopY:r,getFloorIntersectTargets:a})}function M(v){const P="ontouchstart"in window||navigator.maxTouchPoints>0,L=v.pointerType;return L==="touch"||L==="pen"||P&&L==="mouse"}function S(){g=null}function T(){const v=e.ownerDocument||document,P=O=>{if(!g||O.pointerId!==g.pointerId)return;const B=O.clientX-g.startX,X=O.clientY-g.startY;B*B+X*X>hr*hr&&(S(),L())},L=()=>{v.removeEventListener("pointermove",P,!0),v.removeEventListener("pointerup",k,!0),v.removeEventListener("pointercancel",V,!0)},k=O=>{if(!g||O.pointerId!==g.pointerId)return;const{candidate:B,startedAt:X}=g;if(S(),L(),performance.now()-X>da)return;if(M(O)&&O.cancelable&&O.preventDefault(),B?.kind==="cluster"&&typeof l=="function"){l(B.clusterKey);return}if(B?.kind==="pin"){o(B.pin);return}B?.kind==="empty"&&typeof c=="function"&&c()},V=O=>{!g||O.pointerId!==g.pointerId||(S(),L())};v.addEventListener("pointermove",P,!0),v.addEventListener("pointerup",k,!0),v.addEventListener("pointercancel",V,!0)}function C(v,P){const L=e.ownerDocument||document,k=window.setTimeout(()=>{x()},5500);let V=!1;const O=ee=>{if(b===null||ee.pointerId!==b.pointerId)return;const oe=ee.clientX-v,ye=ee.clientY-P;oe*oe+ye*ye>ph*ph&&x()},B=ee=>{if(b===null||ee.pointerId!==b.pointerId)return;if(V){x();return}V=!0;const{clientX:oe,clientY:ye}=ee,be=b.fallbackHit,pt=b.startedAt;if(x(),performance.now()-pt>da)return;const ie=y(oe,ye)||be;ie&&(ee.cancelable&&ee.preventDefault(),u(ie))},X=ee=>{if(!b||V||typeof document<"u"&&!!document.querySelector(".ui-modal-backdrop.is-visible")||ee.target&&ee.target.closest&&ee.target.closest(".ui")||performance.now()-b.startedAt>da)return;V=!0,x();const be=y(ee.clientX,ee.clientY)||b.fallbackHit;be&&(ee.cancelable&&ee.preventDefault(),ee.stopPropagation(),u(be))},z=ee=>{b===null||ee.pointerId!==b.pointerId||(V=!0,x())},K=ee=>{b!==null&&ee.pointerId!==b.pointerId&&(ee.pointerType==="touch"||ee.pointerType==="pen")&&x()};L.addEventListener("pointermove",O,!0),L.addEventListener("pointerup",B,!0),L.addEventListener("click",X,!0),L.addEventListener("pointercancel",z,!0),L.addEventListener("pointerdown",K,!0),m=()=>{clearTimeout(k),L.removeEventListener("pointermove",O,!0),L.removeEventListener("pointerup",B,!0),L.removeEventListener("click",X,!0),L.removeEventListener("pointercancel",z,!0),L.removeEventListener("pointerdown",K,!0)}}e.addEventListener("pointerdown",v=>{if(f=performance.now(),!(v.pointerType!=="mouse"||v.button===0)||v.target.closest(".ui"))return;const L=e.getBoundingClientRect();d.x=(v.clientX-L.left)/L.width*2-1,d.y=-((v.clientY-L.top)/L.height)*2+1,h.setFromCamera(d,i);const k=n(),V=M(v)&&v.cancelable;if(!k.pinMode){const X=h.intersectObjects(t.children,!0);let z={kind:"empty"};if(X.length){let K=X[0].object;for(;K&&!K.userData?.pinData&&!K.userData?.clusterKey;)K=K.parent;K?.userData?.clusterKey?z={kind:"cluster",clusterKey:K.userData.clusterKey}:K?.userData?.pinData&&(z={kind:"pin",pin:K.userData.pinData})}g={pointerId:v.pointerId,startX:v.clientX,startY:v.clientY,startedAt:performance.now(),candidate:z},T();try{e.setPointerCapture?.(v.pointerId)}catch{}if(V&&v.preventDefault(),z.kind==="empty"&&M(v)&&!(typeof document<"u"&&!!document.querySelector(".ui-modal-backdrop.is-visible"))){const ee=y(v.clientX,v.clientY);ee&&(x(),b={pointerId:v.pointerId,clientX:v.clientX,clientY:v.clientY,startedAt:performance.now(),fallbackHit:ee,pointerType:v.pointerType},C(b.clientX,b.clientY))}return}const O=y(v.clientX,v.clientY);if(!O)return;if(M(v)){x(),b={pointerId:v.pointerId,clientX:v.clientX,clientY:v.clientY,startedAt:performance.now(),fallbackHit:O,pointerType:v.pointerType},C(b.clientX,b.clientY);try{e.setPointerCapture?.(v.pointerId)}catch{}v.cancelable&&v.preventDefault();return}u(O)},{passive:!1});let N=null;if(e.addEventListener("mousedown",v=>{if(performance.now()-f<80||v.button!==0||v.target.closest&&v.target.closest(".ui"))return;const P=n(),L="ontouchstart"in window||navigator.maxTouchPoints>0;if(!P?.pinMode&&!L)return;const k=y(v.clientX,v.clientY);k&&(N={startX:v.clientX,startY:v.clientY,startedAt:performance.now(),moved:!1,fallbackHit:k})},!0),e.addEventListener("mousemove",v=>{if(!N)return;const P=v.clientX-N.startX,L=v.clientY-N.startY;P*P+L*L>hr*hr&&(N.moved=!0)},!0),e.addEventListener("mouseup",v=>{if(!N)return;if(v.button!==0){N=null;return}const P=n(),L="ontouchstart"in window||navigator.maxTouchPoints>0;if(!P?.pinMode&&!L){N=null;return}const k=performance.now()-N.startedAt,V=N.moved,O=N.fallbackHit;if(N=null,V||k>da)return;const B=y(v.clientX,v.clientY)||O;B&&u(B)},!0),!("ontouchstart"in window||navigator.maxTouchPoints>0)){let v=!1,P=null;e.addEventListener("pointermove",L=>{v||(v=!0,requestAnimationFrame(()=>{v=!1;const k=e.getBoundingClientRect();d.x=(L.clientX-k.left)/k.width*2-1,d.y=-((L.clientY-k.top)/k.height)*2+1,h.setFromCamera(d,i);const V=gy(t),O=h.intersectObjects(V,!1);let B=null;O.length&&(B=O[0].object.parent),P&&P!==B&&(P.userData.hovered=!1),B?(B.userData.hovered=!0,e.style.cursor="pointer"):e.style.cursor="",P=B}))})}}function _y({camera:i,domElement:e,getState:t,getSelectedFloor:n,getFloorSlabTopY:s,getFloorIntersectTargets:r,controls:a,onFloorClick:o}){const l=new yc,c=new De;e.addEventListener("dblclick",u=>{if(u.target.closest(".ui")||t().pinMode||document.querySelector(".ui-modal-backdrop.is-visible"))return;u.preventDefault();const d=e.getBoundingClientRect();c.x=(u.clientX-d.left)/d.width*2-1,c.y=-((u.clientY-d.top)/d.height)*2+1,l.setFromCamera(c,i);const f=Hd(l,{getSelectedFloor:n,getFloorSlabTopY:s,getFloorIntersectTargets:r});if(!f)return;const g=document.querySelector(".ui-modal-backdrop");g&&(g.style.setProperty("--longpress-x",u.clientX+"px"),g.style.setProperty("--longpress-y",u.clientY+"px"),g.classList.add("is-longpress")),a.enabled=!1,requestAnimationFrame(()=>{a.enabled=!0}),o({floorIndex:f.floorIndex,position:f.position})})}function xy(i,e,t,n={}){e.innerHTML="",t.clear();const s=n.displayMode==="step"?"step":"scroll";e.dataset.displayMode=s,i.forEach((r,a)=>{const o=document.createElement("div");o.className="ui-form-group",o.dataset.questionKey=r.key,o.dataset.stepIndex=String(a);const l=document.createElement("div");l.className="ui-form-question",l.textContent=r.label||r.key,o.appendChild(l),s==="step"&&a>0&&o.classList.add("is-hidden");let c={group:o,label:l,type:r.type,inputs:[]};if(r.type==="slider"){const u=document.createElement("div");u.className="ui-slider-legend";const h=document.createElement("span");h.className="ui-slider-legend-low",h.textContent=r.legend_low||"";const d=document.createElement("span");d.className="ui-slider-legend-high",d.textContent=r.legend_high||"",u.appendChild(h),u.appendChild(d),o.appendChild(u);const f=document.createElement("div");f.className="ui-slider-wrap";const g=document.createElement("div");g.className="ui-slider-midbar",g.innerHTML=`
      ...
      `;const b=document.createElement("input");b.type="range",b.name=r.key,b.min=r.config?.min??0,b.max=r.config?.max??1,b.step=r.config?.step??.01,b.value=_r(r.config),f.appendChild(g),f.appendChild(b),o.appendChild(f);const m=()=>{const p=Number(b.min),x=Number(b.max),y=Number(b.value),S=(x===p?.5:(y-p)/(x-p))-.5,T=Math.round(Math.min(.5,Math.abs(S))*100),C=g.querySelector(".ui-slider-midfill.neg"),N=g.querySelector(".ui-slider-midfill.pos");C&&(C.style.width=S<0?`${T}%`:"0%"),N&&(N.style.width=S>0?`${T}%`:"0%")};b.addEventListener("input",m),m(),c={...c,input:b,legendLow:h,legendHigh:d,syncMidFill:m}}if(r.type==="multi"){const u=document.createElement("div");u.className="ui-form-reasons";const h=!!r.config?.allow_multiple,d=!!r.config?.allow_other,f=r.config?.other_option_key||"other",g=Number(r.config?.other_max_length)||500,b=h?"checkbox":"radio",m=Array.isArray(r.options)?r.options:[];let p=null;if(m.forEach(x=>{if(d&&x.key===f)return;const y=document.createElement("label");y.className="ui-checkbox";const M=document.createElement("input");M.type=b,M.name=r.key,M.value=x.key;const S=document.createElement("span");S.textContent=x.label||x.key,y.appendChild(M),y.appendChild(S),u.appendChild(y),c.inputs.push({input:M,label:S,key:x.key})}),d){const x=document.createElement("div");x.className="ui-multi-other-row";const y=document.createElement("label");y.className="ui-checkbox ui-multi-other-control";const M=document.createElement("input");M.type=b,M.name=r.key,M.value=f,y.appendChild(M),p=document.createElement("input"),p.type="text",p.className="ui-multi-other-text",p.maxLength=g,p.placeholder=r.other_placeholder||Re("ui.otherPlaceholder"),p.setAttribute("aria-label",p.placeholder),x.appendChild(y),x.appendChild(p),u.appendChild(x),c.inputs.push({input:M,key:f});const S=()=>{M.checked=!1,p.value="",p.classList.remove("is-active")},T=()=>{M.checked=!0,p.classList.add("is-active"),h||c.inputs.forEach(({input:C})=>{C!==M&&(C.checked=!1)})};M.addEventListener("change",()=>{M.checked?(p.classList.add("is-active"),p.focus(),h||c.inputs.forEach(({input:C})=>{C!==M&&(C.checked=!1)})):(p.value="",p.classList.remove("is-active"))}),p.addEventListener("focus",T),p.addEventListener("input",()=>{p.value.trim()&&T()}),p.addEventListener("blur",()=>{p.value.trim()||S()}),c.inputs.forEach(({input:C})=>{C!==M&&C.addEventListener("change",()=>{C.checked&&S()})}),c={...c,allowOther:d,otherKey:f,otherInput:M,otherTextInput:p,allowMultiple:h}}o.appendChild(u)}if(r.type==="text"){const u=document.createElement("textarea");u.name=r.key,u.rows=r.config?.rows??3,o.appendChild(u),c={...c,input:u}}if(r.type==="influence"){const u=r.config||{},h=document.createElement("div");h.className="ui-form-influence",h.setAttribute("role","group"),h.setAttribute("aria-label",r.label||r.key);const d=document.createElement("div");d.className="ui-influence-scale-header";const f=document.createElement("div");f.className="ui-influence-label-col-spacer",f.setAttribute("aria-hidden","true");const g=document.createElement("div");g.className="ui-influence-legend-col";const b=document.createElement("div");b.className="ui-slider-legend ui-influence-track-legend";const m=document.createElement("span");m.className="ui-slider-legend-low",m.textContent=r.legend_negative||"";const p=document.createElement("span");p.className="ui-slider-legend-high",p.textContent=r.legend_positive||"",b.appendChild(m),b.appendChild(p),g.appendChild(b),d.appendChild(f),d.appendChild(g),d.classList.add("is-collapsed"),d.setAttribute("aria-hidden","true"),h.appendChild(d);const x=Array.isArray(r.options)?r.options:[],y=[],M=()=>{const S=y.some(T=>T.checkbox.checked);d.classList.toggle("is-collapsed",!S),d.setAttribute("aria-hidden",S?"false":"true")};x.forEach(S=>{const T=document.createElement("div");T.className="ui-influence-row";const C=document.createElement("label");C.className="ui-influence-label-col ui-influence-check";const N=document.createElement("input");N.type="checkbox",N.dataset.optionKey=S.key;const w=document.createElement("span");w.className="ui-influence-option-label",w.textContent=S.label||S.key,C.appendChild(N),C.appendChild(w);const v=document.createElement("div");v.className="ui-influence-slider-col ui-influence-slider-wrap is-collapsed";const P=document.createElement("div");P.className="ui-influence-midbar",P.innerHTML=`
        ...
        `;const L=document.createElement("input");L.type="range",L.min=u.min??-1,L.max=u.max??1,L.step=u.step??.05,L.value=String(_r(u)),L.disabled=!0,L.setAttribute("aria-label",S.label||S.key),v.appendChild(P),v.appendChild(L);const k=()=>{const V=Number(L.min),O=Number(L.max),B=Number(L.value),z=(O===V?.5:(B-V)/(O-V))-.5,K=Math.round(Math.min(.5,Math.abs(z))*100),ee=P.querySelector(".ui-influence-midfill.neg"),oe=P.querySelector(".ui-influence-midfill.pos");ee&&(ee.style.width=z<0?`${K}%`:"0%"),oe&&(oe.style.width=z>0?`${K}%`:"0%")};L.addEventListener("input",k),k(),N.addEventListener("change",()=>{const V=N.checked;v.classList.toggle("is-collapsed",!V),L.disabled=!V,V||(L.value=String(_r(u)),k()),M()}),T.appendChild(C),T.appendChild(v),h.appendChild(T),y.push({key:S.key,checkbox:N,slider:L,sliderWrap:v,cfg:u,syncMidFill:k})}),o.appendChild(h),c={...c,optionRows:y,influenceScaleHeader:d}}e.appendChild(o),t.set(r.key,c)})}function vy(i,e,t){const n=Number(i.dataset.floorIndex),s=Number(i.dataset.x),r=Number(i.dataset.y),a=Number(i.dataset.z);if(Number.isNaN(n)||Number.isNaN(s))return Pa(i,Re("error.noLocation")),null;const o={};for(const d of e){const f=t.get(d.key);if(!f)continue;const g=Gd(d,f);g!==void 0&&(o[d.key]=g);const b=Vd(d,f,g);if(b)return Pa(i,Re(b)),null}const l={floor_index:n,x:s,y:r,z:a,answers:o},c=i.dataset.stationKey;c&&(l.station_key=c);const u=new Set(["wellbeing","reasons","group","note"]),h={};for(const[d,f]of Object.entries(o))u.has(d)||(h[d]=f);return Object.keys(h).length>0&&(l.generic_answers=h),l}function Gd(i,e){if(e){if(i.type==="slider")return Wl(e.input.value,i.config);if(i.type==="text")return e.input.value.trim();if(i.type==="multi"){const t=!!(e.allowMultiple??i.config?.allow_multiple);let n=e.inputs.filter(s=>s.input.checked).map(s=>s.input.value);if(e.allowOther&&e.otherTextInput){const s=e.otherTextInput.value.trim();if(s.length>0||e.otherTextInput.classList.contains("is-active")||document.activeElement===e.otherTextInput){t?n.includes(e.otherKey)||(n=[...n,e.otherKey]):n=[e.otherKey];const a={selected:n};return s&&(a.other_text=s),a}n=n.filter(a=>a!==e.otherKey)}return t?n:n[0]||""}if(i.type==="influence"){const t={},n=e.optionRows||[];for(const s of n)if(s.checkbox.checked){const r=Number(s.slider.value);t[s.key]=Number.isFinite(r)?Math.round(r*1e4)/1e4:0}return t}}}function Vd(i,e,t){if(i.type==="multi"&&e?.allowOther){const s=(Array.isArray(t?.selected)?t.selected:[]).includes(e.otherKey),r=(t?.other_text||"").trim();if(s&&!r)return"error.otherRequired"}return i.required&&My(t)?"error.required":null}function sr(i,e,t,n){const s=n.get(i);if(s){if(s.input){const r=t.find(a=>a.key===i);if(r?.type==="slider"){s.input.value=br(e,r.config),typeof s.syncMidFill=="function"&&s.syncMidFill();return}s.input.value=e??"";return}if(s.optionRows&&Array.isArray(s.optionRows)){const r=e&&typeof e=="object"&&!Array.isArray(e)?e:{};if(s.optionRows.forEach(a=>{const o=r[a.key],l=o!=null;a.checkbox.checked=l,l?(a.slider.value=String(o),a.slider.disabled=!1,a.sliderWrap.classList.remove("is-collapsed")):(a.slider.value=String(_r(a.cfg||{})),a.slider.disabled=!0,a.sliderWrap.classList.add("is-collapsed")),typeof a.syncMidFill=="function"&&a.syncMidFill()}),s.influenceScaleHeader){const a=s.optionRows.some(o=>o.checkbox.checked);s.influenceScaleHeader.classList.toggle("is-collapsed",!a),s.influenceScaleHeader.setAttribute("aria-hidden",a?"false":"true")}return}if(e&&typeof e=="object"&&!Array.isArray(e)&&Array.isArray(e.selected)){const r=e.selected;if(s.inputs.forEach(a=>{a.input.checked=r.includes(a.input.value)}),s.otherTextInput){const a=r.includes(s.otherKey),o=!!(s.allowMultiple??t.find(l=>l.key===i)?.config?.allow_multiple);s.otherTextInput.value=a&&e.other_text||"",s.otherTextInput.classList.toggle("is-active",a),a&&!o&&(s.inputs.forEach(l=>{l.input.value!==s.otherKey&&(l.input.checked=!1)}),s.otherInput&&(s.otherInput.checked=!0))}return}Array.isArray(e)?s.inputs.forEach(r=>{r.input.checked=e.includes(r.input.value)}):s.inputs.forEach(r=>{r.input.checked=r.input.value===e})}}function mh(i,e){e.forEach(t=>{t.input&&(t.input.disabled=i),t.inputs?.forEach(n=>{n.input.disabled=i}),t.otherTextInput&&(t.otherTextInput.disabled=i),t.optionRows?.forEach(n=>{n.checkbox.disabled=i,n.slider.disabled=i||!n.checkbox.checked})})}function yy(i,e){const t=e.get("wellbeing");if(!t?.input){const s=i.find(r=>r.key==="wellbeing");return Wl(_r(s?.config),s?.config)}const n=i.find(s=>s.key==="wellbeing");return Wl(t.input.value||.5,n?.config)}function My(i){return Array.isArray(i)?i.length===0:i==null?!0:typeof i=="string"?i.trim().length===0:typeof i=="object"&&i!==null&&!Array.isArray(i)?Array.isArray(i.selected)?i.selected.length===0:Object.keys(i).length===0:!1}function Ma(i){if(!i)return[];try{return Array.isArray(i)?i:JSON.parse(i)}catch{return[]}}function Pa(i,e){const t=i.querySelector(".ui-form-error");t&&(t.textContent=e)}function jl(i){const e=i.querySelector(".ui-form-error");e&&(e.textContent="")}function Sy(i){return{pins:[],localPins:[],pinMode:!1,activeFloor:i,pendingMesh:null,expandedClusterKey:null,colorQuestionKey:null,colorQuestions:[],globalColorQuestions:[],lastClusterDistance:null,viewPin:null,questions:[],questionElements:new Map,optionsByQuestion:new Map}}function gh(i){return{...i,id:Number(i.id),floor_index:Number(i.floor_index),position_x:Number(i.position_x),position_y:Number(i.position_y),position_z:Number(i.position_z),wellbeing:Number(i.wellbeing),approved:Number(i.approved),reasons:Array.isArray(i.reasons)?i.reasons:Ma(i.reasons),group_key:i.group_key||null}}function wy(i,e){return i.localPins.some(t=>t.id===e)}function Ey(i,e){return(i.sort??0)-(e.sort??0)}function fa(i,e,t){return(i.optionsByQuestion.get(e)||[]).find(r=>r.key===t)?.label||t}const Wd="default",Vo={[Wd]:["#67001f","#b2182b","#d6604d","#f4a582","#fddbc7","#d1e5f0","#92c5de","#4393c3","#2166ac","#053061"],brownTeal:["#543005","#8c510a","#bf812d","#dfc27d","#f6e8c3","#c7eae5","#80cdc1","#35978f","#01665e","#003c30"],purpleGreen:["#40004b","#762a83","#9970ab","#c2a5cf","#e7d4e8","#d9f0d3","#a6dba0","#5aae61","#1b7837","#00441b"],orangePurple:["#7f3b08","#b35806","#e08214","#fdb863","#fee0b6","#d8daeb","#b2abd2","#8073ac","#542788","#2d004b"],pinkGreen:["#8e0152","#c51b7d","#de77ae","#f1b6da","#fde0ef","#e6f5d0","#b8e186","#7fbc41","#4d9221","#276419"],warmCool:["#b40426","#d95847","#f18d6f","#f7b89c","#edd1c2","#c9d7f0","#a4c2fe","#7da0f9","#5977e3","#3b4cc0"],redYellowBlue:["#a50026","#d73027","#f46d43","#fdae61","#fee090","#e0f3f8","#abd9e9","#74add1","#4575b4","#313695"]},Xl=new Ie(10265519);function jd(i={}){const e=typeof i.color_palette=="string"?i.color_palette.trim():"";return e&&Vo[e]?Vo[e]:Vo[Wd]}function bh(i={}){return`linear-gradient(90deg, ${jd(i).join(", ")})`}function ql(i,e={}){const t=jd(e),n=Number.isFinite(e.min)?Number(e.min):1,s=Number.isFinite(e.max)?Number(e.max):10,r=Number(i);if(!Number.isFinite(r))return Xl;const a=Math.min(Math.max(r,n),s),o=s===n?0:(a-n)/(s-n),l=Math.min(t.length-1,Math.max(0,Math.round(o*(t.length-1))));return new Ie(t[l])}function Ty({state:i,legend:e,colorModeRow:t,form:n,pinGroup:s}){return{getPinColor:r,getColorFromForm:a,updatePreviewColor:o,refreshPinColors:l,refreshPendingPinColor:c,updateLegend:u,updateColorQuestions:h,updateColorModeButtons:d,getActiveColorQuestion:f,getPinScore:g};function r(b){const m=f();if(!m)return Xl;const p=g(b,m);return ql(p,m.config)}function a(){const b=f();if(!b)return Xl;const m=i.questionElements.get(b.key);return ql(m?.input?.value,b.config)}function o(){const b=f();if(!b){n.style.removeProperty("--active-slider-gradient");return}n.style.setProperty("--active-slider-gradient",bh(b.config))}function l(){s.children.forEach(b=>{const m=b.userData.pinData,p=b.userData.orb;if(m&&p){const x=r(m);p.material.color.set(x),p.material.emissive.set(x)}})}function c(){if(!i.pendingMesh)return;const b=i.pendingMesh.userData.orb;if(!b)return;const m=a();b.material.color.set(m),b.material.emissive.set(m)}function u(){e.innerHTML="";const b=f();if(o(),!b)return;const m=document.createElement("div");m.className="ui-legend-gradient",m.style.background=bh(b.config);const p=document.createElement("div");p.className="ui-legend-labels",p.innerHTML=`<span>${b.legend_low||""}</span><span>${b.legend_high||""}</span>`,e.appendChild(m),e.appendChild(p)}function h(){if(Array.isArray(i.globalColorQuestions)&&i.globalColorQuestions.length){const x=i.globalColorQuestions.filter(y=>y&&y.type==="slider");if(x.length){i.colorQuestions=[...x],(!i.colorQuestionKey||!x.some(y=>y.key===i.colorQuestionKey))&&(i.colorQuestionKey=x[0]?.key||null),d();return}}const b=i.questions.filter(x=>x.type==="slider");let p=b.filter(x=>x.config?.use_for_color);if(!p.length){const x=b.find(y=>y.key==="wellbeing");p=x?[x]:b.slice(0,1)}i.colorQuestions=p,(!i.colorQuestionKey||!p.some(x=>x.key===i.colorQuestionKey))&&(i.colorQuestionKey=p[0]?.key||null),d()}function d(){if(t.innerHTML="",i.colorQuestions.length<=1){t.style.display="none";return}t.style.display="",i.colorQuestions.forEach(b=>{const m=document.createElement("button");m.type="button",m.className="ui-pin-mode-button",m.dataset.mode=b.key,m.textContent=b.label||b.key,m.classList.toggle("active",b.key===i.colorQuestionKey),t.appendChild(m)})}function f(){return i.colorQuestionKey&&(i.colorQuestions.find(b=>b.key===i.colorQuestionKey)||i.questions.find(b=>b.key===i.colorQuestionKey))||null}function g(b,m){if(!m)return null;const p=m.key;if(Object.prototype.hasOwnProperty.call(b,p))return br(b[p],m.config);const x=b.answers||b.answer||b.responses;return x&&Object.prototype.hasOwnProperty.call(x,p)?br(x[p],m.config):br(b.wellbeing,m.config)}}function _h(i,e){i.toggleButton.textContent=e.pinMode?Re("ui.pinToggleActive"):Re("ui.pinToggleIdle"),i.closeButton.setAttribute("aria-label",Re("ui.close")),i.submitButton.textContent=Re("ui.save"),i.backButton&&(i.backButton.textContent=Re("ui.back")),i.nextButton&&(i.nextButton.textContent=Re("ui.next")),i.viewWellbeingLabel.textContent=Re("ui.viewWellbeing"),i.viewStation&&(i.viewStation.textContent=""),i.viewPending.textContent=Re("ui.viewPending")}function Ay(i,e,t){i.questions.forEach(n=>{const s=i.questionElements.get(n.key);s&&(s.label.textContent=n.label||n.key,n.type==="slider"&&(s.legendLow.textContent=n.legend_low||"",s.legendHigh.textContent=n.legend_high||""),n.type==="multi"&&s.inputs.forEach(r=>{r.label.textContent=Yl(i,n.key,r.key)}),n.key==="wellbeing"&&(e.viewWellbeingLabel.textContent=n.label||Re("ui.viewWellbeing")))}),t()}function Ry(i,e){if(!i.viewPin)return;const n=Cy(i.viewPin.reasons).map(s=>Yl(i,"reasons",s)).filter(Boolean);e.viewReasons.textContent=n.join(", "),e.viewGroup.textContent=Yl(i,"group",i.viewPin.group_key||""),e.viewNote.textContent=i.viewPin.note||"",e.viewTimestamp.textContent=Ud(i.viewPin.created_at)}function Yl(i,e,t){if(!t)return"";const n=i.optionsByQuestion?.get(e);return Array.isArray(n)&&n.find(r=>r.key===t||r.option_key===t)?.label||t}function Cy(i){if(Array.isArray(i))return i;if(typeof i=="string"){const e=i.trim();if(!e)return[];try{const t=JSON.parse(e);return Array.isArray(t)?t:[e]}catch{return[e]}}return[]}function Py({form:i,formContent:e,submitButton:t,formNav:n,backButton:s,nextButton:r}){let a=!1,o=0,l=()=>({questions:[],questionElements:new Map});const c=()=>Array.from(e.querySelectorAll(".ui-form-group")),u=p=>{t.classList.toggle("is-hidden",!p),t.disabled=!p},h=()=>{a=!1,o=0,n.classList.add("is-hidden"),c().forEach(p=>p.classList.remove("is-hidden")),u(!0)},d=()=>{const p=c();if(!p.length){h();return}o=Math.max(0,Math.min(o,p.length-1)),p.forEach((S,T)=>{S.classList.toggle("is-hidden",T!==o)});const x=o===p.length-1,y=o===0;s.disabled=y,s.classList.toggle("is-hidden",y),r.classList.toggle("is-hidden",x),u(x),e.scrollTop=0;const M=p[o];if(M){const S=M.querySelector("input, textarea, select");S&&typeof S.focus=="function"&&S.focus({preventScroll:!0})}},f=()=>{const x=c()[o];if(!x)return null;const y=x.dataset.questionKey,{questions:M,questionElements:S}=l(),T=M.find(N=>N.key===y)||null,C=S.get(y)||null;return T?{question:T,elements:C}:null},g=()=>{const p=f();if(!p)return!0;const x=Gd(p.question,p.elements),y=Vd(p.question,p.elements,x);return y?(Pa(i,Re(y)),!1):(jl(i),!0)},b=()=>{a&&g()&&(o+=1,d())},m=()=>{a&&(jl(i),o-=1,d())};return s.addEventListener("click",m),r.addEventListener("click",b),{begin({displayMode:p,context:x}){if(l=x||l,p!=="step"||c().length<=1){h();return}a=!0,o=0,n.classList.remove("is-hidden"),d()},reset(){h()},isActive(){return a}}}function Ly({scene:i,camera:e,renderer:t,domElement:n,controls:s,getSelectedFloor:r,getFloorSlabTopY:a,getFloorIntersectTargets:o,getPinScale:l,getPinLift:c,questions:u,requestFrame:h,waitForStationQuestionnaire:d=()=>Promise.resolve()}){const f=Sy(r()),g=new Map,b=new Map;function m(){typeof h=="function"&&h()}const p=new Map,x=new Map;let y=null,M=0;async function S(j){const A=pi();let G=j?.questionnaire_key?String(j.questionnaire_key):"default";if((!G||G==="null"||G==="undefined")&&(G="default"),(!j?.questionnaire_key||G==="default")&&j?.station_key){const $=String(j.station_key);if(p.has($))G=p.get($)||G;else try{const re=(await Nd($))?.questionnaire_key||"default";p.set($,re),j?.questionnaire_key||(G=re)}catch{p.set($,"default")}}const Z=`${G}::${A||""}`;if(!x.has(Z)){const $=await wc({key:G,lang:A}).catch(()=>null);$&&Array.isArray($.questions)&&$.questions.length&&x.set(Z,$)}const ne=x.get(Z);ne&&(G!==y||ne.displayMode!==f.displayMode)&&(y=G,He(ne.questions,G,ne.displayMode),m())}const T=new yn;T.renderOrder=4,i.add(T);const C=new Map,N=my(),{panel:w,toggleButton:v,backdrop:P,form:L,formContent:k,closeButton:V,submitButton:O,formNav:B,backButton:X,nextButton:z,colorModeRow:K,legend:ee,viewPanel:oe,viewWellbeing:ye,viewWellbeingLabel:be,viewAnswers:pt,viewStation:rt,viewPending:te,viewTimestamp:ie,viewScoreDot:_e}=N,ze=Py({form:L,formContent:k,submitButton:O,formNav:B,backButton:X,nextButton:z}),ve={toggleButton:v,closeButton:V,submitButton:O,backButton:X,nextButton:z,viewWellbeingLabel:be,viewPending:te,viewTimestamp:ie,viewStation:rt},We=Se(),Be=Ty({state:f,legend:ee,colorModeRow:K,form:L,pinGroup:T});_h(ve,f),we(),kd(()=>{if(_h(ve,f),we(),Be.updateLegend(),f.viewPin&&L.dataset.mode==="view"&&!oe.classList.contains("is-hidden")){ce(f.viewPin);return}Ry(f,ve)}),He(Array.isArray(u)?u:[]),v.addEventListener("click",()=>{f.pinMode=!f.pinMode,v.classList.toggle("active",f.pinMode),v.textContent=f.pinMode?Re("ui.pinToggleActive"):Re("ui.pinToggleIdle"),s.enabled=!f.pinMode,document.body.classList.toggle("pin-mode",f.pinMode),f.pinMode&&(Be.updateColorQuestions(),Be.updateLegend(),m())}),document.addEventListener("keydown",j=>{if(j.key==="Escape"&&!We.backdrop.classList.contains("is-visible")){if(P.classList.contains("is-visible")){ae();return}f.pinMode&&(f.pinMode=!1,v.classList.remove("active"),v.textContent=Re("ui.pinToggleIdle"),s.enabled=!0,document.body.classList.remove("pin-mode"))}}),K.addEventListener("click",j=>{const A=j.target.closest("button[data-mode]");if(!A||!K.contains(A))return;const G=A.dataset.mode;!G||G===f.colorQuestionKey||(f.colorQuestionKey=G,Be.updateColorModeButtons(),Be.updateLegend(),Be.refreshPinColors(),Be.updatePreviewColor(),m())});let qe=!1,Je=null,it=0;return by({camera:e,domElement:n,pinGroup:T,getState:()=>f,getSelectedFloor:r,getFloorSlabTopY:a,getFloorIntersectTargets:o,onPinClick:j=>Me({pin:j}),onClusterClick:j=>{f.expandedClusterKey=j||null,Ke()},onEmptyClick:()=>{f.expandedClusterKey&&(f.expandedClusterKey=null,Ke())},onFloorClick:({floorIndex:j,position:A})=>{F({floorIndex:j,position:A}),Me({floorIndex:j,position:A})}}),_y({camera:e,domElement:n,getState:()=>f,getSelectedFloor:r,getFloorSlabTopY:a,getFloorIntersectTargets:o,controls:s,onFloorClick:({floorIndex:j,position:A})=>{F({floorIndex:j,position:A}),Me({floorIndex:j,position:A})}}),V.addEventListener("click",()=>{ae()}),P.addEventListener("pointerdown",j=>{j.target===P&&performance.now()<it&&(j.preventDefault(),j.stopPropagation())},!0),P.addEventListener("click",j=>{if(j.target===P){if(performance.now()<it){j.preventDefault(),j.stopPropagation();return}ae()}}),O.addEventListener("click",async j=>{j.preventDefault();const A=vy(L,f.questions,f.questionElements);if(A)try{const G=await ey(A),Z=G&&typeof G=="object"?{...G,generic_answers:G.generic_answers??A.generic_answers??G.generic_answers,asked_questions:G.asked_questions??(f.questions||[]).map(ne=>ne.key).filter(Boolean)}:G;se(Z),await St(f.activeFloor),ke(),f.pinMode=!1,v.classList.remove("active"),s.enabled=!0,document.body.classList.remove("pin-mode")}catch(G){Pa(L,G?.message||Re("error.saveFailed"))}}),L.addEventListener("input",()=>{L.dataset.mode==="create"&&P.classList.contains("is-visible")&&(qe=!0),Be.updatePreviewColor(),Be.refreshPendingPinColor(),m()}),St(f.activeFloor),Be.updateLegend(),Be.updatePreviewColor(),{ui:w,resetUi:()=>{if(P.classList.contains("is-visible")){ae();return}J(),f.viewPin=null,Ae(),f.pinMode=!1,v.classList.remove("active"),v.textContent=Re("ui.pinToggleIdle"),s.enabled=!0,document.body.classList.remove("pin-mode"),m()},setActiveFloor:j=>{f.activeFloor=j;const A=g.get(Number(j));Array.isArray(A)?(f.pins=A,Ke()):(f.pins=[],Ke(),St(f.activeFloor))},update:()=>{let j=!1;const A=e.position.distanceTo(s.target);return(f.lastClusterDistance===null||Math.abs(A-f.lastClusterDistance)>.6)&&(f.lastClusterDistance=A,Ke(),j=!0),T.children.forEach(G=>{if(G.userData.baseY===void 0)return;const Z=G.userData.hovered?G.userData.baseY+.08:G.userData.baseY;G.position.y=It.lerp(G.position.y,Z,.1),Math.abs(G.position.y-Z)>1e-4&&(j=!0);const ne=G.userData.orb;if(ne){const $=G.userData.hovered?.5:.25;ne.material.emissiveIntensity=It.lerp(ne.material.emissiveIntensity,$,.1),Math.abs(ne.material.emissiveIntensity-$)>.02&&(j=!0)}}),j},setQuestions:He,setGlobalColorQuestions:I,setStationKey:j=>{L.dataset.stationKey=j||""}};function He(j,A,G="scroll"){f.questions=Array.isArray(j)?[...j].sort(Ey):[],f.displayMode=G==="step"?"step":"scroll",f.questionElements=new Map,f.optionsByQuestion=new Map,f.questions.forEach(Z=>{Array.isArray(Z.options)&&f.optionsByQuestion.set(Z.key,Z.options)}),A&&(y=A),Be.updateColorQuestions(),xy(f.questions,k,f.questionElements,{displayMode:f.displayMode}),Ay(f,ve,Be.updateColorModeButtons),Be.updateLegend(),Be.refreshPinColors(),Tt(),m()}function Tt(){L.dataset.mode==="create"&&P.classList.contains("is-visible")&&ze.begin({displayMode:f.displayMode,context:()=>({questions:f.questions,questionElements:f.questionElements})})}function I(j){const A=(j||[]).filter(Z=>Z.type==="slider"),G=A.filter(Z=>Z.config?.use_for_color);if(G.length)f.globalColorQuestions=G;else{const Z=A.find(ne=>ne.key==="wellbeing");f.globalColorQuestions=Z?[Z]:A.slice(0,1)}Be.updateColorQuestions(),Be.updateLegend(),Be.refreshPinColors(),m()}async function St(j){const A=Number(j);if(g.has(A))return;if(b.has(A))return b.get(A);const G=(async()=>{try{const ne=(await Jv(A)).map(gh).filter($=>$?.status==="approved"||Number($.approved)===1);g.set(A,ne),f.activeFloor===A&&(f.pins=ne,f.localPins=f.localPins.filter($=>!f.pins.some(W=>W.id===$.id)),Ke())}catch{}finally{b.delete(A)}})();return b.set(A,G),G}function Ke(){const j=f.selectedMesh?.userData?.pinData?.id??null;f.selectedMesh=null,T.clear();const A=[...f.pins,...f.localPins].filter(W=>W.floor_index===f.activeFloor),G=fy(A,e,s,n,a,c),Z=e.position.distanceTo(s.target),ne=Te(Z),$=R(Z);G.forEach(W=>{const re=W.pins.map(de=>String(de.id)).sort().join(",");if(W.pins.length>1&&f.expandedClusterKey&&re===f.expandedClusterKey){const de=typeof l=="function"?Number(l()):1,Le=typeof c=="function"?Number(c()):.35,wt=.55*(Number.isFinite(de)&&de>0?de:1)*ne,Pt=W.pins.length;W.pins.forEach((ge,ot)=>{const at=ot/Pt*Math.PI*2,nn=Math.cos(at)*wt,zt=Math.sin(at)*wt,At=Go(ge,Be.getPinColor(ge));Number.isFinite(de)&&de>0&&At.scale.setScalar(de*ne);const wn=(typeof a=="function"?a(ge.floor_index):ge.position_y)+ge.position_y+(Number.isFinite(Le)?Le:.35);At.position.set(ge.position_x+nn,wn,ge.position_z+zt),At.userData.floorIndex=ge.floor_index,At.userData.pinId=ge.id,At.userData.pinData=ge,At.userData.baseY=wn,T.add(At)});return}if(W.pins.length===1){const de=W.pins[0],Le=Go(de,Be.getPinColor(de)),Ge=typeof l=="function"?Number(l()):1,wt=typeof c=="function"?Number(c()):.35;Number.isFinite(Ge)&&Ge>0&&Le.scale.setScalar(Ge*ne);const ge=(typeof a=="function"?a(de.floor_index):de.position_y)+de.position_y+(Number.isFinite(wt)?wt:.35);Le.position.set(de.position_x,ge,de.position_z),Le.userData.floorIndex=de.floor_index,Le.userData.pinId=de.id,Le.userData.pinData=de,Le.userData.baseY=ge,T.add(Le),j!=null&&de.id===j&&(Le.userData.hovered=!0,f.selectedMesh=Le)}else{const de=_(W.pins),Le=cy(W,C,de),Ge=typeof l=="function"?Number(l()):1,wt=typeof c=="function"?Number(c()):.35;Number.isFinite(Ge)&&Ge>0&&Le.scale.setScalar(2.8*Ge*$),Le.position.copy(W.worldPosition),Le.position.y+=(Number.isFinite(wt)?wt:.35)+.05,Le.userData.floorIndex=f.activeFloor,Le.userData.clusterKey=re,T.add(Le)}}),mt(),m()}function mt(){T.children.forEach(j=>{j.visible=j.userData.floorIndex===f.activeFloor})}function Te(j){if(!Number.isFinite(j))return 1;const A=It.clamp((j-10)/30,0,1);return It.lerp(1,1.18,A)}function R(j){if(!Number.isFinite(j))return 1;const A=It.clamp((j-10)/30,0,1);return It.lerp(1,1.1,A)}function _(j){if(!Array.isArray(j)||!j.length)return new Ie("#1f2937");const A=Be.getActiveColorQuestion();if(!A)return Be.getPinColor(j[0]);let G=0,Z=0;if(j.forEach($=>{const W=Number(Be.getPinScore($,A));Number.isFinite(W)&&(G+=W,Z+=1)}),!Z)return Be.getPinColor(j[0]);const ne=G/Z;return ql(ne,A.config)}function F({floorIndex:j,position:A}){J();const G=typeof a=="function"?a(j):0,Z={id:`local-${Date.now()}`,floor_index:j,position_x:A.x,position_y:A.y-G,position_z:A.z,wellbeing:yy(f.questions,f.questionElements),reasons:[],note:"",approved:0,group_key:null},ne=Go(Z,Be.getPinColor(Z)),$=typeof l=="function"?Number(l()):1,W=typeof c=="function"?Number(c()):.35,re=e.position.distanceTo(s.target),de=Te(re);Number.isFinite($)&&$>0&&ne.scale.setScalar($*de);const Le=G+Z.position_y+(Number.isFinite(W)?W:.35);ne.position.set(A.x,Le,A.z),ne.userData.floorIndex=j,ne.userData.baseY=Le,T.add(ne),f.pendingMesh=ne,m()}function J(){f.pendingMesh&&(T.remove(f.pendingMesh),f.pendingMesh=null,m())}function se(j){if(J(),j){const A=gh(j);A.approved===0&&f.localPins.unshift(A)}Ke()}function Q(j){if(!j)return null;for(const A of T.children)if(A.userData.pinData&&A.userData.pinData.id===j)return A;return null}function Ae(){f.selectedMesh&&(f.selectedMesh.userData.hovered=!1,f.selectedMesh=null)}function ce(j){const A=Be.getActiveColorQuestion()||f.questions.find(ge=>ge.key==="wellbeing")||null,G=A?.key||"wellbeing",Z=G==="wellbeing"?j.wellbeing:G==="note"?j.note:G==="group"?j.group_key:G==="reasons"?Ma(j.reasons):(j&&typeof j.generic_answers=="object"&&j.generic_answers?j.generic_answers:{})[G];be.textContent=A?.label||Re("ui.viewWellbeing"),ye.textContent=A?.type==="slider"?ly(Z):String(Z??Re("ui.empty")),_e.style.background=Be.getPinColor(j).getStyle(),ie.textContent=Ud(j.created_at),ie.dataset.pending=wy(f,j.id)&&j.approved===0?"true":"false";const ne=j?.station_key?String(j.station_key):"",$=ne&&ne!=="default"&&ne!=="null"&&ne!=="undefined";rt.textContent=$?`Station: ${ne}`:"";const W=j&&typeof j.generic_answers=="object"&&j.generic_answers?j.generic_answers:{},re=Array.isArray(j.asked_questions)?j.asked_questions:[],de=re.length?re:(f.questions||[]).map(ge=>ge.key).filter(Boolean),Le=[],Ge=ge=>ge==="wellbeing"?j.wellbeing:ge==="note"?j.note:ge==="group"?j.group_key:ge==="reasons"?Ma(j.reasons):W[ge],wt=ge=>{if(ge==null)return!1;if(Array.isArray(ge))return ge.length>0;if(typeof ge=="object")return Array.isArray(ge.selected)?ge.selected.length>0||!!ge.other_text:Object.keys(ge).length>0;if(typeof ge=="string"){const ot=ge.trim();if(!ot)return!1;if(ot[0]==="{")try{const at=JSON.parse(ot);if(at&&typeof at=="object"&&!Array.isArray(at))return Object.keys(at).length>0}catch{}return!0}return String(ge).trim()!==""},Pt=(ge,ot)=>{if(!ge)return String(ot);if(ge.type==="slider"){const at=Number.isFinite(Number(ge.config?.min))?Number(ge.config.min):0,nn=Number.isFinite(Number(ge.config?.max))?Number(ge.config.max):1,zt=ge.legend_low||"",At=ge.legend_high||"",Gt=br(ot,ge.config||{}),wn=nn===at?.5:Math.max(0,Math.min(1,(Number(Gt)-at)/(nn-at))),Ci=Math.round(wn*100);return`<div class="ui-pin-view-slider">${zt||At?`<div class="ui-pin-view-slider-legend"><span>${zt}</span><span>${At}</span></div>`:""}<div class="ui-pin-view-slider-bar" aria-hidden="true"><div class="ui-pin-view-slider-fill" style="width:${Ci}%"></div></div></div>`}if(ge.type==="text")return String(ot||"").trim()||Re("ui.empty");if(ge.type==="multi"){let at=ot;if(typeof ot=="string"&&ot.trim()[0]==="{")try{at=JSON.parse(ot)}catch{}if(at&&typeof at=="object"&&!Array.isArray(at)&&Array.isArray(at.selected)){const zt=ge.config?.other_option_key||"other",At=at.selected.map(Gt=>Gt===zt&&at.other_text?`${fa(f,ge.key,Gt)}: ${at.other_text}`:fa(f,ge.key,Gt));return At.length?At.join(", "):Re("ui.empty")}const nn=Array.isArray(ot)?ot:ot?[ot]:[];return nn.length?nn.map(zt=>fa(f,ge.key,zt)).join(", "):Re("ui.empty")}if(ge.type==="influence"){let at=ot&&typeof ot=="object"&&!Array.isArray(ot)?ot:{};if(typeof ot=="string")try{const jt=JSON.parse(ot);jt&&typeof jt=="object"&&!Array.isArray(jt)&&(at=jt)}catch{}const nn=Object.keys(at);if(!nn.length)return Re("ui.empty");const zt=Number.isFinite(Number(ge.config?.min))?Number(ge.config.min):-1,At=Number.isFinite(Number(ge.config?.max))?Number(ge.config.max):1,Gt=ge.legend_negative||"",wn=ge.legend_positive||"",Ci=jt=>Math.max(0,Math.min(1,jt)),Gs=jt=>At===zt?.5:(jt-zt)/(At-zt),Qi=Gt||wn?`<div class="ui-pin-view-influence-legend"><span><span>${Gt}</span><span>${wn}</span></span><span></span></div>`:"",Dr=nn.map(jt=>{const Ir=fa(f,ge.key,jt),gi=Number(at[jt]);let Nr=.5;if(Number.isFinite(gi)){const Za=gi>=0&&gi<=1,E=zt>=0&&At<=1;Nr=Ci(Za&&!E?gi:Gs(gi))}const Vs=Nr-.5,Fr=Math.round(Math.min(.5,Math.abs(Vs))*100),Ka=Vs<0?Fr:0,$a=Vs>0?Fr:0;return`
            ...
            `}).join("");return`<div class="ui-pin-view-influence">${Qi}${Dr}</div>`}return String(ot)};de.forEach(ge=>{if(ge===G)return;const ot=f.questions.find(At=>At.key===ge)||null,at=Ge(ge);if(!wt(at))return;const nn=ot?.label||ge,zt=Pt(ot,at);Le.push({key:ge,label:nn,value:zt})}),pt.innerHTML=Le.length?Le.map(ge=>`<div class="ui-pin-view-section"><span class="ui-pin-view-label">${ge.label}</span><span class="ui-pin-view-value">${ge.value}</span></div>`).join(""):`<div class="ui-pin-view-section"><span class="ui-pin-view-value">${Re("ui.empty")}</span></div>`}async function Me({floorIndex:j,position:A,pin:G}){const Z=++M;if(L.reset(),jl(L),L.dataset.mode=G?"view":"create",f.viewPin=G||null,!G&&L.dataset.stationKey){try{await d()}catch{}if(Z!==M)return}if(G){try{await S(G)}catch{}if(Z!==M)return;Ae();const $=Q(G.id);$&&($.userData.hovered=!0,f.selectedMesh=$);const W=Ma(G.reasons),re=G.group_key||"";sr("wellbeing",G.wellbeing,f.questions,f.questionElements),sr("note",G.note||"",f.questions,f.questionElements),sr("reasons",W,f.questions,f.questionElements),sr("group",re?[re]:[],f.questions,f.questionElements),mh(!0,f.questionElements),ze.reset(),O.disabled=!0,O.classList.add("is-hidden"),k.classList.add("is-hidden"),oe.classList.remove("is-hidden"),ce(G),qe=!1}else{mh(!1,f.questionElements),f.questions.forEach(W=>{const re=f.questionElements.get(W.key);re&&(W.type==="influence"?sr(W.key,{},f.questions,f.questionElements):W.type==="slider"&&typeof re.syncMidFill=="function"&&re.syncMidFill())}),O.disabled=!1,O.classList.remove("is-hidden"),k.classList.remove("is-hidden"),oe.classList.add("is-hidden"),L.dataset.floorIndex=j,L.dataset.x=A.x;const $=typeof a=="function"?a(j):0;L.dataset.y=A.y-$,L.dataset.z=A.z,qe=!1,ze.begin({displayMode:f.displayMode,context:()=>({questions:f.questions,questionElements:f.questionElements})})}Be.updatePreviewColor(),P.classList.add("is-visible"),("ontouchstart"in window||navigator.maxTouchPoints>0)&&(it=performance.now()+900),m()}function ke(){it=0,ze.reset(),P.classList.remove("is-visible"),P.classList.remove("is-longpress"),L.dataset.floorIndex="",L.dataset.x="",L.dataset.y="",L.dataset.z="",f.viewPin=null,qe=!1,Ae(),L.dataset.mode==="create"&&J(),f.pinMode=!1,v.classList.remove("active"),v.textContent=Re("ui.pinToggleIdle"),s.enabled=!0,document.body.classList.remove("pin-mode"),m()}async function ae(){return await he()?(ke(),!0):!1}async function he(){return L.dataset.mode!=="create"||!qe?!0:Je||(Je=ue().finally(()=>{Je=null}),Je)}function Se(){const{backdrop:j,modal:A,closeButton:G}=zd();j.classList.add("ui-discard-dialog-backdrop"),A.classList.add("ui-discard-dialog"),G.classList.add("ui-discard-dialog-close");const Z=document.createElement("h3");Z.className="ui-discard-dialog-title";const ne=document.createElement("p");ne.className="ui-discard-dialog-message";const $=document.createElement("div");$.className="ui-discard-dialog-actions";const W=document.createElement("button");W.type="button",W.className="ui-discard-dialog-stay";const re=document.createElement("button");re.type="button",re.className="ui-discard-dialog-save";const de=document.createElement("button");return de.type="button",de.className="ui-discard-dialog-discard",$.appendChild(W),$.appendChild(re),$.appendChild(de),A.appendChild(Z),A.appendChild(ne),A.appendChild($),{backdrop:j,dismissButton:G,title:Z,message:ne,stayButton:W,saveButton:re,discardButton:de}}function we(){We.dismissButton.setAttribute("aria-label",Re("ui.close")),We.title.textContent=Re("ui.discardDraftTitle"),We.message.textContent=Re("ui.discardDraftMessage"),We.stayButton.textContent=Re("ui.discardDraftStay"),We.saveButton.textContent=Re("ui.discardDraftSave"),We.discardButton.textContent=Re("ui.discardDraftDiscard")}function ue(){return we(),new Promise(j=>{const{backdrop:A,dismissButton:G,stayButton:Z,saveButton:ne,discardButton:$}=We;A.classList.add("is-visible");const W=Pt=>{A.classList.remove("is-visible"),G.removeEventListener("click",re),Z.removeEventListener("click",re),ne.removeEventListener("click",de),$.removeEventListener("click",Le),A.removeEventListener("click",Ge),document.removeEventListener("keydown",wt),j(Pt)},re=()=>W(!1),de=()=>{W(!1),O.click()},Le=()=>W(!0),Ge=Pt=>{Pt.target===A&&W(!1)},wt=Pt=>{Pt.key==="Escape"&&(Pt.preventDefault(),W(!1))};G.addEventListener("click",re),Z.addEventListener("click",re),ne.addEventListener("click",de),$.addEventListener("click",Le),A.addEventListener("click",Ge),document.addEventListener("keydown",wt),Z.focus()})}}function Dy(){return[{key:"wellbeing",type:"slider",required:!0,sort:10,config:{min:0,max:1,step:.01,default:.5,use_for_color:!0},label:Re("questions.wellbeing.label"),legend_low:Re("questions.wellbeing.legend_low"),legend_high:Re("questions.wellbeing.legend_high")},{key:"reasons",type:"multi",required:!1,sort:20,config:{allow_multiple:!0},label:Re("questions.reasons.label"),options:[{key:"licht",label:Re("options.reasons.licht"),sort:10},{key:"ruhe",label:Re("options.reasons.ruhe"),sort:20},{key:"laerm",label:Re("options.reasons.laerm"),sort:30},{key:"aussicht",label:Re("options.reasons.aussicht"),sort:40},{key:"sicherheit",label:Re("options.reasons.sicherheit"),sort:50},{key:"sauberkeit",label:Re("options.reasons.sauberkeit"),sort:60},{key:"layout",label:Re("options.reasons.layout"),sort:70},{key:"temperatur",label:Re("options.reasons.temperatur"),sort:80}]},{key:"group",type:"multi",required:!1,sort:30,config:{allow_multiple:!1},label:Re("questions.group.label"),options:[{key:"staff",label:Re("options.group.staff"),sort:10},{key:"studi",label:Re("options.group.studi"),sort:20},{key:"dozierend",label:Re("options.group.dozierend"),sort:30},{key:"other",label:Re("options.group.other"),sort:40}]},{key:"note",type:"text",required:!1,sort:40,config:{rows:3},label:Re("questions.note.label")}]}function Tc(){return{async:!1,breaks:!1,extensions:null,gfm:!0,hooks:null,pedantic:!1,renderer:null,silent:!1,tokenizer:null,walkTokens:null}}var Zi=Tc();function Xd(i){Zi=i}var zi={exec:()=>null};function nt(i,e=""){let t=typeof i=="string"?i:i.source,n={replace:(s,r)=>{let a=typeof r=="string"?r:r.source;return a=a.replace(Jt.caret,"$1"),t=t.replace(s,a),n},getRegex:()=>new RegExp(t,e)};return n}var Iy=(()=>{try{return!!new RegExp("(?<=1)(?<!1)")}catch{return!1}})(),Jt={codeRemoveIndent:/^(?: {1,4}| {0,3}\t)/gm,outputLinkReplace:/\\([\[\]])/g,indentCodeCompensation:/^(\s+)(?:```)/,beginningSpace:/^\s+/,endingHash:/#$/,startingSpaceChar:/^ /,endingSpaceChar:/ $/,nonSpaceChar:/[^ ]/,newLineCharGlobal:/\n/g,tabCharGlobal:/\t/g,multipleSpaceGlobal:/\s+/g,blankLine:/^[ \t]*$/,doubleBlankLine:/\n[ \t]*\n[ \t]*$/,blockquoteStart:/^ {0,3}>/,blockquoteSetextReplace:/\n {0,3}((?:=+|-+) *)(?=\n|$)/g,blockquoteSetextReplace2:/^ {0,3}>[ \t]?/gm,listReplaceNesting:/^ {1,4}(?=( {4})*[^ ])/g,listIsTask:/^\[[ xX]\] +\S/,listReplaceTask:/^\[[ xX]\] +/,listTaskCheckbox:/\[[ xX]\]/,anyLine:/\n.*\n/,hrefBrackets:/^<(.*)>$/,tableDelimiter:/[:|]/,tableAlignChars:/^\||\| *$/g,tableRowBlankLine:/\n[ \t]*$/,tableAlignRight:/^ *-+: *$/,tableAlignCenter:/^ *:-+: *$/,tableAlignLeft:/^ *:-+ *$/,startATag:/^<a /i,endATag:/^<\/a>/i,startPreScriptTag:/^<(pre|code|kbd|script)(\s|>)/i,endPreScriptTag:/^<\/(pre|code|kbd|script)(\s|>)/i,startAngleBracket:/^</,endAngleBracket:/>$/,pedanticHrefTitle:/^([^'"]*[^\s])\s+(['"])(.*)\2/,unicodeAlphaNumeric:/[\p{L}\p{N}]/u,escapeTest:/[&<>"']/,escapeReplace:/[&<>"']/g,escapeTestNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/,escapeReplaceNoEncode:/[<>"']|&(?!(#\d{1,7}|#[Xx][a-fA-F0-9]{1,6}|\w+);)/g,caret:/(^|[^\[])\^/g,percentDecode:/%25/g,findPipe:/\|/g,splitPipe:/ \|/,slashPipe:/\\\|/g,carriageReturn:/\r\n|\r/g,spaceLine:/^ +$/gm,notSpaceStart:/^\S*/,endingNewline:/\n$/,listItemRegex:i=>new RegExp(`^( {0,3}${i})((?:[	 ][^\\n]*)?(?:\\n|$))`),nextBulletRegex:i=>new RegExp(`^ {0,${Math.min(3,i-1)}}(?:[*+-]|\\d{1,9}[.)])((?:[ 	][^\\n]*)?(?:\\n|$))`),hrRegex:i=>new RegExp(`^ {0,${Math.min(3,i-1)}}((?:- *){3,}|(?:_ *){3,}|(?:\\* *){3,})(?:\\n+|$)`),fencesBeginRegex:i=>new RegExp(`^ {0,${Math.min(3,i-1)}}(?:\`\`\`|~~~)`),headingBeginRegex:i=>new RegExp(`^ {0,${Math.min(3,i-1)}}#`),htmlBeginRegex:i=>new RegExp(`^ {0,${Math.min(3,i-1)}}<(?:[a-z].*>|!--)`,"i"),blockquoteBeginRegex:i=>new RegExp(`^ {0,${Math.min(3,i-1)}}>`)},Ny=/^(?:[ \t]*(?:\n|$))+/,Fy=/^((?: {4}| {0,3}\t)[^\n]+(?:\n(?:[ \t]*(?:\n|$))*)?)+/,ky=/^ {0,3}(`{3,}(?=[^`\n]*(?:\n|$))|~{3,})([^\n]*)(?:\n|$)(?:|([\s\S]*?)(?:\n|$))(?: {0,3}\1[~`]* *(?=\n|$)|$)/,Lr=/^ {0,3}((?:-[\t ]*){3,}|(?:_[ \t]*){3,}|(?:\*[ \t]*){3,})(?:\n+|$)/,Uy=/^ {0,3}(#{1,6})(?=\s|$)(.*)(?:\n+|$)/,Ac=/ {0,3}(?:[*+-]|\d{1,9}[.)])/,qd=/^(?!bull |blockCode|fences|blockquote|heading|html|table)((?:.|\n(?!\s*?\n|bull |blockCode|fences|blockquote|heading|html|table))+?)\n {0,3}(=+|-+) *(?:\n+|$)/,Yd=nt(qd).replace(/bull/g,Ac).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/\|table/g,"").getRegex(),Oy=nt(qd).replace(/bull/g,Ac).replace(/blockCode/g,/(?: {4}| {0,3}\t)/).replace(/fences/g,/ {0,3}(?:`{3,}|~{3,})/).replace(/blockquote/g,/ {0,3}>/).replace(/heading/g,/ {0,3}#{1,6}/).replace(/html/g,/ {0,3}<[^\n>]+>\n/).replace(/table/g,/ {0,3}\|?(?:[:\- ]*\|)+[\:\- ]*\n/).getRegex(),Rc=/^([^\n]+(?:\n(?!hr|heading|lheading|blockquote|fences|list|html|table| +\n)[^\n]+)*)/,By=/^[^\n]+/,Cc=/(?!\s*\])(?:\\[\s\S]|[^\[\]\\])+/,zy=nt(/^ {0,3}\[(label)\]: *(?:\n[ \t]*)?([^<\s][^\s]*|<.*?>)(?:(?: +(?:\n[ \t]*)?| *\n[ \t]*)(title))? *(?:\n+|$)/).replace("label",Cc).replace("title",/(?:"(?:\\"?|[^"\\])*"|'[^'\n]*(?:\n[^'\n]+)*\n?'|\([^()]*\))/).getRegex(),Hy=nt(/^(bull)([ \t][^\n]+?)?(?:\n|$)/).replace(/bull/g,Ac).getRegex(),Va="address|article|aside|base|basefont|blockquote|body|caption|center|col|colgroup|dd|details|dialog|dir|div|dl|dt|fieldset|figcaption|figure|footer|form|frame|frameset|h[1-6]|head|header|hr|html|iframe|legend|li|link|main|menu|menuitem|meta|nav|noframes|ol|optgroup|option|p|param|search|section|summary|table|tbody|td|tfoot|th|thead|title|tr|track|ul",Pc=/<!--(?:-?>|[\s\S]*?(?:-->|$))/,Gy=nt("^ {0,3}(?:<(script|pre|style|textarea)[\\s>][\\s\\S]*?(?:</\\1>[^\\n]*\\n+|$)|comment[^\\n]*(\\n+|$)|<\\?[\\s\\S]*?(?:\\?>\\n*|$)|<![A-Z][\\s\\S]*?(?:>\\n*|$)|<!\\[CDATA\\[[\\s\\S]*?(?:\\]\\]>\\n*|$)|</?(tag)(?: +|\\n|/?>)[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|<(?!script|pre|style|textarea)([a-z][\\w-]*)(?:attribute)*? */?>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$)|</(?!script|pre|style|textarea)[a-z][\\w-]*\\s*>(?=[ \\t]*(?:\\n|$))[\\s\\S]*?(?:(?:\\n[ 	]*)+\\n|$))","i").replace("comment",Pc).replace("tag",Va).replace("attribute",/ +[a-zA-Z:_][\w.:-]*(?: *= *"[^"\n]*"| *= *'[^'\n]*'| *= *[^\s"'=<>`]+)?/).getRegex(),Kd=nt(Rc).replace("hr",Lr).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("|table","").replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)])[ \\t]").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",Va).getRegex(),Vy=nt(/^( {0,3}> ?(paragraph|[^\n]*)(?:\n|$))+/).replace("paragraph",Kd).getRegex(),Lc={blockquote:Vy,code:Fy,def:zy,fences:ky,heading:Uy,hr:Lr,html:Gy,lheading:Yd,list:Hy,newline:Ny,paragraph:Kd,table:zi,text:By},xh=nt("^ *([^\\n ].*)\\n {0,3}((?:\\| *)?:?-+:? *(?:\\| *:?-+:? *)*(?:\\| *)?)(?:\\n((?:(?! *\\n|hr|heading|blockquote|code|fences|list|html).*(?:\\n|$))*)\\n*|$)").replace("hr",Lr).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("blockquote"," {0,3}>").replace("code","(?: {4}| {0,3}	)[^\\n]").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)])[ \\t]").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",Va).getRegex(),Wy={...Lc,lheading:Oy,table:xh,paragraph:nt(Rc).replace("hr",Lr).replace("heading"," {0,3}#{1,6}(?:\\s|$)").replace("|lheading","").replace("table",xh).replace("blockquote"," {0,3}>").replace("fences"," {0,3}(?:`{3,}(?=[^`\\n]*\\n)|~{3,})[^\\n]*\\n").replace("list"," {0,3}(?:[*+-]|1[.)])[ \\t]").replace("html","</?(?:tag)(?: +|\\n|/?>)|<(?:script|pre|style|textarea|!--)").replace("tag",Va).getRegex()},jy={...Lc,html:nt(`^ *(?:comment *(?:\\n|\\s*$)|<(tag)[\\s\\S]+?</\\1> *(?:\\n{2,}|\\s*$)|<tag(?:"[^"]*"|'[^']*'|\\s[^'"/>\\s]*)*?/?> *(?:\\n{2,}|\\s*$))`).replace("comment",Pc).replace(/tag/g,"(?!(?:a|em|strong|small|s|cite|q|dfn|abbr|data|time|code|var|samp|kbd|sub|sup|i|b|u|mark|ruby|rt|rp|bdi|bdo|span|br|wbr|ins|del|img)\\b)\\w+(?!:|[^\\w\\s@]*@)\\b").getRegex(),def:/^ *\[([^\]]+)\]: *<?([^\s>]+)>?(?: +(["(][^\n]+[")]))? *(?:\n+|$)/,heading:/^(#{1,6})(.*)(?:\n+|$)/,fences:zi,lheading:/^(.+?)\n {0,3}(=+|-+) *(?:\n+|$)/,paragraph:nt(Rc).replace("hr",Lr).replace("heading",` *#{1,6} *[^
]`).replace("lheading",Yd).replace("|table","").replace("blockquote"," {0,3}>").replace("|fences","").replace("|list","").replace("|html","").replace("|tag","").getRegex()},Xy=/^\\([!"#$%&'()*+,\-./:;<=>?@\[\]\\^_`{|}~])/,qy=/^(`+)([^`]|[^`][\s\S]*?[^`])\1(?!`)/,$d=/^( {2,}|\\)\n(?!\s*$)/,Yy=/^(`+|[^`])(?:(?= {2,}\n)|[\s\S]*?(?:(?=[\\<!\[`*_]|\b_|$)|[^ ](?= {2,}\n)))/,zs=/[\p{P}\p{S}]/u,Wa=/[\s\p{P}\p{S}]/u,Dc=/[^\s\p{P}\p{S}]/u,Ky=nt(/^((?![*_])punctSpace)/,"u").replace(/punctSpace/g,Wa).getRegex(),Zd=/(?!~)[\p{P}\p{S}]/u,$y=/(?!~)[\s\p{P}\p{S}]/u,Zy=/(?:[^\s\p{P}\p{S}]|~)/u,Qy=nt(/link|precode-code|html/,"g").replace("link",/\[(?:[^\[\]`]|(?<a>`+)[^`]+\k<a>(?!`))*?\]\((?:\\[\s\S]|[^\\\(\)]|\((?:\\[\s\S]|[^\\\(\)])*\))*\)/).replace("precode-",Iy?"(?<!`)()":"(^^|[^`])").replace("code",/(?<b>`+)[^`]+\k<b>(?!`)/).replace("html",/<(?! )[^<>]*?>/).getRegex(),Qd=/^(?:\*+(?:((?!\*)punct)|([^\s*]))?)|^_+(?:((?!_)punct)|([^\s_]))?/,Jy=nt(Qd,"u").replace(/punct/g,zs).getRegex(),eM=nt(Qd,"u").replace(/punct/g,Zd).getRegex(),Jd="^[^_*]*?__[^_*]*?\\*[^_*]*?(?=__)|[^*]+(?=[^*])|(?!\\*)punct(\\*+)(?=[\\s]|$)|notPunctSpace(\\*+)(?!\\*)(?=punctSpace|$)|(?!\\*)punctSpace(\\*+)(?=notPunctSpace)|[\\s](\\*+)(?!\\*)(?=punct)|(?!\\*)punct(\\*+)(?!\\*)(?=punct)|notPunctSpace(\\*+)(?=notPunctSpace)",tM=nt(Jd,"gu").replace(/notPunctSpace/g,Dc).replace(/punctSpace/g,Wa).replace(/punct/g,zs).getRegex(),nM=nt(Jd,"gu").replace(/notPunctSpace/g,Zy).replace(/punctSpace/g,$y).replace(/punct/g,Zd).getRegex(),iM=nt("^[^_*]*?\\*\\*[^_*]*?_[^_*]*?(?=\\*\\*)|[^_]+(?=[^_])|(?!_)punct(_+)(?=[\\s]|$)|notPunctSpace(_+)(?!_)(?=punctSpace|$)|(?!_)punctSpace(_+)(?=notPunctSpace)|[\\s](_+)(?!_)(?=punct)|(?!_)punct(_+)(?!_)(?=punct)","gu").replace(/notPunctSpace/g,Dc).replace(/punctSpace/g,Wa).replace(/punct/g,zs).getRegex(),sM=nt(/^~~?(?:((?!~)punct)|[^\s~])/,"u").replace(/punct/g,zs).getRegex(),rM="^[^~]+(?=[^~])|(?!~)punct(~~?)(?=[\\s]|$)|notPunctSpace(~~?)(?!~)(?=punctSpace|$)|(?!~)punctSpace(~~?)(?=notPunctSpace)|[\\s](~~?)(?!~)(?=punct)|(?!~)punct(~~?)(?!~)(?=punct)|notPunctSpace(~~?)(?=notPunctSpace)",aM=nt(rM,"gu").replace(/notPunctSpace/g,Dc).replace(/punctSpace/g,Wa).replace(/punct/g,zs).getRegex(),oM=nt(/\\(punct)/,"gu").replace(/punct/g,zs).getRegex(),lM=nt(/^<(scheme:[^\s\x00-\x1f<>]*|email)>/).replace("scheme",/[a-zA-Z][a-zA-Z0-9+.-]{1,31}/).replace("email",/[a-zA-Z0-9.!#$%&'*+/=?^_`{|}~-]+(@)[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?(?:\.[a-zA-Z0-9](?:[a-zA-Z0-9-]{0,61}[a-zA-Z0-9])?)+(?![-_])/).getRegex(),cM=nt(Pc).replace("(?:-->|$)","-->").getRegex(),uM=nt("^comment|^</[a-zA-Z][\\w:-]*\\s*>|^<[a-zA-Z][\\w-]*(?:attribute)*?\\s*/?>|^<\\?[\\s\\S]*?\\?>|^<![a-zA-Z]+\\s[\\s\\S]*?>|^<!\\[CDATA\\[[\\s\\S]*?\\]\\]>").replace("comment",cM).replace("attribute",/\s+[a-zA-Z:_][\w.:-]*(?:\s*=\s*"[^"]*"|\s*=\s*'[^']*'|\s*=\s*[^\s"'=<>`]+)?/).getRegex(),La=/(?:\[(?:\\[\s\S]|[^\[\]\\])*\]|\\[\s\S]|`+(?!`)[^`]*?`+(?!`)|``+(?=\])|[^\[\]\\`])*?/,hM=nt(/^!?\[(label)\]\(\s*(href)(?:(?:[ \t]+(?:\n[ \t]*)?|\n[ \t]*)(title))?\s*\)/).replace("label",La).replace("href",/<(?:\\.|[^\n<>\\])+>|[^ \t\n\x00-\x1f]*/).replace("title",/"(?:\\"?|[^"\\])*"|'(?:\\'?|[^'\\])*'|\((?:\\\)?|[^)\\])*\)/).getRegex(),ef=nt(/^!?\[(label)\]\[(ref)\]/).replace("label",La).replace("ref",Cc).getRegex(),tf=nt(/^!?\[(ref)\](?:\[\])?/).replace("ref",Cc).getRegex(),dM=nt("reflink|nolink(?!\\()","g").replace("reflink",ef).replace("nolink",tf).getRegex(),vh=/[hH][tT][tT][pP][sS]?|[fF][tT][pP]/,Ic={_backpedal:zi,anyPunctuation:oM,autolink:lM,blockSkip:Qy,br:$d,code:qy,del:zi,delLDelim:zi,delRDelim:zi,emStrongLDelim:Jy,emStrongRDelimAst:tM,emStrongRDelimUnd:iM,escape:Xy,link:hM,nolink:tf,punctuation:Ky,reflink:ef,reflinkSearch:dM,tag:uM,text:Yy,url:zi},fM={...Ic,link:nt(/^!?\[(label)\]\((.*?)\)/).replace("label",La).getRegex(),reflink:nt(/^!?\[(label)\]\s*\[([^\]]*)\]/).replace("label",La).getRegex()},Kl={...Ic,emStrongRDelimAst:nM,emStrongLDelim:eM,delLDelim:sM,delRDelim:aM,url:nt(/^((?:protocol):\/\/|www\.)(?:[a-zA-Z0-9\-]+\.?)+[^\s<]*|^email/).replace("protocol",vh).replace("email",/[A-Za-z0-9._+-]+(@)[a-zA-Z0-9-_]+(?:\.[a-zA-Z0-9-_]*[a-zA-Z0-9])+(?![-_])/).getRegex(),_backpedal:/(?:[^?!.,:;*_'"~()&]+|\([^)]*\)|&(?![a-zA-Z0-9]+;$)|[?!.,:;*_'"~)]+(?!$))+/,del:/^(~~?)(?=[^\s~])((?:\\[\s\S]|[^\\])*?(?:\\[\s\S]|[^\s~\\]))\1(?=[^~]|$)/,text:nt(/^([`~]+|[^`~])(?:(?= {2,}\n)|(?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)|[\s\S]*?(?:(?=[\\<!\[`*~_]|\b_|protocol:\/\/|www\.|$)|[^ ](?= {2,}\n)|[^a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-](?=[a-zA-Z0-9.!#$%&'*+\/=?_`{\|}~-]+@)))/).replace("protocol",vh).getRegex()},pM={...Kl,br:nt($d).replace("{2,}","*").getRegex(),text:nt(Kl.text).replace("\\b_","\\b_| {2,}\\n").replace(/\{2,\}/g,"*").getRegex()},pa={normal:Lc,gfm:Wy,pedantic:jy},rr={normal:Ic,gfm:Kl,breaks:pM,pedantic:fM},mM={"&":"&amp;","<":"&lt;",">":"&gt;",'"':"&quot;","'":"&#39;"},yh=i=>mM[i];function zn(i,e){if(e){if(Jt.escapeTest.test(i))return i.replace(Jt.escapeReplace,yh)}else if(Jt.escapeTestNoEncode.test(i))return i.replace(Jt.escapeReplaceNoEncode,yh);return i}function Mh(i){try{i=encodeURI(i).replace(Jt.percentDecode,"%")}catch{return null}return i}function Sh(i,e){let t=i.replace(Jt.findPipe,(r,a,o)=>{let l=!1,c=a;for(;--c>=0&&o[c]==="\\";)l=!l;return l?"|":" |"}),n=t.split(Jt.splitPipe),s=0;if(n[0].trim()||n.shift(),n.length>0&&!n.at(-1)?.trim()&&n.pop(),e)if(n.length>e)n.splice(e);else for(;n.length<e;)n.push("");for(;s<n.length;s++)n[s]=n[s].trim().replace(Jt.slashPipe,"|");return n}function ar(i,e,t){let n=i.length;if(n===0)return"";let s=0;for(;s<n&&i.charAt(n-s-1)===e;)s++;return i.slice(0,n-s)}function gM(i,e){if(i.indexOf(e[1])===-1)return-1;let t=0;for(let n=0;n<i.length;n++)if(i[n]==="\\")n++;else if(i[n]===e[0])t++;else if(i[n]===e[1]&&(t--,t<0))return n;return t>0?-2:-1}function bM(i,e=0){let t=e,n="";for(let s of i)if(s==="	"){let r=4-t%4;n+=" ".repeat(r),t+=r}else n+=s,t++;return n}function wh(i,e,t,n,s){let r=e.href,a=e.title||null,o=i[1].replace(s.other.outputLinkReplace,"$1");n.state.inLink=!0;let l={type:i[0].charAt(0)==="!"?"image":"link",raw:t,href:r,title:a,text:o,tokens:n.inlineTokens(o)};return n.state.inLink=!1,l}function _M(i,e,t){let n=i.match(t.other.indentCodeCompensation);if(n===null)return e;let s=n[1];return e.split(`
...
`)}}}fences(i){let e=this.rules.block.fences.exec(i);if(e){let t=e[0],n=_M(t,e[3]||"",this.rules);return{type:"code",raw:t,lang:e[2]?e[2].trim().replace(this.rules.inline.anyPunctuation,"$1"):e[2],text:n}}}heading(i){let e=this.rules.block.heading.exec(i);if(e){let t=e[2].trim();if(this.rules.other.endingHash.test(t)){let n=ar(t,"#");(this.options.pedantic||!n||this.rules.other.endingSpaceChar.test(n))&&(t=n.trim())}return{type:"heading",raw:e[0],depth:e[1].length,text:t,tokens:this.lexer.inline(t)}}}hr(i){let e=this.rules.block.hr.exec(i);if(e)return{type:"hr",raw:ar(e[0],`
...
`,i=i.substring(d.length+1),l=!0),!l){let b=this.rules.other.nextBulletRegex(g),m=this.rules.other.hrRegex(g),p=this.rules.other.fencesBeginRegex(g),x=this.rules.other.headingBeginRegex(g),y=this.rules.other.htmlBeginRegex(g),M=this.rules.other.blockquoteBeginRegex(g);for(;i;){let S=i.split(`
`,1)[0],T;if(d=S,this.options.pedantic?(d=d.replace(this.rules.other.listReplaceNesting,"  "),T=d):T=d.replace(this.rules.other.tabCharGlobal,"    "),p.test(d)||x.test(d)||y.test(d)||M.test(d)||b.test(d)||m.test(d))break;if(T.search(this.rules.other.nonSpaceChar)>=g||!d.trim())u+=`
...
`;const UM=ja.querySelectorAll("button[data-rot]"),OM=typeof window<"u"&&window.matchMedia?.("(pointer: coarse)")?.matches===!0&&(navigator.maxTouchPoints||0)>0;function Xa(i){if(!Number.isFinite(i)||i===0)return;const e=yt.position.clone().sub(Qe.target),t=new Ol().setFromVector3(e);t.theta+=i,e.setFromSpherical(t),yt.position.copy(Qe.target).add(e),Qe.update(),cn()}function BM(i){if(!Qe.enabled||i.deltaMode!==0||Math.abs(i.deltaX)<1.5)return;i.preventDefault();const t=It.clamp(i.deltaX*.0022,-.12,.12);Xa(t)}let fr=null;const zM=.36,HM=1;function GM(i){if(OM||!Qe.enabled||typeof i.rotation!="number")return;if(i.preventDefault(),fr===null){fr=i.rotation;return}const e=i.rotation-fr;fr=i.rotation;const t=It.clamp(-It.degToRad(e),-.2,.2);Xa(t)}function lf(){fr=null}const Qn=new Map;let Vi=null,Fc=!0;function qa(){Qn.clear(),Vi=null,Qe.enablePan=Fc}function VM(){if(Qn.size<2)return null;const i=Array.from(Qn.values()),e=i[0],t=i[1];return Math.atan2(t.clientY-e.clientY,t.clientX-e.clientX)}function WM(i){let e=i;for(;e>Math.PI;)e-=Math.PI*2;for(;e<-Math.PI;)e+=Math.PI*2;return e}function jM(){if(!Qe.enabled||Qn.size<2)return;const i=VM();if(!Number.isFinite(i))return;if(Vi===null){Vi=i,Fc=Qe.enablePan,Qe.enablePan=!1;return}const e=WM(i-Vi);Vi=i,!(Math.abs(e)<.0025)&&Xa(e*zM*HM)}function XM(i){i.pointerType==="touch"&&(Qn.set(i.pointerId,{clientX:i.clientX,clientY:i.clientY}),Qn.size===2&&(Vi=null))}function qM(i){i.pointerType==="touch"&&Qn.has(i.pointerId)&&(Qn.set(i.pointerId,{clientX:i.clientX,clientY:i.clientY}),jM())}function cf(i){i.pointerType==="touch"&&(Qn.delete(i.pointerId),Qn.size<2&&(Vi=null,Qe.enablePan=Fc))}const uf=vt?.viewer?.rotateButtonsEnabled!==!1;uf&&UM.forEach(i=>{i.addEventListener("click",e=>{e.preventDefault();const t=Number(i.dataset.rot||0);t!==0&&Xa(t*Math.PI/18)})});let Wt=0,ka=lt?.source==="gltf"?Qe.target.y:lt.getTargetYForFloor(Wt);const{floorButtons:hf,ui:Th}=Kv(lt.maxBasements,lt.maxAboveGroundFloors);uf&&Th.prepend(ja),mi.appendChild(Th);const kc=Qv();mi.appendChild(kc.ui);const Ss={floorIndex:Wt,camera:yt.position.clone(),target:Qe.target.clone()};function df(){Nn.resetUi?.(),Ya(Number(Ss.floorIndex??0)),Qe.target.copy(Ss.target),yt.position.copy(Ss.camera),Qe.update(),cn()}kc.ui.addEventListener("click",i=>{i.preventDefault(),df()});kc.ui.addEventListener("keydown",i=>{i.key!=="Enter"&&i.key!==" "||(i.preventDefault(),df())});const Is=$v({languages:[],activeLanguage:pi(),ariaLabel:Re("ui.language"),onChange:i=>Ec(i)});mi.appendChild(Is.ui);const Ei=Zv();Is.infoButton.addEventListener("click",()=>{Oc(pi(),!0)});let Ql=null;const Ah=new D,Rh=new D;function cn(){Ql==null&&(Ql=requestAnimationFrame(KM))}function YM(){if(!sf)return;const i=6e4;let e=null,t=!1;const n=()=>{window.location.reload()},s=()=>{e!==null&&clearTimeout(e),e=window.setTimeout(n,i)},r=()=>{t=!0,s()};["pointerdown","pointermove","wheel","keydown","touchstart","mousedown"].forEach(o=>{window.addEventListener(o,r,{passive:!0})}),document.addEventListener("visibilitychange",()=>{!document.hidden&&t&&s()})}function KM(){if(Ql=null,typeof document<"u"&&document.hidden)return;if(Ah.copy(yt.position),Rh.copy(Qe.target),Qe.update(),tS(),lt?.source!=="gltf"){const t=ka-Qe.target.y;Math.abs(t)>1e-6&&(Qe.target.y+=t,yt.position.y+=t)}const i=Nn.update(),e=yt.position.distanceToSquared(Ah)>1e-8||Qe.target.distanceToSquared(Rh)>1e-8;Yn.render(qi,yt),(e||i)&&cn()}let Uc=Promise.resolve();const Nn=Ly({scene:qi,camera:yt,renderer:Yn,domElement:Yn.domElement,controls:Qe,requestFrame:cn,getSelectedFloor:()=>Wt,getFloorSlabTopY:i=>lt.getFloorSlabTopY(i),getFloorIntersectTargets:i=>{if(lt?.source!=="gltf"||!Array.isArray(lt.floorGroups))return[];const e=Number(i),t=lt.floorGroups.find(n=>Number(n?.userData?.floorIndex)===e);return t?[t]:lt.floorGroups.filter(Boolean)},getPinScale:()=>of(),getPinLift:()=>kM(),questions:[],waitForStationQuestionnaire:()=>Uc});mi.appendChild(Nn.ui);hf.forEach(i=>{i.addEventListener("click",()=>{Ya(Number(i.dataset.index))})});Ya(Wt);window.addEventListener("resize",eS);document.addEventListener("visibilitychange",()=>{if(!(typeof document>"u")){if(document.hidden){qa();return}cn()}});const On=Yn.domElement;On.addEventListener("gesturestart",lf,{passive:!1});On.addEventListener("gesturechange",GM,{passive:!1});On.addEventListener("gestureend",lf,{passive:!1});On.addEventListener("pointerdown",XM,{passive:!0});On.addEventListener("pointermove",qM,{passive:!0});On.addEventListener("pointerup",cf,{passive:!0});On.addEventListener("pointercancel",cf,{passive:!0});window.addEventListener("blur",qa,{passive:!0});window.addEventListener("touchend",qa,{passive:!0,capture:!0});window.addEventListener("touchcancel",qa,{passive:!0,capture:!0});On.addEventListener("pointerdown",cn,{passive:!0});On.addEventListener("wheel",BM,{passive:!1});On.addEventListener("wheel",cn,{passive:!0});On.addEventListener("pointermove",cn,{passive:!0});Qe.addEventListener("change",cn);cn();YM();kd(i=>{Is.setActiveLanguage(i),Is.setAriaLabel(Re("ui.language")),Na?Uc=pf(Na):ff(i),Ga({lang:i}).then(e=>{Array.isArray(e)&&e.length&&Nn.setGlobalColorQuestions(e)}).catch(()=>{}),Oc(i)});$M();vM?JM():Na?Uc=pf(Na):(ff(pi()),Ga({lang:pi()}).then(i=>{Array.isArray(i)&&i.length&&Nn.setGlobalColorQuestions(i)}).catch(()=>{}));Oc(pi());async function $M(){try{const i=await ty();if(i.length){Is.setLanguages(i.map(e=>({id:e.lang,label:e.label}))),i.some(e=>e.lang===pi())||Ec(i[0].lang);return}}catch{}Is.setLanguages([{id:"de",label:"DE"},{id:"en",label:"EN"}])}async function ff(i){let e=null,t="scroll";try{const n=await wc({key:"default",lang:i});e=n.questions,t=n.displayMode}catch(n){console.warn("[Wellspace viewer] fetchQuestionnaire failed:",n)}if(!Array.isArray(e)||!e.length)try{e=await Ga({lang:i})}catch(n){console.warn("[Wellspace viewer] fetchQuestions fallback failed:",n)}(!Array.isArray(e)||!e.length)&&(console.warn("[Wellspace viewer] No questions from API, using hardcoded fallback"),e=Dy()),Nn.setQuestions(e,"default",t)}let Rr=null,ZM=!1;function QM(i){const e=new DOMParser().parseFromString(i,"text/html");return e.body.querySelectorAll("a").forEach(t=>{const n=document.createElement("span");for(t.id&&(n.id=t.id),t.className&&(n.className=t.className),t.title&&(n.title=t.title);t.firstChild;)n.appendChild(t.firstChild);t.replaceWith(n)}),e.body.innerHTML}async function Oc(i,e=!1){try{const t=await ny({key:"about",lang:i});if(!t.body){e&&Ei.show();return}Rr=t.updated_at,ZM=!0;const n=t.body.replace(/\{\{year\}\}/g,String(new Date().getFullYear()));let s=ft.parse(n);if(typeof s!="string"&&(s=String(s)),sf&&(s=QM(s)),Ei.setContent(s),e){Ei.show();return}const r=localStorage.getItem("about_dismissed_at");(!r||t.updated_at&&t.updated_at>r)&&Ei.show()}catch(t){console.warn("[Wellspace viewer] Failed to load about content:",t),e&&Ei.show()}}Ei.closeButton.addEventListener("click",()=>{Rr&&localStorage.setItem("about_dismissed_at",Rr)});Ei.backdrop.addEventListener("click",i=>{i.target===Ei.backdrop&&Rr&&localStorage.setItem("about_dismissed_at",Rr)});function JM(){Nn.ui.style.display="none";function i(t){window.opener&&window.opener.postMessage(t,"*"),window.parent&&window.parent!==window&&window.parent.postMessage(t,"*")}const e=document.createElement("div");if(e.id="capture-overlay",e.innerHTML=Eh==="pin"?`

...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:si,depthTest:!1,depthWrite:!1})}function u_(i,e,t){const n=new Float32Array(Ni),s=new L(0,1,0);return new Gn({name:"SphericalGaussianBlur",defines:{n:Ni,CUBEUV_TEXEL_WIDTH:1/e,CUBEUV_TEXEL_HEIGHT:1/t,CUBEUV_MAX_MIP:`${i}.0`},uniforms:{envMap:{value:null},samples:{value:1},weights:{value:n},latitudinal:{value:!1},dTheta:{value:0},mipInt:{value:0},poleAxis:{value:s}},vertexShader:Ia(),fragmentShader:`
		...
		`,blending:si,depthTest:!1,depthWrite:!1})}function Pu(){return new Gn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:Ia(),fragmentShader:`
		...
		`,blending:si,depthTest:!1,depthWrite:!1})}function Lu(){return new Gn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:Ia(),fragmentShader:`
	...
	`}function h_(i){let e=new WeakMap,t=null;function n(o){if(o&&o.isTexture){const l=o.mapping,c=l===Go||l===Vo,h=l===zi||l===Ss;if(c||h){let u=e.get(o);const d=u!==void 0?u.texture.pmremVersion:0;if(o.isRenderTargetTexture&&o.pmremVersion!==d)return t===null&&(t=new Ru(i)),u=c?t.fromEquirectangular(o,u):t.fromCubemap(o,u),u.texture.pmremVersion=o.pmremVersion,e.set(o,u),u.texture;if(u!==void 0)return u.texture;{const p=o.image;return c&&p&&p.height>0||h&&p&&s(p)?(t===null&&(t=new Ru(i)),u=c?t.fromEquirectangular(o):t.fromCubemap(o),u.texture.pmremVersion=o.pmremVersion,e.set(o,u),o.addEventListener("dispose",r),u.texture):null}}}return o}function s(o){let l=0;const c=6;for(let h=0;h<c;h++)o[h]!==void 0&&l++;return l===c}function r(o){const l=o.target;l.removeEventListener("dispose",r);const c=e.get(l);c!==void 0&&(e.delete(l),c.dispose())}function a(){e=new WeakMap,t!==null&&(t.dispose(),t=null)}return{get:n,dispose:a}}function d_(i){const e={};function t(n){if(e[n]!==void 0)return e[n];const s=i.getExtension(n);return e[n]=s,s}return{has:function(n){return t(n)!==null},init:function(){t("EXT_color_buffer_float"),t("WEBGL_clip_cull_distance"),t("OES_texture_float_linear"),t("EXT_color_buffer_half_float"),t("WEBGL_multisampled_render_to_texture"),t("WEBGL_render_shared_exponent")},get:function(n){const s=t(n);return s===null&&vr("WebGLRenderer: "+n+" extension not supported."),s}}}function f_(i,e,t,n){const s={},r=new WeakMap;function a(u){const d=u.target;d.index!==null&&e.remove(d.index);for(const g in d.attributes)e.remove(d.attributes[g]);d.removeEventListener("dispose",a),delete s[d.id];const p=r.get(d);p&&(e.remove(p),r.delete(d)),n.releaseStatesOfGeometry(d),d.isInstancedBufferGeometry===!0&&delete d._maxInstanceCount,t.memory.geometries--}function o(u,d){return s[d.id]===!0||(d.addEventListener("dispose",a),s[d.id]=!0,t.memory.geometries++),d}function l(u){const d=u.attributes;for(const p in d)e.update(d[p],i.ARRAY_BUFFER)}function c(u){const d=[],p=u.index,g=u.attributes.position;let b=0;if(p!==null){const v=p.array;b=p.version;for(let M=0,y=v.length;M<y;M+=3){const E=v[M+0],T=v[M+1],C=v[M+2];d.push(E,T,T,C,C,E)}}else if(g!==void 0){const v=g.array;b=g.version;for(let M=0,y=v.length/3-1;M<y;M+=3){const E=M+0,T=M+1,C=M+2;d.push(E,T,T,C,C,E)}}else return;const m=new(Oh(d)?Gh:Hh)(d,1);m.version=b;const f=r.get(u);f&&e.remove(f),r.set(u,m)}function h(u){const d=r.get(u);if(d){const p=u.index;p!==null&&d.version<p.version&&c(u)}else c(u);return r.get(u)}return{get:o,update:l,getWireframeAttribute:h}}function p_(i,e,t){let n;function s(d){n=d}let r,a;function o(d){r=d.type,a=d.bytesPerElement}function l(d,p){i.drawElements(n,p,r,d*a),t.update(p,n,1)}function c(d,p,g){g!==0&&(i.drawElementsInstanced(n,p,r,d*a,g),t.update(p,n,g))}function h(d,p,g){if(g===0)return;e.get("WEBGL_multi_draw").multiDrawElementsWEBGL(n,p,0,r,d,0,g);let m=0;for(let f=0;f<g;f++)m+=p[f];t.update(m,n,1)}function u(d,p,g,b){if(g===0)return;const m=e.get("WEBGL_multi_draw");if(m===null)for(let f=0;f<d.length;f++)c(d[f]/a,p[f],b[f]);else{m.multiDrawElementsInstancedWEBGL(n,p,0,r,d,0,b,0,g);let f=0;for(let v=0;v<g;v++)f+=p[v]*b[v];t.update(f,n,1)}}this.setMode=s,this.setIndex=o,this.render=l,this.renderInstances=c,this.renderMultiDraw=h,this.renderMultiDrawInstances=u}function m_(i){const e={geometries:0,textures:0},t={frame:0,calls:0,triangles:0,points:0,lines:0};function n(r,a,o){switch(t.calls++,a){case i.TRIANGLES:t.triangles+=o*(r/3);break;case i.LINES:t.lines+=o*(r/2);break;case i.LINE_STRIP:t.lines+=o*(r-1);break;case i.LINE_LOOP:t.lines+=o*r;break;case i.POINTS:t.points+=o*r;break;default:Ne("WebGLInfo: Unknown draw mode:",a);break}}function s(){t.calls=0,t.triangles=0,t.points=0,t.lines=0}return{memory:e,render:t,programs:null,autoReset:!0,reset:s,update:n}}function g_(i,e,t){const n=new WeakMap,s=new _t;function r(a,o,l){const c=a.morphTargetInfluences,h=o.morphAttributes.position||o.morphAttributes.normal||o.morphAttributes.color,u=h!==void 0?h.length:0;let d=n.get(o);if(d===void 0||d.count!==u){let _=function(){C.dispose(),n.delete(o),o.removeEventListener("dispose",_)};d!==void 0&&d.texture.dispose();const p=o.morphAttributes.position!==void 0,g=o.morphAttributes.normal!==void 0,b=o.morphAttributes.color!==void 0,m=o.morphAttributes.position||[],f=o.morphAttributes.normal||[],v=o.morphAttributes.color||[];let M=0;p===!0&&(M=1),g===!0&&(M=2),b===!0&&(M=3);let y=o.attributes.position.count*M,E=1;y>e.maxTextureSize&&(E=Math.ceil(y/e.maxTextureSize),y=e.maxTextureSize);const T=new Float32Array(y*E*4*u),C=new Bh(T,y,E,u);C.type=hn,C.needsUpdate=!0;const F=M*4;for(let S=0;S<u;S++){const R=m[S],V=f[S],O=v[S],U=y*E*4*S;for(let j=0;j<R.count;j++){const X=j*F;p===!0&&(s.fromBufferAttribute(R,j),T[U+X+0]=s.x,T[U+X+1]=s.y,T[U+X+2]=s.z,T[U+X+3]=0),g===!0&&(s.fromBufferAttribute(V,j),T[U+X+4]=s.x,T[U+X+5]=s.y,T[U+X+6]=s.z,T[U+X+7]=0),b===!0&&(s.fromBufferAttribute(O,j),T[U+X+8]=s.x,T[U+X+9]=s.y,T[U+X+10]=s.z,T[U+X+11]=O.itemSize===4?s.w:1)}}d={count:u,texture:C,size:new Ce(y,E)},n.set(o,d),o.addEventListener("dispose",_)}if(a.isInstancedMesh===!0&&a.morphTexture!==null)l.getUniforms().setValue(i,"morphTexture",a.morphTexture,t);else{let p=0;for(let b=0;b<c.length;b++)p+=c[b];const g=o.morphTargetsRelative?1:1-p;l.getUniforms().setValue(i,"morphTargetBaseInfluence",g),l.getUniforms().setValue(i,"morphTargetInfluences",c)}l.getUniforms().setValue(i,"morphTargetsTexture",d.texture,t),l.getUniforms().setValue(i,"morphTargetsTextureSize",d.size)}return{update:r}}function b_(i,e,t,n){let s=new WeakMap;function r(l){const c=n.render.frame,h=l.geometry,u=e.get(l,h);if(s.get(u)!==c&&(e.update(u),s.set(u,c)),l.isInstancedMesh&&(l.hasEventListener("dispose",o)===!1&&l.addEventListener("dispose",o),s.get(l)!==c&&(t.update(l.instanceMatrix,i.ARRAY_BUFFER),l.instanceColor!==null&&t.update(l.instanceColor,i.ARRAY_BUFFER),s.set(l,c))),l.isSkinnedMesh){const d=l.skeleton;s.get(d)!==c&&(d.update(),s.set(d,c))}return u}function a(){s=new WeakMap}function o(l){const c=l.target;c.removeEventListener("dispose",o),t.remove(c.instanceMatrix),c.instanceColor!==null&&t.remove(c.instanceColor)}return{update:r,dispose:a}}const __={[Sh]:"LINEAR_TONE_MAPPING",[Mh]:"REINHARD_TONE_MAPPING",[wh]:"CINEON_TONE_MAPPING",[Eh]:"ACES_FILMIC_TONE_MAPPING",[Ah]:"AGX_TONE_MAPPING",[Rh]:"NEUTRAL_TONE_MAPPING",[Th]:"CUSTOM_TONE_MAPPING"};function x_(i,e,t,n,s){const r=new On(e,t,{type:i,depthBuffer:n,stencilBuffer:s}),a=new On(e,t,{type:ai,depthBuffer:!1,stencilBuffer:!1}),o=new Jt;o.setAttribute("position",new Qt([-1,3,0,-1,-1,0,3,-1,0],3)),o.setAttribute("uv",new Qt([0,2,0,0,2,0],2));const l=new Up({uniforms:{tDiffuse:{value:null}},vertexShader:`
			...
			void main() {
				...
				#endif
			}`,depthTest:!1,depthWrite:!1}),c=new Et(o,l),h=new Da(-1,1,1,-1,0,1);let u=null,d=null,p=!1,g,b=null,m=[],f=!1;this.setSize=function(v,M){r.setSize(v,M),a.setSize(v,M);for(let y=0;y<m.length;y++){const E=m[y];E.setSize&&E.setSize(v,M)}},this.setEffects=function(v){m=v,f=m.length>0&&m[0].isRenderPass===!0;const M=r.width,y=r.height;for(let E=0;E<m.length;E++){const T=m[E];T.setSize&&T.setSize(M,y)}},this.begin=function(v,M){if(p||v.toneMapping===Un&&m.length===0)return!1;if(b=M,M!==null){const y=M.width,E=M.height;(r.width!==y||r.height!==E)&&this.setSize(y,E)}return f===!1&&v.setRenderTarget(r),g=v.toneMapping,v.toneMapping=Un,!0},this.hasRenderPass=function(){return f},this.end=function(v,M){v.toneMapping=g,p=!0;let y=r,E=a;for(let T=0;T<m.length;T++){const C=m[T];if(C.enabled!==!1&&(C.render(v,E,y,M),C.needsSwap!==!1)){const F=y;y=E,E=F}}if(u!==v.outputColorSpace||d!==v.toneMapping){u=v.outputColorSpace,d=v.toneMapping,l.defines={},Ke.getTransfer(u)===at&&(l.defines.SRGB_TRANSFER="");const T=__[d];T&&(l.defines[T]=""),l.needsUpdate=!0}l.uniforms.tDiffuse.value=y.texture,v.setRenderTarget(b),v.render(c,h),b=null,p=!1},this.isCompositing=function(){return p},this.dispose=function(){r.dispose(),a.dispose(),o.dispose(),l.dispose()}}const rd=new Pt,Rl=new Sr(1,1),ad=new Bh,od=new sp,ld=new jh,Du=[],Iu=[],Nu=new Float32Array(16),Fu=new Float32Array(9),ku=new Float32Array(4);function ks(i,e,t){const n=i[0];if(n<=0||n>0)return i;const s=e*t;let r=Du[s];if(r===void 0&&(r=new Float32Array(s),Du[s]=r),e!==0){n.toArray(r,0);for(let a=1,o=0;a!==e;++a)o+=t,i[a].toArray(r,o)}return r}function Lt(i,e){if(i.length!==e.length)return!1;for(let t=0,n=i.length;t<n;t++)if(i[t]!==e[t])return!1;return!0}function Dt(i,e){for(let t=0,n=e.length;t<n;t++)i[t]=e[t]}function Na(i,e){let t=Iu[e];t===void 0&&(t=new Int32Array(e),Iu[e]=t);for(let n=0;n!==e;++n)t[n]=i.allocateTextureUnit();return t}function v_(i,e){const t=this.cache;t[0]!==e&&(i.uniform1f(this.addr,e),t[0]=e)}function y_(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2f(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Lt(t,e))return;i.uniform2fv(this.addr,e),Dt(t,e)}}function S_(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3f(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else if(e.r!==void 0)(t[0]!==e.r||t[1]!==e.g||t[2]!==e.b)&&(i.uniform3f(this.addr,e.r,e.g,e.b),t[0]=e.r,t[1]=e.g,t[2]=e.b);else{if(Lt(t,e))return;i.uniform3fv(this.addr,e),Dt(t,e)}}function M_(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4f(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Lt(t,e))return;i.uniform4fv(this.addr,e),Dt(t,e)}}function w_(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(Lt(t,e))return;i.uniformMatrix2fv(this.addr,!1,e),Dt(t,e)}else{if(Lt(t,n))return;ku.set(n),i.uniformMatrix2fv(this.addr,!1,ku),Dt(t,n)}}function E_(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(Lt(t,e))return;i.uniformMatrix3fv(this.addr,!1,e),Dt(t,e)}else{if(Lt(t,n))return;Fu.set(n),i.uniformMatrix3fv(this.addr,!1,Fu),Dt(t,n)}}function T_(i,e){const t=this.cache,n=e.elements;if(n===void 0){if(Lt(t,e))return;i.uniformMatrix4fv(this.addr,!1,e),Dt(t,e)}else{if(Lt(t,n))return;Nu.set(n),i.uniformMatrix4fv(this.addr,!1,Nu),Dt(t,n)}}function A_(i,e){const t=this.cache;t[0]!==e&&(i.uniform1i(this.addr,e),t[0]=e)}function R_(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2i(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Lt(t,e))return;i.uniform2iv(this.addr,e),Dt(t,e)}}function C_(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3i(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(Lt(t,e))return;i.uniform3iv(this.addr,e),Dt(t,e)}}function P_(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4i(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Lt(t,e))return;i.uniform4iv(this.addr,e),Dt(t,e)}}function L_(i,e){const t=this.cache;t[0]!==e&&(i.uniform1ui(this.addr,e),t[0]=e)}function D_(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y)&&(i.uniform2ui(this.addr,e.x,e.y),t[0]=e.x,t[1]=e.y);else{if(Lt(t,e))return;i.uniform2uiv(this.addr,e),Dt(t,e)}}function I_(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z)&&(i.uniform3ui(this.addr,e.x,e.y,e.z),t[0]=e.x,t[1]=e.y,t[2]=e.z);else{if(Lt(t,e))return;i.uniform3uiv(this.addr,e),Dt(t,e)}}function N_(i,e){const t=this.cache;if(e.x!==void 0)(t[0]!==e.x||t[1]!==e.y||t[2]!==e.z||t[3]!==e.w)&&(i.uniform4ui(this.addr,e.x,e.y,e.z,e.w),t[0]=e.x,t[1]=e.y,t[2]=e.z,t[3]=e.w);else{if(Lt(t,e))return;i.uniform4uiv(this.addr,e),Dt(t,e)}}function F_(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s);let r;this.type===i.SAMPLER_2D_SHADOW?(Rl.compareFunction=t.isReversedDepthBuffer()?Jl:Ql,r=Rl):r=rd,t.setTexture2D(e||r,s)}function k_(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTexture3D(e||od,s)}function U_(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTextureCube(e||ld,s)}function O_(i,e,t){const n=this.cache,s=t.allocateTextureUnit();n[0]!==s&&(i.uniform1i(this.addr,s),n[0]=s),t.setTexture2DArray(e||ad,s)}function B_(i){switch(i){case 5126:return v_;case 35664:return y_;case 35665:return S_;case 35666:return M_;case 35674:return w_;case 35675:return E_;case 35676:return T_;case 5124:case 35670:return A_;case 35667:case 35671:return R_;case 35668:case 35672:return C_;case 35669:case 35673:return P_;case 5125:return L_;case 36294:return D_;case 36295:return I_;case 36296:return N_;case 35678:case 36198:case 36298:case 36306:case 35682:return F_;case 35679:case 36299:case 36307:return k_;case 35680:case 36300:case 36308:case 36293:return U_;case 36289:case 36303:case 36311:case 36292:return O_}}function z_(i,e){i.uniform1fv(this.addr,e)}function H_(i,e){const t=ks(e,this.size,2);i.uniform2fv(this.addr,t)}function G_(i,e){const t=ks(e,this.size,3);i.uniform3fv(this.addr,t)}function V_(i,e){const t=ks(e,this.size,4);i.uniform4fv(this.addr,t)}function W_(i,e){const t=ks(e,this.size,4);i.uniformMatrix2fv(this.addr,!1,t)}function j_(i,e){const t=ks(e,this.size,9);i.uniformMatrix3fv(this.addr,!1,t)}function X_(i,e){const t=ks(e,this.size,16);i.uniformMatrix4fv(this.addr,!1,t)}function q_(i,e){i.uniform1iv(this.addr,e)}function Y_(i,e){i.uniform2iv(this.addr,e)}function K_(i,e){i.uniform3iv(this.addr,e)}function $_(i,e){i.uniform4iv(this.addr,e)}function Z_(i,e){i.uniform1uiv(this.addr,e)}function Q_(i,e){i.uniform2uiv(this.addr,e)}function J_(i,e){i.uniform3uiv(this.addr,e)}function ex(i,e){i.uniform4uiv(this.addr,e)}function tx(i,e,t){const n=this.cache,s=e.length,r=Na(t,s);Lt(n,r)||(i.uniform1iv(this.addr,r),Dt(n,r));let a;this.type===i.SAMPLER_2D_SHADOW?a=Rl:a=rd;for(let o=0;o!==s;++o)t.setTexture2D(e[o]||a,r[o])}function nx(i,e,t){const n=this.cache,s=e.length,r=Na(t,s);Lt(n,r)||(i.uniform1iv(this.addr,r),Dt(n,r));for(let a=0;a!==s;++a)t.setTexture3D(e[a]||od,r[a])}function ix(i,e,t){const n=this.cache,s=e.length,r=Na(t,s);Lt(n,r)||(i.uniform1iv(this.addr,r),Dt(n,r));for(let a=0;a!==s;++a)t.setTextureCube(e[a]||ld,r[a])}function sx(i,e,t){const n=this.cache,s=e.length,r=Na(t,s);Lt(n,r)||(i.uniform1iv(this.addr,r),Dt(n,r));for(let a=0;a!==s;++a)t.setTexture2DArray(e[a]||ad,r[a])}function rx(i){switch(i){case 5126:return z_;case 35664:return H_;case 35665:return G_;case 35666:return V_;case 35674:return W_;case 35675:return j_;case 35676:return X_;case 5124:case 35670:return q_;case 35667:case 35671:return Y_;case 35668:case 35672:return K_;case 35669:case 35673:return $_;case 5125:return Z_;case 36294:return Q_;case 36295:return J_;case 36296:return ex;case 35678:case 36198:case 36298:case 36306:case 35682:return tx;case 35679:case 36299:case 36307:return nx;case 35680:case 36300:case 36308:case 36293:return ix;case 36289:case 36303:case 36311:case 36292:return sx}}class ax{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.setValue=B_(t.type)}}class ox{constructor(e,t,n){this.id=e,this.addr=n,this.cache=[],this.type=t.type,this.size=t.size,this.setValue=rx(t.type)}}class lx{constructor(e){this.id=e,this.seq=[],this.map={}}setValue(e,t,n){const s=this.seq;for(let r=0,a=s.length;r!==a;++r){const o=s[r];o.setValue(e,t[o.id],n)}}}const So=/(\w+)(\])?(\[|\.)?/g;function Uu(i,e){i.seq.push(e),i.map[e.id]=e}function cx(i,e,t){const n=i.name,s=n.length;for(So.lastIndex=0;;){const r=So.exec(n),a=So.lastIndex;let o=r[1];const l=r[2]==="]",c=r[3];if(l&&(o=o|0),c===void 0||c==="["&&a+2===s){Uu(t,c===void 0?new ax(o,i,e):new ox(o,i,e));break}else{let u=t.map[o];u===void 0&&(u=new lx(o),Uu(t,u)),t=u}}}class ga{constructor(e,t){this.seq=[],this.map={};const n=e.getProgramParameter(t,e.ACTIVE_UNIFORMS);for(let a=0;a<n;++a){const o=e.getActiveUniform(t,a),l=e.getUniformLocation(t,o.name);cx(o,l,this)}const s=[],r=[];for(const a of this.seq)a.type===e.SAMPLER_2D_SHADOW||a.type===e.SAMPLER_CUBE_SHADOW||a.type===e.SAMPLER_2D_ARRAY_SHADOW?s.push(a):r.push(a);s.length>0&&(this.seq=s.concat(r))}setValue(e,t,n,s){const r=this.map[t];r!==void 0&&r.setValue(e,n,s)}setOptional(e,t,n){const s=t[n];s!==void 0&&this.setValue(e,n,s)}static upload(e,t,n,s){for(let r=0,a=t.length;r!==a;++r){const o=t[r],l=n[o.id];l.needsUpdate!==!1&&o.setValue(e,l.value,s)}}static seqWithValue(e,t){const n=[];for(let s=0,r=e.length;s!==r;++s){const a=e[s];a.id in t&&n.push(a)}return n}}function Ou(i,e,t){const n=i.createShader(e);return i.shaderSource(n,t),i.compileShader(n),n}const ux=37297;let hx=0;function dx(i,e){const t=i.split(`
`),n=[],s=Math.max(e-6,0),r=Math.min(e+6,t.length);for(let a=s;a<r;a++){const o=a+1;n.push(`${o===e?">":" "} ${o}: ${t[a]}`)}return n.join(`
`)}const Bu=new Ge;function fx(i){Ke._getMatrix(Bu,Ke.workingColorSpace,i);const e=`mat3( ${Bu.elements.map(t=>t.toFixed(4))} )`;switch(Ke.getTransfer(i)){case xa:return[e,"LinearTransferOETF"];case at:return[e,"sRGBTransferOETF"];default:return Re("WebGLProgram: Unsupported color space: ",i),[e,"LinearTransferOETF"]}}function zu(i,e,t){const n=i.getShaderParameter(e,i.COMPILE_STATUS),r=(i.getShaderInfoLog(e)||"").trim();if(n&&r==="")return"";const a=/ERROR: 0:(\d+)/.exec(r);if(a){const o=parseInt(a[1]);return t.toUpperCase()+`

`+r+`

`+dx(i.getShaderSource(e),o)}else return r}function px(i,e){const t=fx(e);return[`vec4 ${i}( vec4 value ) {`,`	return ${t[1]}( vec4( value.rgb * ${t[0]}, value.a ) );`,"}"].join(`
`)}const mx={[Sh]:"Linear",[Mh]:"Reinhard",[wh]:"Cineon",[Eh]:"ACESFilmic",[Ah]:"AgX",[Rh]:"Neutral",[Th]:"Custom"};function gx(i,e){const t=mx[e];return t===void 0?(Re("WebGLProgram: Unsupported toneMapping:",e),"vec3 "+i+"( vec3 color ) { return LinearToneMapping( color ); }"):"vec3 "+i+"( vec3 color ) { return "+t+"ToneMapping( color ); }"}const aa=new L;function bx(){Ke.getLuminanceCoefficients(aa);const i=aa.x.toFixed(4),e=aa.y.toFixed(4),t=aa.z.toFixed(4);return["float luminance( const in vec3 rgb ) {",`	const vec3 weights = vec3( ${i}, ${e}, ${t} );`,"	return dot( weights, rgb );","}"].join(`
`)}function _x(i){return[i.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":"",i.extensionMultiDraw?"#extension GL_ANGLE_multi_draw : require":""].filter(rr).join(`
`)}function xx(i){const e=[];for(const t in i){const n=i[t];n!==!1&&e.push("#define "+t+" "+n)}return e.join(`
`)}function vx(i,e){const t={},n=i.getProgramParameter(e,i.ACTIVE_ATTRIBUTES);for(let s=0;s<n;s++){const r=i.getActiveAttrib(e,s),a=r.name;let o=1;r.type===i.FLOAT_MAT2&&(o=2),r.type===i.FLOAT_MAT3&&(o=3),r.type===i.FLOAT_MAT4&&(o=4),t[a]={type:r.type,location:i.getAttribLocation(e,a),locationSize:o}}return t}function rr(i){return i!==""}function Hu(i,e){const t=e.numSpotLightShadows+e.numSpotLightMaps-e.numSpotLightShadowsWithMaps;return i.replace(/NUM_DIR_LIGHTS/g,e.numDirLights).replace(/NUM_SPOT_LIGHTS/g,e.numSpotLights).replace(/NUM_SPOT_LIGHT_MAPS/g,e.numSpotLightMaps).replace(/NUM_SPOT_LIGHT_COORDS/g,t).replace(/NUM_RECT_AREA_LIGHTS/g,e.numRectAreaLights).replace(/NUM_POINT_LIGHTS/g,e.numPointLights).replace(/NUM_HEMI_LIGHTS/g,e.numHemiLights).replace(/NUM_DIR_LIGHT_SHADOWS/g,e.numDirLightShadows).replace(/NUM_SPOT_LIGHT_SHADOWS_WITH_MAPS/g,e.numSpotLightShadowsWithMaps).replace(/NUM_SPOT_LIGHT_SHADOWS/g,e.numSpotLightShadows).replace(/NUM_POINT_LIGHT_SHADOWS/g,e.numPointLightShadows)}function Gu(i,e){return i.replace(/NUM_CLIPPING_PLANES/g,e.numClippingPlanes).replace(/UNION_CLIPPING_PLANES/g,e.numClippingPlanes-e.numClipIntersection)}const yx=/^[ \t]*#include +<([\w\d./]+)>/gm;function Cl(i){return i.replace(yx,Mx)}const Sx=new Map;function Mx(i,e){let t=Ve[e];if(t===void 0){const n=Sx.get(e);if(n!==void 0)t=Ve[n],Re('WebGLRenderer: Shader chunk "%s" has been deprecated. Use "%s" instead.',e,n);else throw new Error("Can not resolve #include <"+e+">")}return Cl(t)}const wx=/#pragma unroll_loop_start\s+for\s*\(\s*int\s+i\s*=\s*(\d+)\s*;\s*i\s*<\s*(\d+)\s*;\s*i\s*\+\+\s*\)\s*{([\s\S]+?)}\s+#pragma unroll_loop_end/g;function Vu(i){return i.replace(wx,Ex)}function Ex(i,e,t,n){let s="";for(let r=parseInt(e);r<parseInt(t);r++)s+=n.replace(/\[\s*i\s*\]/g,"[ "+r+" ]").replace(/UNROLLED_LOOP_INDEX/g,r);return s}function Wu(i){let e=`precision ${i.precision} float;
...
#define LOW_PRECISION`),e}const Tx={[ua]:"SHADOWMAP_TYPE_PCF",[ir]:"SHADOWMAP_TYPE_VSM"};function Ax(i){return Tx[i.shadowMapType]||"SHADOWMAP_TYPE_BASIC"}const Rx={[zi]:"ENVMAP_TYPE_CUBE",[Ss]:"ENVMAP_TYPE_CUBE",[Pa]:"ENVMAP_TYPE_CUBE_UV"};function Cx(i){return i.envMap===!1?"ENVMAP_TYPE_CUBE":Rx[i.envMapMode]||"ENVMAP_TYPE_CUBE"}const Px={[Ss]:"ENVMAP_MODE_REFRACTION"};function Lx(i){return i.envMap===!1?"ENVMAP_MODE_REFLECTION":Px[i.envMapMode]||"ENVMAP_MODE_REFLECTION"}const Dx={[Vl]:"ENVMAP_BLENDING_MULTIPLY",[yf]:"ENVMAP_BLENDING_MIX",[Sf]:"ENVMAP_BLENDING_ADD"};function Ix(i){return i.envMap===!1?"ENVMAP_BLENDING_NONE":Dx[i.combine]||"ENVMAP_BLENDING_NONE"}function Nx(i){const e=i.envMapCubeUVHeight;if(e===null)return null;const t=Math.log2(e)-2,n=1/e;return{texelWidth:1/(3*Math.max(Math.pow(2,t),112)),texelHeight:n,maxMip:t}}function Fx(i,e,t,n){const s=i.getContext(),r=t.defines;let a=t.vertexShader,o=t.fragmentShader;const l=Ax(t),c=Cx(t),h=Lx(t),u=Ix(t),d=Nx(t),p=_x(t),g=xx(r),b=s.createProgram();let m,f,v=t.glslVersion?"#version "+t.glslVersion+`
...
void main() {
  ...
  `,{viewPanel:i,viewWellbeing:i.querySelector(".ui-pin-view-score"),viewWellbeingLabel:i.querySelector(".ui-pin-view-label.wellbeing"),viewAnswers:i.querySelector(".ui-pin-view-answers"),viewStation:i.querySelector(".ui-pin-view-station"),viewPending:i.querySelector(".ui-pin-view-pending"),viewTimestamp:i.querySelector(".ui-pin-view-timestamp"),viewScoreDot:i.querySelector(".ui-pin-view-dot")}}function Kv(){const i=document.createElement("div");i.className="ui ui-pin-panel";const e=document.createElement("button");e.type="button",e.className="ui-pin-toggle",e.textContent=Pe("ui.pinToggleIdle"),i.appendChild(e);const t=document.createElement("div");t.className="ui-pin-mode",i.appendChild(t);const n=document.createElement("div");n.className="ui-legend",i.appendChild(n);const{backdrop:s,modal:r,closeButton:a}=Ad(),o=document.createElement("form");o.className="ui-form",r.appendChild(o);const l=document.createElement("div");l.className="ui-form-content",o.appendChild(l);const c=Yv();o.appendChild(c.viewPanel);const h=document.createElement("div");h.className="ui-form-error",o.appendChild(h);const u=document.createElement("button");return u.type="submit",u.className="ui-form-submit",u.textContent=Pe("ui.save"),o.appendChild(u),{panel:i,toggleButton:e,backdrop:s,form:o,formContent:l,closeButton:a,submitButton:u,colorModeRow:t,legend:n,...c}}const la=550,or=18,rh=or;function $v(i){const e=[];return i.children.forEach(t=>{t.children&&t.children.forEach(n=>{n.userData.isHitSphere&&e.push(n)})}),e}function Zv({camera:i,domElement:e,pinGroup:t,getState:n,getSelectedFloor:s,getFloorSlabTopY:r,onPinClick:a,onClusterClick:o,onEmptyClick:l,onFloorClick:c}){const h=new uc,u=new Ce;let d=0,p=null,g=null,b=null;function m(_){try{e.releasePointerCapture(_)}catch{}}function f(){b&&(b(),b=null),g!==null&&(m(g.pointerId),g=null)}function v(_,S){const R=e.getBoundingClientRect();u.x=(_-R.left)/R.width*2-1,u.y=-((S-R.top)/R.height)*2+1,h.setFromCamera(u,i);const V=s(),O=typeof r=="function"?r(V):0,U=new xn(new L(0,1,0),-O),j=new L;return h.ray.intersectPlane(U,j)?{floorIndex:V,position:j.clone()}:null}function M(_){const S="ontouchstart"in window||navigator.maxTouchPoints>0,R=_.pointerType;return R==="touch"||R==="pen"||S&&R==="mouse"}function y(){p=null}function E(){const _=e.ownerDocument||document,S=U=>{if(!p||U.pointerId!==p.pointerId)return;const j=U.clientX-p.startX,X=U.clientY-p.startY;j*j+X*X>or*or&&(y(),R())},R=()=>{_.removeEventListener("pointermove",S,!0),_.removeEventListener("pointerup",V,!0),_.removeEventListener("pointercancel",O,!0)},V=U=>{if(!p||U.pointerId!==p.pointerId)return;const{candidate:j,startedAt:X}=p;if(y(),R(),performance.now()-X>la)return;if(M(U)&&U.cancelable&&U.preventDefault(),j?.kind==="cluster"&&typeof o=="function"){o(j.clusterKey);return}if(j?.kind==="pin"){a(j.pin);return}j?.kind==="empty"&&typeof l=="function"&&l()},O=U=>{!p||U.pointerId!==p.pointerId||(y(),R())};_.addEventListener("pointermove",S,!0),_.addEventListener("pointerup",V,!0),_.addEventListener("pointercancel",O,!0)}function T(_,S){const R=e.ownerDocument||document,V=window.setTimeout(()=>{f()},5500);let O=!1;const U=te=>{if(g===null||te.pointerId!==g.pointerId)return;const ue=te.clientX-_,he=te.clientY-S;ue*ue+he*he>rh*rh&&f()},j=te=>{if(g===null||te.pointerId!==g.pointerId)return;if(O){f();return}O=!0;const{clientX:ue,clientY:he}=te,xe=g.fallbackHit,Ue=g.startedAt;if(f(),performance.now()-Ue>la)return;const q=v(ue,he)||xe;q&&(te.cancelable&&te.preventDefault(),c(q))},X=te=>{if(!g||O||typeof document<"u"&&!!document.querySelector(".ui-modal-backdrop.is-visible")||te.target&&te.target.closest&&te.target.closest(".ui")||performance.now()-g.startedAt>la)return;O=!0,f();const xe=v(te.clientX,te.clientY)||g.fallbackHit;xe&&(te.cancelable&&te.preventDefault(),te.stopPropagation(),c(xe))},I=te=>{g===null||te.pointerId!==g.pointerId||(O=!0,f())},G=te=>{g!==null&&te.pointerId!==g.pointerId&&(te.pointerType==="touch"||te.pointerType==="pen")&&f()};R.addEventListener("pointermove",U,!0),R.addEventListener("pointerup",j,!0),R.addEventListener("click",X,!0),R.addEventListener("pointercancel",I,!0),R.addEventListener("pointerdown",G,!0),b=()=>{clearTimeout(V),R.removeEventListener("pointermove",U,!0),R.removeEventListener("pointerup",j,!0),R.removeEventListener("click",X,!0),R.removeEventListener("pointercancel",I,!0),R.removeEventListener("pointerdown",G,!0)}}e.addEventListener("pointerdown",_=>{if(d=performance.now(),!(_.pointerType!=="mouse"||_.button===0)||_.target.closest(".ui"))return;const R=e.getBoundingClientRect();u.x=(_.clientX-R.left)/R.width*2-1,u.y=-((_.clientY-R.top)/R.height)*2+1,h.setFromCamera(u,i);const V=n(),O=M(_)&&_.cancelable;if(!V.pinMode){const X=h.intersectObjects(t.children,!0);let I={kind:"empty"};if(X.length){let G=X[0].object;for(;G&&!G.userData?.pinData&&!G.userData?.clusterKey;)G=G.parent;G?.userData?.clusterKey?I={kind:"cluster",clusterKey:G.userData.clusterKey}:G?.userData?.pinData&&(I={kind:"pin",pin:G.userData.pinData})}p={pointerId:_.pointerId,startX:_.clientX,startY:_.clientY,startedAt:performance.now(),candidate:I},E();try{e.setPointerCapture?.(_.pointerId)}catch{}if(O&&_.preventDefault(),I.kind==="empty"&&M(_)&&!(typeof document<"u"&&!!document.querySelector(".ui-modal-backdrop.is-visible"))){const te=v(_.clientX,_.clientY);te&&(f(),g={pointerId:_.pointerId,clientX:_.clientX,clientY:_.clientY,startedAt:performance.now(),fallbackHit:te,pointerType:_.pointerType},T(g.clientX,g.clientY))}return}const U=v(_.clientX,_.clientY);if(!U)return;if(M(_)){f(),g={pointerId:_.pointerId,clientX:_.clientX,clientY:_.clientY,startedAt:performance.now(),fallbackHit:U,pointerType:_.pointerType},T(g.clientX,g.clientY);try{e.setPointerCapture?.(_.pointerId)}catch{}_.cancelable&&_.preventDefault();return}c(U)},{passive:!1});let C=null;if(e.addEventListener("mousedown",_=>{if(performance.now()-d<80||_.button!==0||_.target.closest&&_.target.closest(".ui"))return;const S=n(),R="ontouchstart"in window||navigator.maxTouchPoints>0;if(!S?.pinMode&&!R)return;const V=v(_.clientX,_.clientY);V&&(C={startX:_.clientX,startY:_.clientY,startedAt:performance.now(),moved:!1,fallbackHit:V})},!0),e.addEventListener("mousemove",_=>{if(!C)return;const S=_.clientX-C.startX,R=_.clientY-C.startY;S*S+R*R>or*or&&(C.moved=!0)},!0),e.addEventListener("mouseup",_=>{if(!C)return;if(_.button!==0){C=null;return}const S=n(),R="ontouchstart"in window||navigator.maxTouchPoints>0;if(!S?.pinMode&&!R){C=null;return}const V=performance.now()-C.startedAt,O=C.moved,U=C.fallbackHit;if(C=null,O||V>la)return;const j=v(_.clientX,_.clientY)||U;j&&c(j)},!0),!("ontouchstart"in window||navigator.maxTouchPoints>0)){let _=!1,S=null;e.addEventListener("pointermove",R=>{_||(_=!0,requestAnimationFrame(()=>{_=!1;const V=e.getBoundingClientRect();u.x=(R.clientX-V.left)/V.width*2-1,u.y=-((R.clientY-V.top)/V.height)*2+1,h.setFromCamera(u,i);const O=$v(t),U=h.intersectObjects(O,!1);let j=null;U.length&&(j=U[0].object.parent),S&&S!==j&&(S.userData.hovered=!1),j?(j.userData.hovered=!0,e.style.cursor="pointer"):e.style.cursor="",S=j}))})}}function Qv({camera:i,domElement:e,getState:t,getSelectedFloor:n,getFloorSlabTopY:s,controls:r,onFloorClick:a}){const o=new uc,l=new Ce;e.addEventListener("dblclick",c=>{if(c.target.closest(".ui")||t().pinMode||document.querySelector(".ui-modal-backdrop.is-visible"))return;c.preventDefault();const u=e.getBoundingClientRect();l.x=(c.clientX-u.left)/u.width*2-1,l.y=-((c.clientY-u.top)/u.height)*2+1,o.setFromCamera(l,i);const d=n(),p=typeof s=="function"?s(d):0,g=new xn(new L(0,1,0),-p),b=new L;if(!o.ray.intersectPlane(g,b))return;const m=document.querySelector(".ui-modal-backdrop");m&&(m.style.setProperty("--longpress-x",c.clientX+"px"),m.style.setProperty("--longpress-y",c.clientY+"px"),m.classList.add("is-longpress")),r.enabled=!1,requestAnimationFrame(()=>{r.enabled=!0}),a({floorIndex:d,position:b})})}function Jv(i,e,t){e.innerHTML="",t.clear(),i.forEach(n=>{const s=document.createElement("div");s.className="ui-form-group",s.dataset.questionKey=n.key;const r=document.createElement("div");r.className="ui-form-question",r.textContent=n.label||n.key,s.appendChild(r);let a={group:s,label:r,type:n.type,inputs:[]};if(n.type==="slider"){const o=document.createElement("div");o.className="ui-slider-legend";const l=document.createElement("span");l.className="ui-slider-legend-low",l.textContent=n.legend_low||"";const c=document.createElement("span");c.className="ui-slider-legend-high",c.textContent=n.legend_high||"",o.appendChild(l),o.appendChild(c),s.appendChild(o);const h=document.createElement("div");h.className="ui-slider-wrap";const u=document.createElement("div");u.className="ui-slider-midbar",u.innerHTML=`
      ...
      `;const d=document.createElement("input");d.type="range",d.name=n.key,d.min=n.config?.min??0,d.max=n.config?.max??1,d.step=n.config?.step??.01,d.value=pr(n.config),h.appendChild(u),h.appendChild(d),s.appendChild(h);const p=()=>{const g=Number(d.min),b=Number(d.max),m=Number(d.value),v=(b===g?.5:(m-g)/(b-g))-.5,M=Math.round(Math.min(.5,Math.abs(v))*100),y=u.querySelector(".ui-slider-midfill.neg"),E=u.querySelector(".ui-slider-midfill.pos");y&&(y.style.width=v<0?`${M}%`:"0%"),E&&(E.style.width=v>0?`${M}%`:"0%")};d.addEventListener("input",p),p(),a={...a,input:d,legendLow:l,legendHigh:c,syncMidFill:p}}if(n.type==="multi"){const o=document.createElement("div");o.className="ui-form-reasons";const c=!!n.config?.allow_multiple?"checkbox":"radio";(Array.isArray(n.options)?n.options:[]).forEach(u=>{const d=document.createElement("label");d.className="ui-checkbox";const p=document.createElement("input");p.type=c,p.name=n.key,p.value=u.key;const g=document.createElement("span");g.textContent=u.label||u.key,d.appendChild(p),d.appendChild(g),o.appendChild(d),a.inputs.push({input:p,label:g,key:u.key})}),s.appendChild(o)}if(n.type==="text"){const o=document.createElement("textarea");o.name=n.key,o.rows=n.config?.rows??3,s.appendChild(o),a={...a,input:o}}if(n.type==="influence"){const o=n.config||{},l=document.createElement("div");l.className="ui-form-influence",l.setAttribute("role","group"),l.setAttribute("aria-label",n.label||n.key);const c=document.createElement("div");c.className="ui-influence-scale-header";const h=document.createElement("div");h.className="ui-influence-label-col-spacer",h.setAttribute("aria-hidden","true");const u=document.createElement("div");u.className="ui-influence-legend-col";const d=document.createElement("div");d.className="ui-slider-legend ui-influence-track-legend";const p=document.createElement("span");p.className="ui-slider-legend-low",p.textContent=n.legend_negative||"";const g=document.createElement("span");g.className="ui-slider-legend-high",g.textContent=n.legend_positive||"",d.appendChild(p),d.appendChild(g),u.appendChild(d),c.appendChild(h),c.appendChild(u),c.classList.add("is-collapsed"),c.setAttribute("aria-hidden","true"),l.appendChild(c);const b=Array.isArray(n.options)?n.options:[],m=[],f=()=>{const v=m.some(M=>M.checkbox.checked);c.classList.toggle("is-collapsed",!v),c.setAttribute("aria-hidden",v?"false":"true")};b.forEach(v=>{const M=document.createElement("div");M.className="ui-influence-row";const y=document.createElement("label");y.className="ui-influence-label-col ui-influence-check";const E=document.createElement("input");E.type="checkbox",E.dataset.optionKey=v.key;const T=document.createElement("span");T.className="ui-influence-option-label",T.textContent=v.label||v.key,y.appendChild(E),y.appendChild(T);const C=document.createElement("div");C.className="ui-influence-slider-col ui-influence-slider-wrap is-collapsed";const F=document.createElement("div");F.className="ui-influence-midbar",F.innerHTML=`
        ...
        `;const _=document.createElement("input");_.type="range",_.min=o.min??-1,_.max=o.max??1,_.step=o.step??.05,_.value=String(pr(o)),_.disabled=!0,_.setAttribute("aria-label",v.label||v.key),C.appendChild(F),C.appendChild(_);const S=()=>{const R=Number(_.min),V=Number(_.max),O=Number(_.value),j=(V===R?.5:(O-R)/(V-R))-.5,X=Math.round(Math.min(.5,Math.abs(j))*100),I=F.querySelector(".ui-influence-midfill.neg"),G=F.querySelector(".ui-influence-midfill.pos");I&&(I.style.width=j<0?`${X}%`:"0%"),G&&(G.style.width=j>0?`${X}%`:"0%")};_.addEventListener("input",S),S(),E.addEventListener("change",()=>{const R=E.checked;C.classList.toggle("is-collapsed",!R),_.disabled=!R,R||(_.value=String(pr(o)),S()),f()}),M.appendChild(y),M.appendChild(C),l.appendChild(M),m.push({key:v.key,checkbox:E,slider:_,sliderWrap:C,cfg:o,syncMidFill:S})}),s.appendChild(l),a={...a,optionRows:m,influenceScaleHeader:c}}e.appendChild(s),t.set(n.key,a)})}function ey(i,e,t){const n=Number(i.dataset.floorIndex),s=Number(i.dataset.x),r=Number(i.dataset.y),a=Number(i.dataset.z);if(Number.isNaN(n)||Number.isNaN(s))return Nl(i,Pe("error.noLocation")),null;const o={};for(const d of e){const p=t.get(d.key);if(p){if(d.type==="slider"&&(o[d.key]=Il(p.input.value,d.config)),d.type==="text"&&(o[d.key]=p.input.value.trim()),d.type==="multi"){const g=!!d.config?.allow_multiple,b=p.inputs.filter(m=>m.input.checked).map(m=>m.input.value);o[d.key]=g?b:b[0]||""}if(d.type==="influence"){const g={},b=p.optionRows||[];for(const m of b)if(m.checkbox.checked){const f=Number(m.slider.value);g[m.key]=Number.isFinite(f)?Math.round(f*1e4)/1e4:0}o[d.key]=g}if(d.required&&ny(o[d.key]))return Nl(i,Pe("error.required")),null}}const l={floor_index:n,x:s,y:r,z:a,answers:o},c=i.dataset.stationKey;c&&(l.station_key=c);const h=new Set(["wellbeing","reasons","group","note"]),u={};for(const[d,p]of Object.entries(o))h.has(d)||(u[d]=p);return Object.keys(u).length>0&&(l.generic_answers=u),l}function er(i,e,t,n){const s=n.get(i);if(s){if(s.input){const r=t.find(a=>a.key===i);if(r?.type==="slider"){s.input.value=fr(e,r.config),typeof s.syncMidFill=="function"&&s.syncMidFill();return}s.input.value=e??"";return}if(s.optionRows&&Array.isArray(s.optionRows)){const r=e&&typeof e=="object"&&!Array.isArray(e)?e:{};if(s.optionRows.forEach(a=>{const o=r[a.key],l=o!=null;a.checkbox.checked=l,l?(a.slider.value=String(o),a.slider.disabled=!1,a.sliderWrap.classList.remove("is-collapsed")):(a.slider.value=String(pr(a.cfg||{})),a.slider.disabled=!0,a.sliderWrap.classList.add("is-collapsed")),typeof a.syncMidFill=="function"&&a.syncMidFill()}),s.influenceScaleHeader){const a=s.optionRows.some(o=>o.checkbox.checked);s.influenceScaleHeader.classList.toggle("is-collapsed",!a),s.influenceScaleHeader.setAttribute("aria-hidden",a?"false":"true")}return}Array.isArray(e)?s.inputs.forEach(r=>{r.input.checked=e.includes(r.input.value)}):s.inputs.forEach(r=>{r.input.checked=r.input.value===e})}}function ah(i,e){e.forEach(t=>{t.input&&(t.input.disabled=i),t.inputs?.forEach(n=>{n.input.disabled=i}),t.optionRows?.forEach(n=>{n.checkbox.disabled=i,n.slider.disabled=i||!n.checkbox.checked})})}function ty(i,e){const t=e.get("wellbeing");if(!t?.input){const s=i.find(r=>r.key==="wellbeing");return Il(pr(s?.config),s?.config)}const n=i.find(s=>s.key==="wellbeing");return Il(t.input.value||.5,n?.config)}function ny(i){return Array.isArray(i)?i.length===0:i==null?!0:typeof i=="string"?i.trim().length===0:typeof i=="object"&&i!==null&&!Array.isArray(i)?Object.keys(i).length===0:!1}function ba(i){if(!i)return[];try{return Array.isArray(i)?i:JSON.parse(i)}catch{return[]}}function Nl(i,e){const t=i.querySelector(".ui-form-error");t&&(t.textContent=e)}function iy(i){const e=i.querySelector(".ui-form-error");e&&(e.textContent="")}function sy(i){return{pins:[],localPins:[],pinMode:!1,activeFloor:i,pendingMesh:null,expandedClusterKey:null,colorQuestionKey:null,colorQuestions:[],globalColorQuestions:[],lastClusterDistance:null,viewPin:null,questions:[],questionElements:new Map,optionsByQuestion:new Map}}function oh(i){return{...i,id:Number(i.id),floor_index:Number(i.floor_index),position_x:Number(i.position_x),position_y:Number(i.position_y),position_z:Number(i.position_z),wellbeing:Number(i.wellbeing),approved:Number(i.approved),reasons:Array.isArray(i.reasons)?i.reasons:ba(i.reasons),group_key:i.group_key||null}}function ry(i,e){return i.localPins.some(t=>t.id===e)}function ay(i,e){return(i.sort??0)-(e.sort??0)}function lh(i,e,t){return(i.optionsByQuestion.get(e)||[]).find(r=>r.key===t)?.label||t}const Rd="default",Do={[Rd]:["#67001f","#b2182b","#d6604d","#f4a582","#fddbc7","#d1e5f0","#92c5de","#4393c3","#2166ac","#053061"],brownTeal:["#543005","#8c510a","#bf812d","#dfc27d","#f6e8c3","#c7eae5","#80cdc1","#35978f","#01665e","#003c30"],purpleGreen:["#40004b","#762a83","#9970ab","#c2a5cf","#e7d4e8","#d9f0d3","#a6dba0","#5aae61","#1b7837","#00441b"],orangePurple:["#7f3b08","#b35806","#e08214","#fdb863","#fee0b6","#d8daeb","#b2abd2","#8073ac","#542788","#2d004b"],pinkGreen:["#8e0152","#c51b7d","#de77ae","#f1b6da","#fde0ef","#e6f5d0","#b8e186","#7fbc41","#4d9221","#276419"],warmCool:["#b40426","#d95847","#f18d6f","#f7b89c","#edd1c2","#c9d7f0","#a4c2fe","#7da0f9","#5977e3","#3b4cc0"],redYellowBlue:["#a50026","#d73027","#f46d43","#fdae61","#fee090","#e0f3f8","#abd9e9","#74add1","#4575b4","#313695"]},Fl=new Le(10265519);function Cd(i={}){const e=typeof i.color_palette=="string"?i.color_palette.trim():"";return e&&Do[e]?Do[e]:Do[Rd]}function ch(i={}){return`linear-gradient(90deg, ${Cd(i).join(", ")})`}function kl(i,e={}){const t=Cd(e),n=Number.isFinite(e.min)?Number(e.min):1,s=Number.isFinite(e.max)?Number(e.max):10,r=Number(i);if(!Number.isFinite(r))return Fl;const a=Math.min(Math.max(r,n),s),o=s===n?0:(a-n)/(s-n),l=Math.min(t.length-1,Math.max(0,Math.round(o*(t.length-1))));return new Le(t[l])}function oy({state:i,legend:e,colorModeRow:t,form:n,pinGroup:s}){return{getPinColor:r,getColorFromForm:a,updatePreviewColor:o,refreshPinColors:l,refreshPendingPinColor:c,updateLegend:h,updateColorQuestions:u,updateColorModeButtons:d,getActiveColorQuestion:p,getPinScore:g};function r(b){const m=p();if(!m)return Fl;const f=g(b,m);return kl(f,m.config)}function a(){const b=p();if(!b)return Fl;const m=i.questionElements.get(b.key);return kl(m?.input?.value,b.config)}function o(){const b=p();if(!b){n.style.removeProperty("--active-slider-gradient");return}n.style.setProperty("--active-slider-gradient",ch(b.config))}function l(){s.children.forEach(b=>{const m=b.userData.pinData,f=b.userData.orb;if(m&&f){const v=r(m);f.material.color.set(v),f.material.emissive.set(v)}})}function c(){if(!i.pendingMesh)return;const b=i.pendingMesh.userData.orb;if(!b)return;const m=a();b.material.color.set(m),b.material.emissive.set(m)}function h(){e.innerHTML="";const b=p();if(o(),!b)return;const m=document.createElement("div");m.className="ui-legend-gradient",m.style.background=ch(b.config);const f=document.createElement("div");f.className="ui-legend-labels",f.innerHTML=`<span>${b.legend_low||""}</span><span>${b.legend_high||""}</span>`,e.appendChild(m),e.appendChild(f)}function u(){if(Array.isArray(i.globalColorQuestions)&&i.globalColorQuestions.length){const v=i.globalColorQuestions.filter(M=>M&&M.type==="slider");if(v.length){i.colorQuestions=[...v],(!i.colorQuestionKey||!v.some(M=>M.key===i.colorQuestionKey))&&(i.colorQuestionKey=v[0]?.key||null),d();return}}const b=i.questions.filter(v=>v.type==="slider");let f=b.filter(v=>v.config?.use_for_color);if(!f.length){const v=b.find(M=>M.key==="wellbeing");f=v?[v]:b.slice(0,1)}i.colorQuestions=f,(!i.colorQuestionKey||!f.some(v=>v.key===i.colorQuestionKey))&&(i.colorQuestionKey=f[0]?.key||null),d()}function d(){if(t.innerHTML="",i.colorQuestions.length<=1){t.style.display="none";return}t.style.display="",i.colorQuestions.forEach(b=>{const m=document.createElement("button");m.type="button",m.className="ui-pin-mode-button",m.dataset.mode=b.key,m.textContent=b.label||b.key,m.classList.toggle("active",b.key===i.colorQuestionKey),t.appendChild(m)})}function p(){return i.colorQuestionKey&&(i.colorQuestions.find(b=>b.key===i.colorQuestionKey)||i.questions.find(b=>b.key===i.colorQuestionKey))||null}function g(b,m){if(!m)return null;const f=m.key;if(Object.prototype.hasOwnProperty.call(b,f))return fr(b[f],m.config);const v=b.answers||b.answer||b.responses;return v&&Object.prototype.hasOwnProperty.call(v,f)?fr(v[f],m.config):fr(b.wellbeing,m.config)}}function uh(i,e){i.toggleButton.textContent=e.pinMode?Pe("ui.pinToggleActive"):Pe("ui.pinToggleIdle"),i.closeButton.setAttribute("aria-label",Pe("ui.close")),i.submitButton.textContent=Pe("ui.save"),i.viewWellbeingLabel.textContent=Pe("ui.viewWellbeing"),i.viewStation&&(i.viewStation.textContent=""),i.viewPending.textContent=Pe("ui.viewPending")}function ly(i,e,t){i.questions.forEach(n=>{const s=i.questionElements.get(n.key);s&&(s.label.textContent=n.label||n.key,n.type==="slider"&&(s.legendLow.textContent=n.legend_low||"",s.legendHigh.textContent=n.legend_high||""),n.type==="multi"&&s.inputs.forEach(r=>{r.label.textContent=Ul(i,n.key,r.key)}),n.key==="wellbeing"&&(e.viewWellbeingLabel.textContent=n.label||Pe("ui.viewWellbeing")))}),t()}function cy(i,e){if(!i.viewPin)return;const n=uy(i.viewPin.reasons).map(s=>Ul(i,"reasons",s)).filter(Boolean);e.viewReasons.textContent=n.join(", "),e.viewGroup.textContent=Ul(i,"group",i.viewPin.group_key||""),e.viewNote.textContent=i.viewPin.note||"",e.viewTimestamp.textContent=Ed(i.viewPin.created_at)}function Ul(i,e,t){if(!t)return"";const n=i.optionsByQuestion?.get(e);return Array.isArray(n)&&n.find(r=>r.key===t||r.option_key===t)?.label||t}function uy(i){if(Array.isArray(i))return i;if(typeof i=="string"){const e=i.trim();if(!e)return[];try{const t=JSON.parse(e);return Array.isArray(t)?t:[e]}catch{return[e]}}return[]}function hy({scene:i,camera:e,renderer:t,domElement:n,controls:s,getSelectedFloor:r,getFloorSlabTopY:a,getPinScale:o,getPinLift:l,questions:c,requestFrame:h}){const u=sy(r()),d=new Map,p=new Map;function g(){typeof h=="function"&&h()}const b=new Map,m=new Map;let f=null,v=0;async function M(H){const Z=li();let B=H?.questionnaire_key?String(H.questionnaire_key):"default";if((!B||B==="null"||B==="undefined")&&(B="default"),(!H?.questionnaire_key||B==="default")&&H?.station_key){const oe=String(H.station_key);if(b.has(oe))B=b.get(oe)||B;else try{const ve=(await Sd(oe))?.questionnaire_key||"default";b.set(oe,ve),H?.questionnaire_key||(B=ve)}catch{b.set(oe,"default")}}const ee=`${B}::${Z||""}`;if(!m.has(ee)){const oe=await fc({key:B,lang:Z}).catch(()=>null);Array.isArray(oe)&&oe.length&&m.set(ee,oe)}const re=m.get(ee);re&&B!==f&&(f=B,Me(re),g())}const y=new fn;i.add(y);const E=new Map,T=Kv(),{panel:C,toggleButton:F,backdrop:_,form:S,formContent:R,closeButton:V,submitButton:O,colorModeRow:U,legend:j,viewPanel:X,viewWellbeing:I,viewWellbeingLabel:G,viewAnswers:te,viewStation:ue,viewPending:he,viewTimestamp:xe,viewScoreDot:Ue}=T,et={toggleButton:F,closeButton:V,submitButton:O,viewWellbeingLabel:G,viewPending:he,viewTimestamp:xe,viewStation:ue},qe=$(),q=oy({state:u,legend:j,colorModeRow:U,form:S,pinGroup:y});uh(et,u),Te(),wd(()=>{if(uh(et,u),Te(),q.updateLegend(),u.viewPin&&S.dataset.mode==="view"&&!X.classList.contains("is-hidden")){A(u.viewPin);return}cy(u,et)}),Me(Array.isArray(c)?c:[]),F.addEventListener("click",()=>{u.pinMode=!u.pinMode,F.classList.toggle("active",u.pinMode),F.textContent=u.pinMode?Pe("ui.pinToggleActive"):Pe("ui.pinToggleIdle"),s.enabled=!u.pinMode,document.body.classList.toggle("pin-mode",u.pinMode),u.pinMode&&(q.updateColorQuestions(),q.updateLegend(),g())}),document.addEventListener("keydown",H=>{if(H.key==="Escape"&&!qe.backdrop.classList.contains("is-visible")){if(_.classList.contains("is-visible")){Q();return}u.pinMode&&(u.pinMode=!1,F.classList.remove("active"),F.textContent=Pe("ui.pinToggleIdle"),s.enabled=!0,document.body.classList.remove("pin-mode"))}}),U.addEventListener("click",H=>{const Z=H.target.closest("button[data-mode]");if(!Z||!U.contains(Z))return;const B=Z.dataset.mode;!B||B===u.colorQuestionKey||(u.colorQuestionKey=B,q.updateColorModeButtons(),q.updateLegend(),q.refreshPinColors(),q.updatePreviewColor(),g())});let ie=!1,_e=null,ke=0;return Zv({camera:e,domElement:n,pinGroup:y,getState:()=>u,getSelectedFloor:r,getFloorSlabTopY:a,onPinClick:H=>x({pin:H}),onClusterClick:H=>{u.expandedClusterKey=H||null,Be()},onEmptyClick:()=>{u.expandedClusterKey&&(u.expandedClusterKey=null,Be())},onFloorClick:({floorIndex:H,position:Z})=>{D({floorIndex:H,position:Z}),x({floorIndex:H,position:Z})}}),Qv({camera:e,domElement:n,getState:()=>u,getSelectedFloor:r,getFloorSlabTopY:a,controls:s,onFloorClick:({floorIndex:H,position:Z})=>{D({floorIndex:H,position:Z}),x({floorIndex:H,position:Z})}}),V.addEventListener("click",()=>{Q()}),_.addEventListener("pointerdown",H=>{H.target===_&&performance.now()<ke&&(H.preventDefault(),H.stopPropagation())},!0),_.addEventListener("click",H=>{if(H.target===_){if(performance.now()<ke){H.preventDefault(),H.stopPropagation();return}Q()}}),O.addEventListener("click",async H=>{H.preventDefault();const Z=ey(S,u.questions,u.questionElements);if(Z)try{const B=await Fv(Z),ee=B&&typeof B=="object"?{...B,generic_answers:B.generic_answers??Z.generic_answers??B.generic_answers,asked_questions:B.asked_questions??(u.questions||[]).map(re=>re.key).filter(Boolean)}:B;Qe(ee),await yt(u.activeFloor),N(),u.pinMode=!1,F.classList.remove("active"),s.enabled=!0,document.body.classList.remove("pin-mode")}catch(B){Nl(S,B?.message||Pe("error.saveFailed"))}}),S.addEventListener("input",()=>{S.dataset.mode==="create"&&_.classList.contains("is-visible")&&(ie=!0),q.updatePreviewColor(),q.refreshPendingPinColor(),g()}),yt(u.activeFloor),q.updateLegend(),q.updatePreviewColor(),{ui:C,resetUi:()=>{if(_.classList.contains("is-visible")){Q();return}bt(),u.viewPin=null,we(),u.pinMode=!1,F.classList.remove("active"),F.textContent=Pe("ui.pinToggleIdle"),s.enabled=!0,document.body.classList.remove("pin-mode"),g()},setActiveFloor:H=>{u.activeFloor=H;const Z=d.get(Number(H));Array.isArray(Z)?(u.pins=Z,Be()):(u.pins=[],Be(),yt(u.activeFloor))},update:()=>{let H=!1;const Z=e.position.distanceTo(s.target);return(u.lastClusterDistance===null||Math.abs(Z-u.lastClusterDistance)>.6)&&(u.lastClusterDistance=Z,Be(),H=!0),y.children.forEach(B=>{if(B.userData.baseY===void 0)return;const ee=B.userData.hovered?B.userData.baseY+.08:B.userData.baseY;B.position.y=Nt.lerp(B.position.y,ee,.1),Math.abs(B.position.y-ee)>1e-4&&(H=!0);const re=B.userData.orb;if(re){const oe=B.userData.hovered?.5:.25;re.material.emissiveIntensity=Nt.lerp(re.material.emissiveIntensity,oe,.1),Math.abs(re.material.emissiveIntensity-oe)>.02&&(H=!0)}}),H},setQuestions:Me,setGlobalColorQuestions:$e,setStationKey:H=>{S.dataset.stationKey=H||""}};function Me(H,Z){u.questions=Array.isArray(H)?[...H].sort(ay):[],u.questionElements=new Map,u.optionsByQuestion=new Map,u.questions.forEach(B=>{Array.isArray(B.options)&&u.optionsByQuestion.set(B.key,B.options)}),Z&&(f=Z),q.updateColorQuestions(),Jv(u.questions,R,u.questionElements),ly(u,et,q.updateColorModeButtons),q.updateLegend(),q.refreshPinColors(),g()}function $e(H){const Z=(H||[]).filter(ee=>ee.type==="slider"),B=Z.filter(ee=>ee.config?.use_for_color);if(B.length)u.globalColorQuestions=B;else{const ee=Z.find(re=>re.key==="wellbeing");u.globalColorQuestions=ee?[ee]:Z.slice(0,1)}q.updateColorQuestions(),q.updateLegend(),q.refreshPinColors(),g()}async function yt(H){const Z=Number(H);if(d.has(Z))return;if(p.has(Z))return p.get(Z);const B=(async()=>{try{const re=(await Nv(Z)).map(oh).filter(oe=>oe?.status==="approved"||Number(oe.approved)===1);d.set(Z,re),u.activeFloor===Z&&(u.pins=re,u.localPins=u.localPins.filter(oe=>!u.pins.some(J=>J.id===oe.id)),Be())}catch{}finally{p.delete(Z)}})();return p.set(Z,B),B}function Be(){const H=u.selectedMesh?.userData?.pinData?.id??null;u.selectedMesh=null,y.clear();const Z=[...u.pins,...u.localPins].filter(J=>J.floor_index===u.activeFloor),B=qv(Z,e,s,n,a,l),ee=e.position.distanceTo(s.target),re=it(ee),oe=ze(ee);B.forEach(J=>{const ve=J.pins.map(P=>String(P.id)).sort().join(",");if(J.pins.length>1&&u.expandedClusterKey&&ve===u.expandedClusterKey){const P=typeof o=="function"?Number(o()):1,le=typeof l=="function"?Number(l()):.35,de=.55*(Number.isFinite(P)&&P>0?P:1)*re,se=J.pins.length;J.pins.forEach((z,ae)=>{const ye=ae/se*Math.PI*2,je=Math.cos(ye)*de,He=Math.sin(ye)*de,ft=Lo(z,q.getPinColor(z));Number.isFinite(P)&&P>0&&ft.scale.setScalar(P*re);const Xn=(typeof a=="function"?a(z.floor_index):z.position_y)+z.position_y+(Number.isFinite(le)?le:.35);ft.position.set(z.position_x+je,Xn,z.position_z+He),ft.userData.floorIndex=z.floor_index,ft.userData.pinId=z.id,ft.userData.pinData=z,ft.userData.baseY=Xn,y.add(ft)});return}if(J.pins.length===1){const P=J.pins[0],le=Lo(P,q.getPinColor(P)),ce=typeof o=="function"?Number(o()):1,de=typeof l=="function"?Number(l()):.35;Number.isFinite(ce)&&ce>0&&le.scale.setScalar(ce*re);const z=(typeof a=="function"?a(P.floor_index):P.position_y)+P.position_y+(Number.isFinite(de)?de:.35);le.position.set(P.position_x,z,P.position_z),le.userData.floorIndex=P.floor_index,le.userData.pinId=P.id,le.userData.pinData=P,le.userData.baseY=z,y.add(le),H!=null&&P.id===H&&(le.userData.hovered=!0,u.selectedMesh=le)}else{const P=St(J.pins),le=Vv(J,E,P),ce=typeof o=="function"?Number(o()):1,de=typeof l=="function"?Number(l()):.35;Number.isFinite(ce)&&ce>0&&le.scale.setScalar(2.8*ce*oe),le.position.copy(J.worldPosition),le.position.y+=(Number.isFinite(de)?de:.35)+.05,le.userData.floorIndex=u.activeFloor,le.userData.clusterKey=ve,y.add(le)}}),tt(),g()}function tt(){y.children.forEach(H=>{H.visible=H.userData.floorIndex===u.activeFloor})}function it(H){if(!Number.isFinite(H))return 1;const Z=Nt.clamp((H-10)/30,0,1);return Nt.lerp(1,1.18,Z)}function ze(H){if(!Number.isFinite(H))return 1;const Z=Nt.clamp((H-10)/30,0,1);return Nt.lerp(1,1.1,Z)}function St(H){if(!Array.isArray(H)||!H.length)return new Le("#1f2937");const Z=q.getActiveColorQuestion();if(!Z)return q.getPinColor(H[0]);let B=0,ee=0;if(H.forEach(oe=>{const J=Number(q.getPinScore(oe,Z));Number.isFinite(J)&&(B+=J,ee+=1)}),!ee)return q.getPinColor(H[0]);const re=B/ee;return kl(re,Z.config)}function D({floorIndex:H,position:Z}){bt();const B=typeof a=="function"?a(H):0,ee={id:`local-${Date.now()}`,floor_index:H,position_x:Z.x,position_y:Z.y-B,position_z:Z.z,wellbeing:ty(u.questions,u.questionElements),reasons:[],note:"",approved:0,group_key:null},re=Lo(ee,q.getPinColor(ee)),oe=typeof o=="function"?Number(o()):1,J=typeof l=="function"?Number(l()):.35,ve=e.position.distanceTo(s.target),P=it(ve);Number.isFinite(oe)&&oe>0&&re.scale.setScalar(oe*P);const le=B+ee.position_y+(Number.isFinite(J)?J:.35);re.position.set(Z.x,le,Z.z),re.userData.floorIndex=H,re.userData.baseY=le,y.add(re),u.pendingMesh=re,g()}function bt(){u.pendingMesh&&(y.remove(u.pendingMesh),u.pendingMesh=null,g())}function Qe(H){if(bt(),H){const Z=oh(H);Z.approved===0&&u.localPins.unshift(Z)}Be()}function ut(H){if(!H)return null;for(const Z of y.children)if(Z.userData.pinData&&Z.userData.pinData.id===H)return Z;return null}function we(){u.selectedMesh&&(u.selectedMesh.userData.hovered=!1,u.selectedMesh=null)}function A(H){const Z=q.getActiveColorQuestion()||u.questions.find(z=>z.key==="wellbeing")||null,B=Z?.key||"wellbeing",ee=B==="wellbeing"?H.wellbeing:B==="note"?H.note:B==="group"?H.group_key:B==="reasons"?ba(H.reasons):(H&&typeof H.generic_answers=="object"&&H.generic_answers?H.generic_answers:{})[B];G.textContent=Z?.label||Pe("ui.viewWellbeing"),I.textContent=Z?.type==="slider"?Gv(ee):String(ee??Pe("ui.empty")),Ue.style.background=q.getPinColor(H).getStyle(),xe.textContent=Ed(H.created_at),xe.dataset.pending=ry(u,H.id)&&H.approved===0?"true":"false";const re=H?.station_key?String(H.station_key):"",oe=re&&re!=="default"&&re!=="null"&&re!=="undefined";ue.textContent=oe?`Station: ${re}`:"";const J=H&&typeof H.generic_answers=="object"&&H.generic_answers?H.generic_answers:{},ve=Array.isArray(H.asked_questions)?H.asked_questions:[],P=ve.length?ve:(u.questions||[]).map(z=>z.key).filter(Boolean),le=[],ce=z=>z==="wellbeing"?H.wellbeing:z==="note"?H.note:z==="group"?H.group_key:z==="reasons"?ba(H.reasons):J[z],de=z=>{if(z==null)return!1;if(Array.isArray(z))return z.length>0;if(typeof z=="object")return Object.keys(z).length>0;if(typeof z=="string"){const ae=z.trim();if(!ae)return!1;if(ae[0]==="{")try{const ye=JSON.parse(ae);if(ye&&typeof ye=="object"&&!Array.isArray(ye))return Object.keys(ye).length>0}catch{}return!0}return String(z).trim()!==""},se=(z,ae)=>{if(!z)return String(ae);if(z.type==="slider"){const ye=Number.isFinite(Number(z.config?.min))?Number(z.config.min):0,je=Number.isFinite(Number(z.config?.max))?Number(z.config.max):1,He=z.legend_low||"",ft=z.legend_high||"",zt=fr(ae,z.config||{}),Xn=je===ye?.5:Math.max(0,Math.min(1,(Number(zt)-ye)/(je-ye))),Mi=Math.round(Xn*100);return`<div class="ui-pin-view-slider">${He||ft?`<div class="ui-pin-view-slider-legend"><span>${He}</span><span>${ft}</span></div>`:""}<div class="ui-pin-view-slider-bar" aria-hidden="true"><div class="ui-pin-view-slider-fill" style="width:${Mi}%"></div></div></div>`}if(z.type==="text")return String(ae||"").trim()||Pe("ui.empty");if(z.type==="multi"){const ye=Array.isArray(ae)?ae:ae?[ae]:[];return ye.length?ye.map(je=>lh(u,z.key,je)).join(", "):Pe("ui.empty")}if(z.type==="influence"){let ye=ae&&typeof ae=="object"&&!Array.isArray(ae)?ae:{};if(typeof ae=="string")try{const Yt=JSON.parse(ae);Yt&&typeof Yt=="object"&&!Array.isArray(Yt)&&(ye=Yt)}catch{}const je=Object.keys(ye);if(!je.length)return Pe("ui.empty");const He=Number.isFinite(Number(z.config?.min))?Number(z.config.min):-1,ft=Number.isFinite(Number(z.config?.max))?Number(z.config.max):1,zt=z.legend_negative||"",Xn=z.legend_positive||"",Mi=Yt=>Math.max(0,Math.min(1,Yt)),qi=Yt=>ft===He?.5:(Yt-He)/(ft-He),za=zt||Xn?`<div class="ui-pin-view-influence-legend"><span><span>${zt}</span><span>${Xn}</span></span><span></span></div>`:"",Rr=je.map(Yt=>{const qn=lh(u,z.key,Yt),Yn=Number(ye[Yt]);let Bs=.5;if(Number.isFinite(Yn)){const Pr=Yn>=0&&Yn<=1,Lr=He>=0&&ft<=1;Bs=Mi(Pr&&!Lr?Yn:qi(Yn))}const Yi=Bs-.5,wi=Math.round(Math.min(.5,Math.abs(Yi))*100),Cr=Yi<0?wi:0,Ki=Yi>0?wi:0;return`
              <div class="ui-pin-view-influence-row">
                <div class="ui-pin-view-influence-label">${qn}</div>
...
`)}}}fences(i){let e=this.rules.block.fences.exec(i);if(e){let t=e[0],n=Qy(t,e[3]||"",this.rules);return{type:"code",raw:t,lang:e[2]?e[2].trim().replace(this.rules.inline.anyPunctuation,"$1"):e[2],text:n}}}heading(i){let e=this.rules.block.heading.exec(i);if(e){let t=e[2].trim();if(this.rules.other.endingHash.test(t)){let n=nr(t,"#");(this.options.pedantic||!n||this.rules.other.endingSpaceChar.test(n))&&(t=n.trim())}return{type:"heading",raw:e[0],depth:e[1].length,text:t,tokens:this.lexer.inline(t)}}}hr(i){let e=this.rules.block.hr.exec(i);if(e)return{type:"hr",raw:nr(e[0],`
...
`;return n?'<pre><code class="language-'+Dn(n)+'">'+(t?s:Dn(s,!0))+`</code></pre>
`:"<pre><code>"+(t?s:Dn(s,!0))+`</code></pre>
...
`;wc.querySelectorAll("button[data-rot]");const dS=typeof window<"u"&&window.matchMedia?.("(pointer: coarse)")?.matches===!0&&(navigator.maxTouchPoints||0)>0;function Ec(i){if(!Number.isFinite(i)||i===0)return;const e=vt.position.clone().sub(st.target),t=new Al().setFromVector3(e);t.theta+=i,e.setFromSpherical(t),vt.position.copy(st.target).add(e),st.update(),en()}function fS(i){if(!st.enabled||i.deltaMode!==0||Math.abs(i.deltaX)<1.5)return;i.preventDefault();const t=Nt.clamp(i.deltaX*.0022,-.12,.12);Ec(t)}let cr=null;const pS=.36,mS=1;function gS(i){if(dS||!st.enabled||typeof i.rotation!="number")return;if(i.preventDefault(),cr===null){cr=i.rotation;return}const e=i.rotation-cr;cr=i.rotation;const t=Nt.clamp(-Nt.degToRad(e),-.2,.2);Ec(t)}function Gd(){cr=null}const Vn=new Map;let Oi=null,Tc=!0;function Oa(){Vn.clear(),Oi=null,st.enablePan=Tc}function bS(){if(Vn.size<2)return null;const i=Array.from(Vn.values()),e=i[0],t=i[1];return Math.atan2(t.clientY-e.clientY,t.clientX-e.clientX)}function _S(i){let e=i;for(;e>Math.PI;)e-=Math.PI*2;for(;e<-Math.PI;)e+=Math.PI*2;return e}function xS(){if(!st.enabled||Vn.size<2)return;const i=bS();if(!Number.isFinite(i))return;if(Oi===null){Oi=i,Tc=st.enablePan,st.enablePan=!1;return}const e=_S(i-Oi);Oi=i,!(Math.abs(e)<.0025)&&Ec(e*pS*mS)}function vS(i){i.pointerType==="touch"&&(Vn.set(i.pointerId,{clientX:i.clientX,clientY:i.clientY}),Vn.size===2&&(Oi=null))}function yS(i){i.pointerType==="touch"&&Vn.has(i.pointerId)&&(Vn.set(i.pointerId,{clientX:i.clientX,clientY:i.clientY}),xS())}function Vd(i){i.pointerType==="touch"&&(Vn.delete(i.pointerId),Vn.size<2&&(Oi=null,st.enablePan=Tc))}let kt=0,Ca=gt?.source==="gltf"?st.target.y:gt.getTargetYForFloor(kt);const{floorButtons:Wd}=Pv(gt.maxBasements,gt.maxAboveGroundFloors),Ac=Iv();Si.appendChild(Ac.ui);const vs={floorIndex:kt,camera:vt.position.clone(),target:st.target.clone()};function jd(){Tn.resetUi?.(),Ba(Number(vs.floorIndex??0)),st.target.copy(vs.target),vt.position.copy(vs.camera),st.update(),en()}Ac.ui.addEventListener("click",i=>{i.preventDefault(),jd()});Ac.ui.addEventListener("keydown",i=>{i.key!=="Enter"&&i.key!==" "||(i.preventDefault(),jd())});const Ps=Lv({languages:[],activeLanguage:li(),ariaLabel:Pe("ui.language"),onChange:i=>pc(i)});Si.appendChild(Ps.ui);const bi=Dv();Ps.infoButton.addEventListener("click",()=>{Cc(li(),!0)});let Hl=null;const _h=new L,xh=new L;function en(){Hl==null&&(Hl=requestAnimationFrame(MS))}function SS(){if(!Hd)return;const i=6e4;let e=null,t=!1;const n=()=>{window.location.reload()},s=()=>{e!==null&&clearTimeout(e),e=window.setTimeout(n,i)},r=()=>{t=!0,s()};["pointerdown","pointermove","wheel","keydown","touchstart","mousedown"].forEach(o=>{window.addEventListener(o,r,{passive:!0})}),document.addEventListener("visibilitychange",()=>{!document.hidden&&t&&s()})}function MS(){if(Hl=null,typeof document<"u"&&document.hidden)return;if(_h.copy(vt.position),xh.copy(st.target),st.update(),CS(),gt?.source!=="gltf"){const t=Ca-st.target.y;Math.abs(t)>1e-6&&(st.target.y+=t,vt.position.y+=t)}const i=Tn.update(),e=vt.position.distanceToSquared(_h)>1e-8||st.target.distanceToSquared(xh)>1e-8;Bn.render(Gi,vt),(e||i)&&en()}const Tn=hy({scene:Gi,camera:vt,renderer:Bn,domElement:Bn.domElement,controls:st,requestFrame:en,getSelectedFloor:()=>kt,getFloorSlabTopY:i=>gt.getFloorSlabTopY(i),getPinScale:()=>{const i=Number(gt?.suggestedGroundSize);return!Number.isFinite(i)||i<=0?1:i>2e3?100:1},getPinLift:()=>{const i=Number(gt?.suggestedGroundSize);return!Number.isFinite(i)||i<=0?.35:i>2e3?35:.35},questions:[]});Si.appendChild(Tn.ui);Wd.forEach(i=>{i.addEventListener("click",()=>{Ba(Number(i.dataset.index))})});Ba(kt);window.addEventListener("resize",RS);document.addEventListener("visibilitychange",()=>{if(!(typeof document>"u")){if(document.hidden){Oa();return}en()}});const Pn=Bn.domElement;Pn.addEventListener("gesturestart",Gd,{passive:!1});Pn.addEventListener("gesturechange",gS,{passive:!1});Pn.addEventListener("gestureend",Gd,{passive:!1});Pn.addEventListener("pointerdown",vS,{passive:!0});Pn.addEventListener("pointermove",yS,{passive:!0});Pn.addEventListener("pointerup",Vd,{passive:!0});Pn.addEventListener("pointercancel",Vd,{passive:!0});window.addEventListener("blur",Oa,{passive:!0});window.addEventListener("touchend",Oa,{passive:!0,capture:!0});window.addEventListener("touchcancel",Oa,{passive:!0,capture:!0});Pn.addEventListener("pointerdown",en,{passive:!0});Pn.addEventListener("wheel",fS,{passive:!1});Pn.addEventListener("wheel",en,{passive:!0});Pn.addEventListener("pointermove",en,{passive:!0});st.addEventListener("change",en);en();SS();wd(i=>{Ps.setActiveLanguage(i),Ps.setAriaLabel(Pe("ui.language")),Ra?Xd(Ra):Rc(i),Fa({lang:i}).then(e=>{Array.isArray(e)&&e.length&&Tn.setGlobalColorQuestions(e)}).catch(()=>{}),Cc(i)});wS();eS?AS():Ra?Xd(Ra):(Rc(li()),Fa({lang:li()}).then(i=>{Array.isArray(i)&&i.length&&Tn.setGlobalColorQuestions(i)}).catch(()=>{}));Cc(li());async function wS(){try{const i=await kv();if(i.length){Ps.setLanguages(i.map(e=>({id:e.lang,label:e.label}))),i.some(e=>e.lang===li())||pc(i[0].lang);return}}catch{}Ps.setLanguages([{id:"de",label:"DE"},{id:"en",label:"EN"}])}async function Rc(i){let e=null;try{e=await fc({key:"default",lang:i})}catch(t){console.warn("[Wellspace viewer] fetchQuestionnaire failed:",t)}if(!Array.isArray(e)||!e.length)try{e=await Fa({lang:i})}catch(t){console.warn("[Wellspace viewer] fetchQuestions fallback failed:",t)}(!Array.isArray(e)||!e.length)&&(console.warn("[Wellspace viewer] No questions from API, using hardcoded fallback"),e=dy()),Tn.setQuestions(e,"default")}let wr=null,ES=!1;function TS(i){const e=new DOMParser().parseFromString(i,"text/html");return e.body.querySelectorAll("a").forEach(t=>{const n=document.createElement("span");for(t.id&&(n.id=t.id),t.className&&(n.className=t.className),t.title&&(n.title=t.title);t.firstChild;)n.appendChild(t.firstChild);t.replaceWith(n)}),e.body.innerHTML}async function Cc(i,e=!1){try{const t=await Uv({key:"about",lang:i});if(!t.body){e&&bi.show();return}wr=t.updated_at,ES=!0;const n=t.body.replace(/\{\{year\}\}/g,String(new Date().getFullYear()));let s=ct.parse(n);if(typeof s!="string"&&(s=String(s)),Hd&&(s=TS(s)),bi.setContent(s),e){bi.show();return}const r=localStorage.getItem("about_dismissed_at");(!r||t.updated_at&&t.updated_at>r)&&bi.show()}catch(t){console.warn("[Wellspace viewer] Failed to load about content:",t),e&&bi.show()}}bi.closeButton.addEventListener("click",()=>{wr&&localStorage.setItem("about_dismissed_at",wr)});bi.backdrop.addEventListener("click",i=>{i.target===bi.backdrop&&wr&&localStorage.setItem("about_dismissed_at",wr)});function AS(){Tn.ui.style.display="none";function i(t){window.opener&&window.opener.postMessage(t,"*"),window.parent&&window.parent!==window&&window.parent.postMessage(t,"*")}const e=document.createElement("div");if(e.id="capture-overlay",e.innerHTML=bh==="pin"?`
  ...
  `,Si.appendChild(e),bh!=="pin")document.getElementById("captureBtn").addEventListener("click",()=>{const t=vt.position.clone(),n=st.target.clone();i({type:"wellspace-capture",camera:{x:t.x,y:t.y,z:t.z},target:{x:n.x,y:n.y,z:n.z},floor_index:kt})});else{const t=new uc,n=new Ce;Bn.domElement.style.cursor="crosshair";const s=Number(gt?.suggestedGroundSize),r=Number.isFinite(s)&&s>2e3?100:1,a=new Et(new Ds(.18*r,16,12),new wn({color:16723285}));a.renderOrder=1e3,"depthTest"in a.material&&(a.material.depthTest=!1),a.visible=!1,Gi.add(a);let o=null;const l=document.getElementById("capturePointBtn");l.addEventListener("click",()=>{o&&(i({type:"wellspace-capture",target:{x:o.x,y:o.y,z:o.z},floor_index:kt}),window.close())}),Bn.domElement.addEventListener("pointerdown",c=>{if(c.button!==0)return;const h=Bn.domElement.getBoundingClientRect();n.x=(c.clientX-h.left)/h.width*2-1,n.y=-((c.clientY-h.top)/h.height)*2+1,t.setFromCamera(n,vt);const u=gt.getFloorSlabTopY(kt),d=new xn(new L(0,1,0),-u),p=new L;t.ray.intersectPlane(d,p)&&(o=p.clone(),a.position.copy(o),a.visible=!0,l.disabled=!1)})}document.getElementById("captureCancelBtn").addEventListener("click",()=>{window.close()})}async function Xd(i){Tn.setStationKey(i);const e=li(),t=Fa({lang:e}).catch(()=>[]);try{const n=await Sd(i);if(n.camera&&n.target){const a=n.floor_index??0;Ba(a);const o=n.camera.y-n.target.y;st.target.set(n.target.x,Ca,n.target.z),vt.position.set(n.camera.x,Ca+o,n.camera.z),st.update(),en(),vs.floorIndex=a,vs.target.copy(st.target),vs.camera.copy(vt.position)}const s=await t;Array.isArray(s)&&s.length&&Tn.setGlobalColorQuestions(s);const r=n.questionnaire_key||"default";try{const a=await fc({key:r,lang:e});if(Array.isArray(a)){Tn.setQuestions(a,r);return}}catch(a){console.warn("[Wellspace viewer] Station questionnaire failed:",a)}}catch(n){console.warn("[Wellspace viewer] Failed to load station:",n)}Rc(e)}function vh(i,e){const t=e<.999;i.renderOrder=t?2:1,i.traverse(n=>{n.material&&(Array.isArray(n.material)?n.material:[n.material]).forEach(r=>{r.transparent=t,r.opacity=e,"depthWrite"in r&&(r.depthWrite=!t),"depthTest"in r&&(r.depthTest=!0),"polygonOffset"in r&&(r.polygonOffset=t,r.polygonOffsetFactor=t?1:0,r.polygonOffsetUnits=t?1:0),r.needsUpdate=!0}),n.isMesh&&(n.renderOrder=t?2:1)})}function yh(){if(gt.floorGroups.forEach(i=>{const e=i.userData.floorIndex;if(e>kt){i.visible=!1;return}if(kt>=0&&e<0){i.visible=!1;return}i.visible=!0,e===kt?(gt.setFloorWallMode(i,!0),vh(i,1)):(gt.setFloorWallMode(i,!1),vh(i,.22))}),Wd.forEach(i=>{i.classList.toggle("active",Number(i.dataset.index)===kt)}),ki.visible=kt>=0,Tn.setActiveFloor(kt),tS){const i=gt.floorGroups.map(e=>{const t=e.userData.floorIndex,n=e.visible;let s=null,r=null;return e.traverse(a=>{if(s||!a?.isMesh||!a.material)return;const o=Array.isArray(a.material)?a.material[0]:a.material;o&&(s={transparent:o.transparent,opacity:o.opacity,depthWrite:o.depthWrite,depthTest:o.depthTest})}),e.traverse(a=>{if(r||!a?.isMesh||a.name!==`floorMarker_${t}`)return;const o=new L;a.getWorldPosition(o);const l=o.clone().project(vt);r={worldY:o.y,ndcY:l.y}}),{floorIndex:t,visible:n,materialSample:s,groupY:e.position.y,markerScreen:r}}).sort((e,t)=>Number(e.floorIndex)-Number(t.floorIndex));console.log("[floorVisibility]",JSON.stringify({selectedFloor:kt,snapshot:i}))}en()}function Ba(i){kt=i,gt?.source!=="gltf"&&(Ca=gt.getTargetYForFloor(kt)),gt?.source==="gltf"&&typeof gt.ensureFloorLoaded=="function"&&gt.ensureFloorLoaded(kt).then(()=>{yh(),en()}),yh()}function RS(){const i=Si.clientWidth,e=Si.clientHeight;vt.aspect=i/e,vt.updateProjectionMatrix(),Bn.setSize(i,e),Bn.setPixelRatio(ud()),en()}function CS(){const i=gt?.navigationBounds;if(!i||i.isEmpty())return;const e=new L;i.getSize(e);const t=C0.panPaddingFactor*Math.max(e.x,e.z,1),n=st.target,s=n.clone();n.x=Nt.clamp(n.x,i.min.x-t,i.max.x+t),n.z=Nt.clamp(n.z,i.min.z-t,i.max.z+t);const r=n.x-s.x,a=n.z-s.z;(Math.abs(r)>1e-9||Math.abs(a)>1e-9)&&(vt.position.x+=r,vt.position.z+=a)}

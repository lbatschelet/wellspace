import{b as s}from"./config-D5aLXqMH.js";const o="ws-404-style",r=`
...
`;function a(){if(document.getElementById(o))return;const e=document.createElement("style");e.id=o,e.textContent=r,document.head.appendChild(e)}function i(){return(new URL(window.location.href).searchParams.get("lang")||navigator.language||"en").slice(0,2).toLowerCase()==="de"?"de":"en"}const n={de:{title:"Diese Feedback-Seite gibt es nicht.",body:"Die angeforderte Seite wurde nicht gefunden. Über den Button kommst du zurück zum Feedback-Formular.",home:"Zum Feedback-Formular",viewer:"Zur Startseite"},en:{title:"This feedback page does not exist.",body:"The page you requested could not be found. Use the button to return to the feedback form.",home:"Back to feedback form",viewer:"Back to home"}};a();const d=i(),t=n[d]||n.en,c=s?.wordmarkHtml,l=document.querySelector("#app");l.innerHTML=`
  <div class="ws-404">

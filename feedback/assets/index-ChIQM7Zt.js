    ...
    <footer class="app-footer">
      <div class="footer-left">
        ...
        <span class="footer-license">
          ${s(e("footer.license"))} <a href="${C}" target="_blank" rel="noopener">AGPL-3.0</a>
        </span>
      </div>
      <div class="footer-right">
        <a class="footer-bug" href="${A}" target="_blank" rel="noopener" title="${s(e("footer.issues"))}">
